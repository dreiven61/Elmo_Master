...
#pragma pack(pop)
	  ...
	  (
	    ...
	    IPRSetAxesPositionsG92Direct,
	    IPRIsSetProfPosLastCmd,
	    IPRReadAxisCoupleCheck,
	    IPRSetAxisCoupleCheck
	  )$UINT;
	  t_e_AxisCoupleCheckMode :
	  (
	    LMCPROF_ACCM_NoCheck,
	    LMCPROF_ACCM_Stop,
	    LMCPROF_ACCM_Error
	  )$UDINT;
	  t_e_AxisCoupleCheckStates :
	  (
	    LMCPROF_ACCS_CheckActive,
	    LMCPROF_ACCS_ProfileStopActive,
	    LMCPROF_ACCS_CurrentConfig
	  )$UDINT;
#pragma pack(push, 1)
	  t_s_DynamicPosCorrectionDetail : STRUCT
	    MinimumVelocity : DINT;
	    ReferenceVelocity : DINT;
	    MinimumDistance : DINT;
	    ReferenceDistance : DINT;
	  END_STRUCT;
#pragma pack(pop)
...
END_CLASS;
#pragma define (restore)
_UDPTransceiverInterface : CLASS_PUBLIC
	TYPE
	  _STATE_UDP_INTF :
	  (
	    _STATE_NO_SOCKET,
...
END_CLASS;
#pragma define (restore)
UDPTransmission : CLASS_PUBLIC
: _UDPTransceiverInterface
	TYPE
	  t_e_TransmissionState :
	  (
	    TS_CheckPara,
	    TS_AddSocket,
	    TS_CheckSocket,
