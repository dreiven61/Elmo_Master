...
TYPE
  ...
  [
    ...
    19 AutoTuneError,  //! <Type Comment="1 --&gt; The command was denied because of autotuning axis is currently active on connected axis." Name="_LMCAXIS_CMDERROR.AutoTuneError"/>
  ];
...
#pragma pack(pop)
  ...
  (
    ...
    _LMCPROF_SETPOS_TO_USER_POS_SET_AXPOS  //! <Type Comment="The profile positions will be set to the positions, which are returned from the methode SetProfPosCallback(). Please overwrite this private methode.&#13;&#10;&#13;&#10;The _LMCAxis object position is set to the same position as the profile position." Name="_LMCPROF_SETPOS_MODE._LMCPROF_SETPOS_TO_USER_POS_SET_AXPOS"/>
  )$UDINT;
  ...
  (
    ...
    _LMCPROF_WORKING_AREA_VIOLATED,  //! <Type Comment="a working area is violated" Name="_LMCPROFERRORTYPES._LMCPROF_WORKING_AREA_VIOLATED"/>
    _LMCPROF_AXIS_COUPLECHECK,  //! <Type Comment="The axis couple check with error reaction was triggered for the axis given by the sub error number." Name="_LMCPROFERRORTYPES._LMCPROF_AXIS_COUPLECHECK"/>
...
#pragma pack(pop)
  ...
  [
    ...
    14 bCoupleCheckProfileStop,  //! <Type Comment="Profile movement is stopped / is stopping because axis couple check is triggered." Name="_LMCPROFILESTATES.bCoupleCheckProfileStop"/>
  ];
...
#pragma pack(pop)
  ...
  (
    ...
    _LMCPROF_SafetyZones,  //! <Type Comment="FALSE: Default value. The safety zones are not monitored.&#13;&#10;TRUE : the safety zone are monitored.&#13;&#10;&#13;&#10;in case of a connection to a _WatchProtWorkArea&#13;&#10;Bit1 ... active (default)&#13;&#10;Bit2 ... just check working areas when testing a move command&#13;&#10;Bit3 ... just check protection areas when testing a move command&#13;&#10;Bit4 ... disable calling the RtWork()&#13;&#10;Bit5 ... disable the automatic StopMove(1) when a violation occurs" Name="_LMCPROFPARAMETER._LMCPROF_SafetyZones"/>
    ...
    _LMCPROF_MinMoveDistance_Mode,  //! <Type Comment="0 ... (default) a move smaller MinMoveDistance, will be changed to a NO_POS_CHANGE&#13;&#10;1 ... in case of _LMCPROF_EXACT_STOP, the move will not be changed to NO_POS_CHANGE, it will change the last move to _LMCPROF_EXACT_STOP and insert the short move as well" Name="_LMCPROFPARAMETER._LMCPROF_MinMoveDistance_Mode"/>
    _LMCPROF_StrictEntryVelocityCheck  //! <Type Comment="When determining the braking point, the current braking distance is used to determine the point at which braking should begin or end. This allows using the fastest entry speed into next movement.&#13;&#10;The entry speed limit can be exceeded in this case in case of a jerk limited axis. The setting only works for MoveType = JERK_PROFILE.&#13;&#10;0 ... (Default) The current braking position is used to determine the braking time during the braking process in order to obtain the fastest entry speed for the following movement.&#10;&#13;&#10;1 ... The current braking distance and the braking distance with the acceleration increased by one tick are checked during the braking process to ensure that the speed limit of the following movement is maintained.&#10;" Name="_LMCPROFPARAMETER._LMCPROF_StrictEntryVelocityCheck"/>
  )$UDINT;
  ...
  _POSFLAGS : BDINT  //! <Type Comment="Public type to set configuration of motion controller classes. Used to define which data is used from the drive." Name="_POSFLAGS"/>
  [
    ...
    4 SetAFF,  //! <Type Comment="0 .. the set acceleration isn&apos;t written to the drive axis object (AFF)&#13;&#10;1 .. default the set acceleration is written to the drive axis object (AFF)&#13;&#10;&#13;&#10;set acceleration is used in drive to calculate current feed forward through P-TFF in drive.&#13;&#10;&#13;&#10;In case of _RAMP_PROFILE the set acceleration is directly derived from set speed with set speed from last tick.&#13;&#10;In case of _JERK_PROFILE the set acceleration is a direct result of the jerk limited movement profile." Name="_POSFLAGS.SetAFF"/>
  ];
  CncFlags : BDINT
  [
