...
typedef struct   //! <Type Comment="Status flags" Name="_LMCAXIS_CMDERROR"/>
  {
    ...
    long AutoTuneError : 1;  //! <Type Comment="1 --&gt; The command was denied because of autotuning axis is currently active on connected axis." Name="_LMCAXIS_CMDERROR.AutoTuneError"/>
  }_LMCAXIS_CMDERROR;
...
typedef UDINT _LMCPROF_SETPOS_MODE;   //! <Type Comment="Mode defines how we get the set positions." Name="_LMCPROF_SETPOS_MODE"/>
    ...
    #define _LMCPROF_SETPOS_TO_USER_POS_SET_AXPOS 3
...
typedef UDINT _LMCPROFERRORTYPES;   //! <Type Comment="Error numbers" Name="_LMCPROFERRORTYPES"/>
    ...
    #define _LMCPROF_WORKING_AREA_VIOLATED 60
    #define _LMCPROF_AXIS_COUPLECHECK 61
...
typedef struct   //! <Type Comment="Profile States" Name="_LMCPROFILESTATES"/>
  {
    ...
    long bCoupleCheckProfileStop : 1;  //! <Type Comment="Profile movement is stopped / is stopping because axis couple check is triggered." Name="_LMCPROFILESTATES.bCoupleCheckProfileStop"/>
  }_LMCPROFILESTATES;
...
typedef UDINT _LMCPROFPARAMETER;   //! <Type Comment="_LMCProfile parameters" Name="_LMCPROFPARAMETER"/>
    ...
    #define _LMCPROF_MinMoveDistance_Mode 57
    #define _LMCPROF_StrictEntryVelocityCheck 58
...
typedef struct   //! <Type Comment="Public type to set configuration of motion controller classes. Used to define which data is used from the drive." Name="_POSFLAGS"/>
  {
