# 14.14 Stop On Limit Event (C & C++) - API 분석

- 원본 장: `Chapter 14 API Events (C & C++)`
- 시작 PDF 페이지: 1264
- 원문 위치: [14.14 Stop On Limit Event (C & C++)](../chunks/049_p1252-p1290_Chapter-14-API-Events-C-C++.md#pdf-page-1264)
...
|---|---:|---|---|---|
| `14.14` | 1264 | `Stop On Limit Event (C & C++)` | 축 또는 동작을 정지 상태로 전환하는 API입니다. | - |
| `14.14.1` | 1265 | `StopOnLimit_Received (C++)` | 축 또는 동작을 정지 상태로 전환하는 API입니다. | - |
...
- PDF 페이지: 1265
- 원문 위치: [14.14.1 StopOnLimit_Received (C++)](../chunks/049_p1252-p1290_Chapter-14-API-Events-C-C++.md#pdf-page-1265)
- 기능 설명: 축 또는 동작을 정지 상태로 전환하는 API입니다.
