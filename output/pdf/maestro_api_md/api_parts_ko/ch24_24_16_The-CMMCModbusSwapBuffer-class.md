# 24.16 The CMMCModbusSwapBuffer class - API 분석

- 원본 장: `Chapter 24 Programming in C++`
- 시작 PDF 페이지: 2314
- 원문 위치: [24.16 The CMMCModbusSwapBuffer class](../chunks/085_p2286-p2322_24.14-The-MMCHostComm-class.md#pdf-page-2314)
...
|---|---:|---|---|---|
| `24.16` | 2314 | `The CMMCModbusSwapBuffer class` | The CMMCModbus Swap Buffer class 작업을 수행하는 API입니다. | - |
...
- PDF 페이지: 2314
- 원문 위치: [24.16 The CMMCModbusSwapBuffer class](../chunks/085_p2286-p2322_24.14-The-MMCHostComm-class.md#pdf-page-2314)
- 기능 설명: The CMMCModbus Swap Buffer class 작업을 수행하는 API입니다.
