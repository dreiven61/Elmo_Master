# 21.2 Elmo Slave Drives - API 분석

- 원본 장: `Chapter 21 EtherCAT Drive Communication`
- 시작 PDF 페이지: 1554
- 원문 위치: [21.2 Elmo Slave Drives](../chunks/062_p1552-p1589_Chapter-21-EtherCAT-Drive-Communication.md#pdf-page-1554)
...
|---|---:|---|---|---|
| `21.2` | 1554 | `Elmo Slave Drives` | Elmo Slave Drives 작업을 수행하는 API입니다. | - |
...
- PDF 페이지: 1554
- 원문 위치: [21.2 Elmo Slave Drives](../chunks/062_p1552-p1589_Chapter-21-EtherCAT-Drive-Communication.md#pdf-page-1554)
- 기능 설명: Elmo Slave Drives 작업을 수행하는 API입니다.
