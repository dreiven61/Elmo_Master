# 25.4 Elmo_RetainSave - API 분석

- 원본 장: `Chapter 25 IEC 61131-3 Special Functions`
- 시작 PDF 페이지: 2425
- 원문 위치: [25.4 Elmo_RetainSave](../chunks/089_p2423-p2431_Chapter-25-IEC-61131-3-Special-Functions.md#pdf-page-2425)
...
|---|---:|---|---|---|
| `25.4` | 2425 | `Elmo_RetainSave` | Elmo Retain 저장 작업을 수행하는 API입니다. | Motion Mode N/A N/A |
...
- PDF 페이지: 2425
- 원문 위치: [25.4 Elmo_RetainSave](../chunks/089_p2423-p2431_Chapter-25-IEC-61131-3-Special-Functions.md#pdf-page-2425)
- 기능 설명: Elmo Retain 저장 작업을 수행하는 API입니다.
