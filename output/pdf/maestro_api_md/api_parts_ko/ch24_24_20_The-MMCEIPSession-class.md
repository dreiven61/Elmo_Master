# 24.20 The MMCEIPSession class - API 분석

- 원본 장: `Chapter 24 Programming in C++`
- 시작 PDF 페이지: 2333
- 원문 위치: [24.20 The MMCEIPSession class](../chunks/086_p2323-p2352_24.18-The-CMMCBulkRead-class.md#pdf-page-2333)
...
|---|---:|---|---|---|
| `24.20` | 2333 | `The MMCEIPSession class` | The MMCEIPSession class 작업을 수행하는 API입니다. | - |
...
- PDF 페이지: 2333
- 원문 위치: [24.20 The MMCEIPSession class](../chunks/086_p2323-p2352_24.18-The-CMMCBulkRead-class.md#pdf-page-2333)
- 기능 설명: The MMCEIPSession class 작업을 수행하는 API입니다.
