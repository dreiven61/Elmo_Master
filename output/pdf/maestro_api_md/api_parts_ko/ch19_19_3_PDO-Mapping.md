# 19.3 PDO Mapping - API 분석

- 원본 장: `Chapter 19 CANbus Drive Communication`
- 시작 PDF 페이지: 1412
- 원문 위치: [19.3 PDO Mapping](../chunks/057_p1410-p1448_19.1-Master-Slave-Relations.md#pdf-page-1412)
...
|---|---:|---|---|---|
| `19.3` | 1412 | `PDO Mapping` | PDO Mapping 작업을 수행하는 API입니다. | - |
...
- PDF 페이지: 1412
- 원문 위치: [19.3 PDO Mapping](../chunks/057_p1410-p1448_19.1-Master-Slave-Relations.md#pdf-page-1412)
- 기능 설명: PDO Mapping 작업을 수행하는 API입니다.
