# 14.10 Touch Probe Ended Event - API 분석

- 원본 장: `Chapter 14 API Events (C & C++)`
- 시작 PDF 페이지: 1260
- 원문 위치: [14.10 Touch Probe Ended Event](../chunks/049_p1252-p1290_Chapter-14-API-Events-C-C++.md#pdf-page-1260)
...
|---|---:|---|---|---|
| `14.10` | 1260 | `Touch Probe Ended Event` | 터치 프로브 Ended 이벤트 작업을 수행하는 API입니다. | - |
...
- PDF 페이지: 1260
- 원문 위치: [14.10 Touch Probe Ended Event](../chunks/049_p1252-p1290_Chapter-14-API-Events-C-C++.md#pdf-page-1260)
- 기능 설명: 터치 프로브 Ended 이벤트 작업을 수행하는 API입니다.
