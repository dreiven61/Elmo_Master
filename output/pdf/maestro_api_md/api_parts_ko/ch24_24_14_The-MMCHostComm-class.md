# 24.14 The MMCHostComm class - API 분석

- 원본 장: `Chapter 24 Programming in C++`
- 시작 PDF 페이지: 2286
- 원문 위치: [24.14 The MMCHostComm class](../chunks/085_p2286-p2322_24.14-The-MMCHostComm-class.md#pdf-page-2286)
...
|---|---:|---|---|---|
| `24.14` | 2286 | `The MMCHostComm class` | The MMCHost Comm class 작업을 수행하는 API입니다. | - |
...
- PDF 페이지: 2286
- 원문 위치: [24.14 The MMCHostComm class](../chunks/085_p2286-p2322_24.14-The-MMCHostComm-class.md#pdf-page-2286)
- 기능 설명: The MMCHost Comm class 작업을 수행하는 API입니다.
