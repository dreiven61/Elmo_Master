# 22.6 MMC_ElmoGetAn arrayAndRetrieveData - API 분석

- 원본 장: `Chapter 22 Interpreter Command Functions`
- 시작 PDF 페이지: 1629
- 원문 위치: [22.6 MMC_ElmoGetAn arrayAndRetrieveData](../chunks/065_p1615-p1646_Chapter-22-Interpreter-Command-Functions.md#pdf-page-1629)
...
|---|---:|---|---|---|
| `22.6` | 1629 | `MMC_ElmoGetAn arrayAndRetrieveData` | Elmo 조회 Array And Retrieve 데이터 값/상태를 조회하는 API입니다. | - |
...
- PDF 페이지: 1629
- 원문 위치: [22.6 MMC_ElmoGetAn arrayAndRetrieveData](../chunks/065_p1615-p1646_Chapter-22-Interpreter-Command-Functions.md#pdf-page-1629)
- 기능 설명: Elmo 조회 Array And Retrieve 데이터 값/상태를 조회하는 API입니다.
