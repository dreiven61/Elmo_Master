# 24.13 The MMCNetwork class - API 분석

- 원본 장: `Chapter 24 Programming in C++`
- 시작 PDF 페이지: 2269
- 원문 위치: [24.13 The MMCNetwork class](../chunks/084_p2250-p2285_Continuation-24.12-The-MMCConnection-class.md#pdf-page-2269)
...
|---|---:|---|---|---|
| `24.13` | 2269 | `The MMCNetwork class` | The MMCNetwork class 작업을 수행하는 API입니다. | - |
...
- PDF 페이지: 2269
- 원문 위치: [24.13 The MMCNetwork class](../chunks/084_p2250-p2285_Continuation-24.12-The-MMCConnection-class.md#pdf-page-2269)
- 기능 설명: The MMCNetwork class 작업을 수행하는 API입니다.
