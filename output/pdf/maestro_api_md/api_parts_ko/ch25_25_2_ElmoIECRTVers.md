# 25.2 ElmoIECRTVers - API 분석

- 원본 장: `Chapter 25 IEC 61131-3 Special Functions`
- 시작 PDF 페이지: 2423
- 원문 위치: [25.2 ElmoIECRTVers](../chunks/089_p2423-p2431_Chapter-25-IEC-61131-3-Special-Functions.md#pdf-page-2423)
...
|---|---:|---|---|---|
| `25.2` | 2423 | `ElmoIECRTVers` | Elmo IECRTVers 작업을 수행하는 API입니다. | - |
...
- PDF 페이지: 2423
- 원문 위치: [25.2 ElmoIECRTVers](../chunks/089_p2423-p2431_Chapter-25-IEC-61131-3-Special-Functions.md#pdf-page-2423)
- 기능 설명: Elmo IECRTVers 작업을 수행하는 API입니다.
