# 22.11 MMC_ElmoQueryOperationFIFOIndexReset - API 분석

- 원본 장: `Chapter 22 Interpreter Command Functions`
- 시작 PDF 페이지: 1642
- 원문 위치: [22.11 MMC_ElmoQueryOperationFIFOIndexReset](../chunks/065_p1615-p1646_Chapter-22-Interpreter-Command-Functions.md#pdf-page-1642)
...
|---|---:|---|---|---|
| `22.11` | 1642 | `MMC_ElmoQueryOperationFIFOIndexReset` | Elmo 질의 동작 FIFOIndex 리셋 작업을 수행하는 API입니다. | Motion Mode NC - Supported Distributed - Supported |
...
- PDF 페이지: 1642
- 원문 위치: [22.11 MMC_ElmoQueryOperationFIFOIndexReset](../chunks/065_p1615-p1646_Chapter-22-Interpreter-Command-Functions.md#pdf-page-1642)
- 기능 설명: Elmo 질의 동작 FIFOIndex 리셋 작업을 수행하는 API입니다.
