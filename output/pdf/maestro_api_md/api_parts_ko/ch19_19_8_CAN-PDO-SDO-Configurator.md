# 19.8 CAN - PDO, SDO Configurator - API 분석

- 원본 장: `Chapter 19 CANbus Drive Communication`
- 시작 PDF 페이지: 1416
- 원문 위치: [19.8 CAN - PDO, SDO Configurator](../chunks/057_p1410-p1448_19.1-Master-Slave-Relations.md#pdf-page-1416)
...
|---|---:|---|---|---|
| `19.8` | 1416 | `CAN - PDO, SDO Configurator` | CAN - PDO, SDO Configurator 작업을 수행하는 API입니다. | - |
...
- PDF 페이지: 1416
- 원문 위치: [19.8 CAN - PDO, SDO Configurator](../chunks/057_p1410-p1448_19.1-Master-Slave-Relations.md#pdf-page-1416)
- 기능 설명: CAN - PDO, SDO Configurator 작업을 수행하는 API입니다.
