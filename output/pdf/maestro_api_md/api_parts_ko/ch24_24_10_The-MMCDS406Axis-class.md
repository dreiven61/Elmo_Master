# 24.10 The MMCDS406Axis class - API 분석

- 원본 장: `Chapter 24 Programming in C++`
- 시작 PDF 페이지: 2200
- 원문 위치: [24.10 The MMCDS406Axis class](../chunks/082_p2175-p2209_Continuation-24.8-The-MMCGroupAxis-class.md#pdf-page-2200)
...
|---|---:|---|---|---|
| `24.10` | 2200 | `The MMCDS406Axis class` | The MMCDS406 축 class 작업을 수행하는 API입니다. | - |
...
- PDF 페이지: 2200
- 원문 위치: [24.10 The MMCDS406Axis class](../chunks/082_p2175-p2209_Continuation-24.8-The-MMCGroupAxis-class.md#pdf-page-2200)
- 기능 설명: The MMCDS406 축 class 작업을 수행하는 API입니다.
