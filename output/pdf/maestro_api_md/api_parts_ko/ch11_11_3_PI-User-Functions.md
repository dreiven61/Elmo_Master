# 11.3 PI User Functions - API 분석

- 원본 장: `Chapter 11 Process Image(PI)`
- 시작 PDF 페이지: 1095
- 원문 위치: [11.3 PI User Functions](../chunks/043_p1093-p1131_11.2-Variable-Types.md#pdf-page-1095)
...
|---|---:|---|---|---|
| `11.3` | 1095 | `PI User Functions` | Process Image 사용자 Functions 작업을 수행하는 API입니다. | - |
...
- PDF 페이지: 1095
- 원문 위치: [11.3 PI User Functions](../chunks/043_p1093-p1131_11.2-Variable-Types.md#pdf-page-1095)
- 기능 설명: Process Image 사용자 Functions 작업을 수행하는 API입니다.
