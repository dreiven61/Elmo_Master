# 24.19 The MMCUserParams class - API 분석

- 원본 장: `Chapter 24 Programming in C++`
- 시작 PDF 페이지: 2329
- 원문 위치: [24.19 The MMCUserParams class](../chunks/086_p2323-p2352_24.18-The-CMMCBulkRead-class.md#pdf-page-2329)
...
|---|---:|---|---|---|
| `24.19` | 2329 | `The MMCUserParams class` | The MMCUser 파라미터 class 작업을 수행하는 API입니다. | - |
...
- PDF 페이지: 2329
- 원문 위치: [24.19 The MMCUserParams class](../chunks/086_p2323-p2352_24.18-The-CMMCBulkRead-class.md#pdf-page-2329)
- 기능 설명: The MMCUser 파라미터 class 작업을 수행하는 API입니다.
