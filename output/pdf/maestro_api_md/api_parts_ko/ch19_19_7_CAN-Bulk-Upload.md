# 19.7 CAN Bulk Upload - API 분석

- 원본 장: `Chapter 19 CANbus Drive Communication`
- 시작 PDF 페이지: 1415
- 원문 위치: [19.7 CAN Bulk Upload](../chunks/057_p1410-p1448_19.1-Master-Slave-Relations.md#pdf-page-1415)
...
|---|---:|---|---|---|
| `19.7` | 1415 | `CAN Bulk Upload` | CAN 벌크 업로드 작업을 수행하는 API입니다. | - |
...
- PDF 페이지: 1415
- 원문 위치: [19.7 CAN Bulk Upload](../chunks/057_p1410-p1448_19.1-Master-Slave-Relations.md#pdf-page-1415)
- 기능 설명: CAN 벌크 업로드 작업을 수행하는 API입니다.
