# 14.1 Communication Byte Order - API 분석

- 원본 장: `Chapter 14 API Events (C & C++)`
- 시작 PDF 페이지: 1253
- 원문 위치: [14.1 Communication Byte Order](../chunks/049_p1252-p1290_Chapter-14-API-Events-C-C++.md#pdf-page-1253)
...
|---|---:|---|---|---|
| `14.1` | 1253 | `Communication Byte Order` | Communication Byte Order 작업을 수행하는 API입니다. | - |
...
- PDF 페이지: 1253
- 원문 위치: [14.1 Communication Byte Order](../chunks/049_p1252-p1290_Chapter-14-API-Events-C-C++.md#pdf-page-1253)
- 기능 설명: Communication Byte Order 작업을 수행하는 API입니다.
