# 22.10 MMC_ElmoQueryOperationFIFORetrieveData - API 분석

- 원본 장: `Chapter 22 Interpreter Command Functions`
- 시작 PDF 페이지: 1640
- 원문 위치: [22.10 MMC_ElmoQueryOperationFIFORetrieveData](../chunks/065_p1615-p1646_Chapter-22-Interpreter-Command-Functions.md#pdf-page-1640)
...
|---|---:|---|---|---|
| `22.10` | 1640 | `MMC_ElmoQueryOperationFIFORetrieveData` | Elmo 질의 동작 FIFORetrieve 데이터 작업을 수행하는 API입니다. | Motion Mode NC - Supported Distributed - Supported |
...
- PDF 페이지: 1640
- 원문 위치: [22.10 MMC_ElmoQueryOperationFIFORetrieveData](../chunks/065_p1615-p1646_Chapter-22-Interpreter-Command-Functions.md#pdf-page-1640)
- 기능 설명: Elmo 질의 동작 FIFORetrieve 데이터 작업을 수행하는 API입니다.
