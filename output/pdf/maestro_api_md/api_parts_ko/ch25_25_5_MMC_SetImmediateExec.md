# 25.5 MMC_SetImmediateExec - API 분석

- 원본 장: `Chapter 25 IEC 61131-3 Special Functions`
- 시작 PDF 페이지: 2426
- 원문 위치: [25.5 MMC_SetImmediateExec](../chunks/089_p2423-p2431_Chapter-25-IEC-61131-3-Special-Functions.md#pdf-page-2426)
...
|---|---:|---|---|---|
| `25.5` | 2426 | `MMC_SetImmediateExec` | 설정 Immediate Exec 값/설정을 적용하는 API입니다. | Motion Mode N/A N/A |
...
- PDF 페이지: 2426
- 원문 위치: [25.5 MMC_SetImmediateExec](../chunks/089_p2423-p2431_Chapter-25-IEC-61131-3-Special-Functions.md#pdf-page-2426)
- 기능 설명: 설정 Immediate Exec 값/설정을 적용하는 API입니다.
- 지원/모드: Motion Mode N/A N/A
