# 11.4 Read/Write RAW Data - API 분석

- 원본 장: `Chapter 11 Process Image(PI)`
- 시작 PDF 페이지: 1095
- 원문 위치: [11.4 Read/Write RAW Data](../chunks/043_p1093-p1131_11.2-Variable-Types.md#pdf-page-1095)
...
|---|---:|---|---|---|
| `11.4` | 1095 | `Read/Write RAW Data` | Read/Write RAW 데이터 값/상태를 조회하는 API입니다. | - |
...
- PDF 페이지: 1095
- 원문 위치: [11.4 Read/Write RAW Data](../chunks/043_p1093-p1131_11.2-Variable-Types.md#pdf-page-1095)
- 기능 설명: Read/Write RAW 데이터 값/상태를 조회하는 API입니다.
