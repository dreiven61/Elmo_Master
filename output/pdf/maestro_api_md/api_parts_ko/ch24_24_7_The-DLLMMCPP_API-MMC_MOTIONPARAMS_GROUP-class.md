# 24.7 The DLLMMCPP_API MMC_MOTIONPARAMS_GROUP class - API 분석

- 원본 장: `Chapter 24 Programming in C++`
- 시작 PDF 페이지: 2050
- 원문 위치: [24.7 The DLLMMCPP_API MMC_MOTIONPARAMS_GROUP class](../chunks/078_p2033-p2054_Continuation-24.6-The-MMCMotionAxis-class.md#pdf-page-2050)
...
|---|---:|---|---|---|
| `24.7` | 2050 | `The DLLMMCPP_API MMC_MOTIONPARAMS_GROUP class` | The DLLMMCPP API Maestro MOTIONPARAMS GROUP class 작업을 수행하는 API입니다. | - |
...
- PDF 페이지: 2050
- 원문 위치: [24.7 The DLLMMCPP_API MMC_MOTIONPARAMS_GROUP class](../chunks/078_p2033-p2054_Continuation-24.6-The-MMCMotionAxis-class.md#pdf-page-2050)
- 기능 설명: The DLLMMCPP API Maestro MOTIONPARAMS GROUP class 작업을 수행하는 API입니다.
