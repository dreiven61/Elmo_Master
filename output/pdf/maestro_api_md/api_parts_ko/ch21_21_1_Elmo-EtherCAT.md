# 21.1 Elmo EtherCAT - API 분석

- 원본 장: `Chapter 21 EtherCAT Drive Communication`
- 시작 PDF 페이지: 1553
- 원문 위치: [21.1 Elmo EtherCAT](../chunks/062_p1552-p1589_Chapter-21-EtherCAT-Drive-Communication.md#pdf-page-1553)
...
|---|---:|---|---|---|
| `21.1` | 1553 | `Elmo EtherCAT` | Elmo Ether CAT 작업을 수행하는 API입니다. | - |
...
- PDF 페이지: 1553
- 원문 위치: [21.1 Elmo EtherCAT](../chunks/062_p1552-p1589_Chapter-21-EtherCAT-Drive-Communication.md#pdf-page-1553)
- 기능 설명: Elmo Ether CAT 작업을 수행하는 API입니다.
