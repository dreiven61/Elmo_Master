# 24.22 Functions TCP/IP and UDP/IP C++ User Libraries - API 분석

- 원본 장: `Chapter 24 Programming in C++`
- 시작 PDF 페이지: 2352
- 원문 위치: [24.22 Functions TCP/IP and UDP/IP C++ User Libraries](../chunks/086_p2323-p2352_24.18-The-CMMCBulkRead-class.md#pdf-page-2352)
...
|---|---:|---|---|---|
| `24.22` | 2352 | `Functions TCP/IP and UDP/IP C++ User Libraries` | Functions TCP/IP and UDP/IP C++ 사용자 Libraries 작업을 수행하는 API입니다. | - |
...
- PDF 페이지: 2352
- 원문 위치: [24.22 Functions TCP/IP and UDP/IP C++ User Libraries](../chunks/086_p2323-p2352_24.18-The-CMMCBulkRead-class.md#pdf-page-2352)
- 기능 설명: Functions TCP/IP and UDP/IP C++ 사용자 Libraries 작업을 수행하는 API입니다.
