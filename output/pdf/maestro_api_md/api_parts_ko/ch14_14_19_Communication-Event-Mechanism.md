# 14.19 Communication Event Mechanism - API 분석

- 원본 장: `Chapter 14 API Events (C & C++)`
- 시작 PDF 페이지: 1273
- 원문 위치: [14.19 Communication Event Mechanism](../chunks/049_p1252-p1290_Chapter-14-API-Events-C-C++.md#pdf-page-1273)
...
|---|---:|---|---|---|
| `14.19` | 1273 | `Communication Event Mechanism` | Communication 이벤트 Mechanism 작업을 수행하는 API입니다. | - |
...
- PDF 페이지: 1273
- 원문 위치: [14.19 Communication Event Mechanism](../chunks/049_p1252-p1290_Chapter-14-API-Events-C-C++.md#pdf-page-1273)
- 기능 설명: Communication 이벤트 Mechanism 작업을 수행하는 API입니다.
