# 22.5 MMC_ElmoGetAn array - API 분석

- 원본 장: `Chapter 22 Interpreter Command Functions`
- 시작 PDF 페이지: 1626
- 원문 위치: [22.5 MMC_ElmoGetAn array](../chunks/065_p1615-p1646_Chapter-22-Interpreter-Command-Functions.md#pdf-page-1626)
...
|---|---:|---|---|---|
| `22.5` | 1626 | `MMC_ElmoGetAn array` | Elmo 조회 Array 값/상태를 조회하는 API입니다. | Motion Mode NC - Supported Distributed - Supported |
...
- PDF 페이지: 1626
- 원문 위치: [22.5 MMC_ElmoGetAn array](../chunks/065_p1615-p1646_Chapter-22-Interpreter-Command-Functions.md#pdf-page-1626)
- 기능 설명: Elmo 조회 Array 값/상태를 조회하는 API입니다.
