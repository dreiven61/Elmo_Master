# 22.9 MMC_ElmoQueryOperationFIFOIndex - API 분석

- 원본 장: `Chapter 22 Interpreter Command Functions`
- 시작 PDF 페이지: 1638
- 원문 위치: [22.9 MMC_ElmoQueryOperationFIFOIndex](../chunks/065_p1615-p1646_Chapter-22-Interpreter-Command-Functions.md#pdf-page-1638)
...
|---|---:|---|---|---|
| `22.9` | 1638 | `MMC_ElmoQueryOperationFIFOIndex` | Elmo 질의 동작 FIFOIndex 작업을 수행하는 API입니다. | Motion Mode NC - Supported Distributed - Supported |
...
- PDF 페이지: 1638
- 원문 위치: [22.9 MMC_ElmoQueryOperationFIFOIndex](../chunks/065_p1615-p1646_Chapter-22-Interpreter-Command-Functions.md#pdf-page-1638)
- 기능 설명: Elmo 질의 동작 FIFOIndex 작업을 수행하는 API입니다.
