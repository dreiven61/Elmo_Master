# 22.7 MMC_ElmoGetParameterAndRetrieveData - API 분석

- 원본 장: `Chapter 22 Interpreter Command Functions`
- 시작 PDF 페이지: 1632
- 원문 위치: [22.7 MMC_ElmoGetParameterAndRetrieveData](../chunks/065_p1615-p1646_Chapter-22-Interpreter-Command-Functions.md#pdf-page-1632)
...
|---|---:|---|---|---|
| `22.7` | 1632 | `MMC_ElmoGetParameterAndRetrieveData` | Elmo 조회 파라미터 And Retrieve 데이터 값/상태를 조회하는 API입니다. | Motion Mode NC - Supported Distributed - Supported |
...
- PDF 페이지: 1632
- 원문 위치: [22.7 MMC_ElmoGetParameterAndRetrieveData](../chunks/065_p1615-p1646_Chapter-22-Interpreter-Command-Functions.md#pdf-page-1632)
- 기능 설명: Elmo 조회 파라미터 And Retrieve 데이터 값/상태를 조회하는 API입니다.
