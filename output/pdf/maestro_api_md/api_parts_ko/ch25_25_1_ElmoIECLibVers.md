# 25.1 ElmoIECLibVers - API 분석

- 원본 장: `Chapter 25 IEC 61131-3 Special Functions`
- 시작 PDF 페이지: 2423
- 원문 위치: [25.1 ElmoIECLibVers](../chunks/089_p2423-p2431_Chapter-25-IEC-61131-3-Special-Functions.md#pdf-page-2423)
...
|---|---:|---|---|---|
| `25.1` | 2423 | `ElmoIECLibVers` | Elmo IECLib Vers 작업을 수행하는 API입니다. | - |
...
- PDF 페이지: 2423
- 원문 위치: [25.1 ElmoIECLibVers](../chunks/089_p2423-p2431_Chapter-25-IEC-61131-3-Special-Functions.md#pdf-page-2423)
- 기능 설명: Elmo IECLib Vers 작업을 수행하는 API입니다.
