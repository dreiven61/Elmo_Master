# 25.3 Elmo_RetainLoad - API 분석

- 원본 장: `Chapter 25 IEC 61131-3 Special Functions`
- 시작 PDF 페이지: 2424
- 원문 위치: [25.3 Elmo_RetainLoad](../chunks/089_p2423-p2431_Chapter-25-IEC-61131-3-Special-Functions.md#pdf-page-2424)
...
|---|---:|---|---|---|
| `25.3` | 2424 | `Elmo_RetainLoad` | Elmo Retain 로드 작업을 수행하는 API입니다. | Motion Mode N/A N/A |
...
- PDF 페이지: 2424
- 원문 위치: [25.3 Elmo_RetainLoad](../chunks/089_p2423-p2431_Chapter-25-IEC-61131-3-Special-Functions.md#pdf-page-2424)
- 기능 설명: Elmo Retain 로드 작업을 수행하는 API입니다.
