# 22.8 MMC_ElmoSetAn array - API 분석

- 원본 장: `Chapter 22 Interpreter Command Functions`
- 시작 PDF 페이지: 1635
- 원문 위치: [22.8 MMC_ElmoSetAn array](../chunks/065_p1615-p1646_Chapter-22-Interpreter-Command-Functions.md#pdf-page-1635)
...
|---|---:|---|---|---|
| `22.8` | 1635 | `MMC_ElmoSetAn array` | Elmo 설정 Array 값/설정을 적용하는 API입니다. | Motion Mode NC - Supported Distributed - Supported |
...
- PDF 페이지: 1635
- 원문 위치: [22.8 MMC_ElmoSetAn array](../chunks/065_p1615-p1646_Chapter-22-Interpreter-Command-Functions.md#pdf-page-1635)
- 기능 설명: Elmo 설정 Array 값/설정을 적용하는 API입니다.
