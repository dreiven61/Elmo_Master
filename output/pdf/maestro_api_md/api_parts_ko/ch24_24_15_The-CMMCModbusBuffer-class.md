# 24.15 The CMMCModbusBuffer class - API 분석

- 원본 장: `Chapter 24 Programming in C++`
- 시작 PDF 페이지: 2313
- 원문 위치: [24.15 The CMMCModbusBuffer class](../chunks/085_p2286-p2322_24.14-The-MMCHostComm-class.md#pdf-page-2313)
...
|---|---:|---|---|---|
| `24.15` | 2313 | `The CMMCModbusBuffer class` | The CMMCModbus Buffer class 작업을 수행하는 API입니다. | - |
...
- PDF 페이지: 2313
- 원문 위치: [24.15 The CMMCModbusBuffer class](../chunks/085_p2286-p2322_24.14-The-MMCHostComm-class.md#pdf-page-2313)
- 기능 설명: The CMMCModbus Buffer class 작업을 수행하는 API입니다.
