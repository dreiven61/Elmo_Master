# 22.12 MMC_ElmoCall - API 분석

- 원본 장: `Chapter 22 Interpreter Command Functions`
- 시작 PDF 페이지: 1644
- 원문 위치: [22.12 MMC_ElmoCall](../chunks/065_p1615-p1646_Chapter-22-Interpreter-Command-Functions.md#pdf-page-1644)
...
|---|---:|---|---|---|
| `22.12` | 1644 | `MMC_ElmoCall` | Elmo 호출 작업을 수행하는 API입니다. | Motion Mode NC - Supported Distributed - Supported |
