# 24.24 The MMCTCP class - API 분석

- 원본 장: `Chapter 24 Programming in C++`
- 시작 PDF 페이지: 2383
- 원문 위치: [24.24 The MMCTCP class](../chunks/087_p2353-p2392_24.23-The-MMCUDP-class.md#pdf-page-2383)
...
|---|---:|---|---|---|
| `24.24` | 2383 | `The MMCTCP class` | The MMCTCP class 작업을 수행하는 API입니다. | - |
...
- PDF 페이지: 2383
- 원문 위치: [24.24 The MMCTCP class](../chunks/087_p2353-p2392_24.23-The-MMCUDP-class.md#pdf-page-2383)
- 기능 설명: The MMCTCP class 작업을 수행하는 API입니다.
