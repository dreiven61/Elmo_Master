...
> 			10811 탭 항목 (selectable) Lib
> 			10812 탭 항목 (selectable) File
> 			10813 탭 항목 (selectable) Class
> 			10814 탭 항목 (selectable) Global
> 			10815 탭 항목 (selectable) Net
> 			341 단추 Close
...
> 					354 단추
> 					355 단추
> 			10816 탭 항목 (selectable) Properties
> 			357 단추 Close
>
> The focused UI element is 246 트리 ID: 103.
> ```
>
...
> 			142 도구 모음 Edit
> 				11152 단추 Toggle bookmark
> 				11153 단추 (disabled) Previous bookmark
> 				11154 단추 (disabled) Next bookmark
> 				11155 단추 (disabled) Delete all bookmarks
> 				11156 단추 (disabled) Previous bookmark in this file
> 				11157 단추 (disabled) Next bookmark in this file
> 				11158 단추 (disabled) Comment selected text (Ctrl+Shift+C)
> 				11159 단추 (disabled) Remove comment (Ctrl+Shift+X)
> 				11160 단추 (disabled) Unindent (Shift+Tab)
> 				11161 단추 (disabled) Indent (Tab)
> 			153 도구 모음 Macros Manager
> 				11162 메뉴 항목 Macros
> 			155 도구 모음 Layout Manager
> 				11163 메뉴 항목 Layouts
> 			157 도구 모음 Toolbox
> 				11164 단추 DataAnalyzer
> 				11165 메뉴 항목 Toolbar Options
> 			160 도구 모음 Net Edit
> 				11166 단추 (disabled) Select
> 				11167 메뉴 항목 Toolbar Options
> 			163 도구 모음 Debug
