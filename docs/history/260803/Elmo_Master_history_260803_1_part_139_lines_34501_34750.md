...
> ```json
> {
>   "title": "Zoom EtherCAT endpoint",
>   "code": "var preciseBuf = Buffer.from(currentNetState.screenshots[1].url.split(\",\")[1],\"base64\"); var preciseCrop = await sharpMod.default(preciseBuf).extract({left:735,top:240,width:105,height:75}).resize(1050,750,{kernel:\"nearest\"}).png().toBuffer(); await nodeRepl.emitImage(preciseCrop);"
> }
> ```
>
...
> ```json
> {
>   "title": "Open ClassState endpoint menu",
>   "code": "await globalThis.sky.click({window:globalThis.targetWindow,x:793,y:276,mouse_button:\"right\",screenshotId:\"screenshot-1\"}); var endpointMenuState1 = await globalThis.sky.get_window_state({window:globalThis.targetWindow,include_screenshot:true,include_text:true}); nodeRepl.write(endpointMenuState1.accessibility.tree.slice(0,1500));"
> }
> ```
>
> ```text
...
> ```json
> {
>   "title": "Connect Coupler endpoint",
>   "code": "nodeRepl.write(endpointMenuState1.screenshots.map(s=>s.id));"
> }
> ```
>
> ```text
...
> ```json
> {
>   "title": "Paste Coupler connection",
>   "code": "await globalThis.sky.click({window:globalThis.targetWindow,x:872,y:356}); await new Promise(r=>setTimeout(r,500)); var afterCouplerPaste = await globalThis.sky.get_window_state({window:globalThis.targetWindow,include_screenshot:true,include_text:true}); nodeRepl.write(afterCouplerPaste.accessibility.tree.slice(0,500));"
> }
> ```
>
> ```text
...
> 		283872 창
> 		283873 메뉴
> 			284594 메뉴 항목 (disabled) Goto Client
> 			284595 메뉴 항목 (disabled) Change Initvalue
> 			284596 메뉴 항목 Copy
> 			284597 메뉴 항목 Paste Connection
> 			284598 메뉴 항목 Insert new IO-Element
> 			284599 메뉴 항목 (disabled) Find References
> 			284600 메뉴 항목 Find in Implementation
> 		1
> ```
>
> Image output: image/jpeg
...
> ```json
> {
>   "title": "Select Motion network",
>   "code": "await globalThis.sky.press_key({window:globalThis.targetWindow,key:\"ESC\"}); await globalThis.sky.click({window:globalThis.targetWindow,x:572,y:116}); await new Promise(r=>setTimeout(r,300)); var motionStateA = await globalThis.sky.get_window_state({window:globalThis.targetWindow,include_screenshot:true,include_text:true}); nodeRepl.write(motionStateA);"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=34665 chars=9977 sha256=1d7ccbedad94a9a4e6ea107be6160d7feaf24dc109c0da935065f7ae56cb7af2]'... 219931 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=34674 chars=9977 sha256=2c435bf663a52cfa0569b1cc43101ca711b23879680dd5423abf47d88403e474]'... 204307 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
>       id: 'screenshot-2',
>       zIndex: 2,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=34683 chars=9977 sha256=115e269592a98f3b56cebed2f5928cea4ac66220e71fc366ec58a0b0d5406719]'... 7663 more characters,
>       originX: -1307,
>       originY: 131,
>       width: 742,
>       height: 35
