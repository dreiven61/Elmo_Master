...
> ```json
> {
>   "title": "Locate LASAL class tree item",
>   "code": "var linesA = globalThis.state.accessibility.tree.split(\"\\n\"); var idxA = linesA.findIndex((x,i)=>x.includes(\"LMCEcatInputLatch\") && i>100); nodeRepl.write(linesA.slice(Math.max(0,idxA-8),idxA+8).join(\"\\n\"));"
> }
> ```
>
> ```text
...
> 			13582 탭 항목 (selectable) Lib
> 			13583 탭 항목 (selectable) File
> 			13584 탭 항목 (selectable) Global
> ```
>
> </details>
>
