...
> ```json
> {
>   "title": "CREVIS 서버 채널 컨텍스트 확인",
>   "code": "await globalThis.sky.press_key({window:globalThis.targetWindow,key:'Shift+F10'}); await new Promise(r=>setTimeout(r,350)); var mainState5 = await globalThis.sky.get_window_state({window:globalThis.targetWindow,include_screenshot:true,include_text:true}); nodeRepl.write(mainState5);"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=29068 chars=9977 sha256=a429bcb45353367824443e6bdd190064a8ac50f2a6bd1e771c57c677df13f7b4]'... 203923 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=29077 chars=9977 sha256=93202d42bbcfc72ccf2dc34f90c3c888217fac12f896ed05ca69612aa1991fc0]'... 187955 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
> ```json
> {
>   "title": "Network View 연결 도움말 확인",
>   "code": "await globalThis.sky.activate_window({window:globalThis.helpWindow}); await new Promise(r=>setTimeout(r,250)); var helpState12 = await globalThis.sky.get_window_state({window:globalThis.helpWindow,include_screenshot:true,include_text:true}); nodeRepl.write(helpState12);"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=29164 chars=9977 sha256=e883f2695419ce014206bfebe0a357672feb2ac266907c1321a165dd6684b5d8]'... 302651 more characters,
>       originX: 109,
>       originY: 51,
>       width: 1597,
>       height: 863
...
> Status: completed
>
> LASAL 도움말 기준으로 연결 절차를 확정했습니다. 이제 `EtherCAT_Network`에서 각 `ClassState` 서버 끝점을 복사해 `Motion_Network`의 3개 클라이언트에 붙이고, 저장 파일에서 실제 연결이 생성됐는지 바로 교차 확인하겠습니다.
>
...
> ```json
> {
>   "title": "Inspect LASAL Help and IDE windows",
>   "code": "nodeRepl.write({hasSky:!!globalThis.sky,targetWindow:globalThis.targetWindow,helpWindow:globalThis.helpWindow});"
> }
> ```
>
> ```text
...
>   "code": "var ideState1 = await globalThis.sky.get_window_state({window:globalThis.targetWindow,include_screenshot:true,include_text:true}); nodeRepl.write(ideState1);"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=29237 chars=9977 sha256=9884670490aef32081eb023f71fea31bc31975e001e8f748311b0620e4499355]'... 202171 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=29246 chars=9977 sha256=cd1dc903afa923b7be3a010365e8137784dae7b2fda48cbd602f22719ac794e1]'... 184879 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
