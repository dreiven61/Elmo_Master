...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=29764 chars=9977 sha256=a429bcb45353367824443e6bdd190064a8ac50f2a6bd1e771c57c677df13f7b4]'... 215751 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=29773 chars=9977 sha256=93202d42bbcfc72ccf2dc34f90c3c888217fac12f896ed05ca69612aa1991fc0]'... 200119 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
> ```json
> {
>   "title": "Inspect available LASAL UI actions",
>   "code": "nodeRepl.write(Object.keys(globalThis.sky).filter(k=>/click|press|key|type|drag/i.test(k)).sort());"
> }
> ```
>
> ```text
> [ 'click', 'drag', 'press_key', 'type_text' ]
> ```
>
> </details>
>
...
> ```json
> {
>   "title": "Open EtherCAT network in LASAL",
>   "code": "await globalThis.sky.click({window:globalThis.targetWindow,x:1294,y:256,screenshotId:\"screenshot-1\"}); await new Promise(r=>setTimeout(r,120)); var f2 = await globalThis.sky.click({window:globalThis.targetWindow,x:1294,y:256}); nodeRepl.write(f2);"
> }
> ```
>
> ```text
...
> ```json
> {
>   "title": "Inspect EtherCAT network editor",
>   "code": "var ideState6 = await globalThis.sky.get_window_state({window:globalThis.targetWindow,include_screenshot:true,include_text:true}); nodeRepl.write(ideState6);"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=29894 chars=9977 sha256=a429bcb45353367824443e6bdd190064a8ac50f2a6bd1e771c57c677df13f7b4]'... 212559 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=29903 chars=9977 sha256=93202d42bbcfc72ccf2dc34f90c3c888217fac12f896ed05ca69612aa1991fc0]'... 196927 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
>       '\t\t\t16 창 LMCSdoExecutor Secondary Actions: Raise ID: 65281\n' +
>       '\t\t\t\t17 창 ID: 59648\n' +
>       '\t\t\t\t\t18 창 #pragma usingLtd SigCLib #define LMC_SDO_EXEC_IDLE 0 #define LMC_SDO_EXEC_ARMING 1 #define LMC_SDO_EXEC_RUNNING 2 #define LMC_SDO_EXEC_RESULT_READY 3 #define LMC_SDO_EXEC_ORPHANED 4 #define LMC_SDO_EXEC_QUARANTINED 5 #define LMC_SDO_EXEC_RELEASING 6 #define LMC_SDO_EXEC_VALID 0$UDINT #define LMC_S'... 12533 more characters,
>     focused_element: '230052 트리 ID: 102'
>   }
> }
> ```
...
> {
>   "title": "Open EtherCAT network in LASAL",
>   "code": "var f3 = await globalThis.sky.click({window:globalThis.targetWindow,x:1289,y:257,click_count:2,screenshotId:\"screenshot-1\"}); nodeRepl.write(f3);"
> }
> ```
>
> ```text
...
> ```json
> {
>   "title": "Confirm EtherCAT network opened",
>   "code": "var ideState7 = await globalThis.sky.get_window_state({window:globalThis.targetWindow,include_screenshot:true,include_text:true}); nodeRepl.write(ideState7);"
> }
> ```
>
> ```text
