...
> ```json
> {
>   "title": "Try LASAL client-to-server connection",
>   "code": "await globalThis.sky.press_key({window:globalThis.targetWindow,key:\"ESC\"}); await new Promise(r=>setTimeout(r,150)); await globalThis.sky.drag({window:globalThis.targetWindow,from_x:564,from_y:321,to_x:1265,to_y:258,screenshotId:\"screenshot-1\"}); await new Promise(r=>setTimeout(r,500)); globalThis.state = await globalThis.sky.get_window_state({window:globalThis.targetWindow,include_screenshot:true,include_text:true}); nodeRepl.write(globalThis.state);"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=25591 chars=9977 sha256=a429bcb45353367824443e6bdd190064a8ac50f2a6bd1e771c57c677df13f7b4]'... 201383 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=25600 chars=9977 sha256=93202d42bbcfc72ccf2dc34f90c3c888217fac12f896ed05ca69612aa1991fc0]'... 185535 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
>       '\t\t212075 메뉴\n' +
>       '\t\t\t213055 메뉴 항목 Select\n' +
>       '\t\t\t213056 메뉴 항목 Comment\n' +
>       '\t\t\t213057 메뉴 항목 Pan\n' +
>       '\t\t\t213058 메뉴 항목 Zoom\n' +
>       '\t\t\t213059 메뉴 항목 Zoom All\n' +
>       '\t\t\t213060 메뉴 항목 (disabled) Zoom Selection\n' +
>       '\t\t\t213061 메뉴 항목 Rename F2\n' +
>       '\t\t1 창 작업 영역 ID: 59648\n' +
>       '\t\t\t155298 창 Motion_Network Secondary Actions: Raise ID: 65284\n' +
>       '\t\t\t\t155299 창 ID: 59648\n' +
>       '\t\t\t\t\t162758 스크롤 막대 세로 ID: NonClientVerticalScrollBar\n' +
...
>       '\t\t\t16 창 LMCSdoExecutor Secondary Actions: Raise ID: 65281\n' +
>       '\t\t\t\t17 창 ID: 59648\n' +
>       '\t\t\t\t\t18 창 #pragma usingLtd SigCLib #define LMC_S'... 14242 more characters,
>     focused_element: '213113 메뉴 항목 NETEDIT'
>   }
> }
> ```
>
...
> ```json
> {
>   "title": "Save LASAL network connection",
>   "code": "await globalThis.sky.press_key({window:globalThis.targetWindow,key:\"CTRL+S\"}); await new Promise(r=>setTimeout(r,700)); nodeRepl.write(\"saved\");"
> }
> ```
>
> ```text
...
> ```json
> {
>   "title": "Complete LASAL channel connection",
>   "code": "await globalThis.sky.click({window:globalThis.targetWindow,x:1265,y:258,screenshotId:\"screenshot-1\"}); await new Promise(r=>setTimeout(r,500)); globalThis.state = await globalThis.sky.get_window_state({window:globalThis.targetWindow,include_screenshot:true,include_text:true}); nodeRepl.write(globalThis.state);"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=25713 chars=9977 sha256=a429bcb45353367824443e6bdd190064a8ac50f2a6bd1e771c57c677df13f7b4]'... 201551 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=25722 chars=9977 sha256=93202d42bbcfc72ccf2dc34f90c3c888217fac12f896ed05ca69612aa1991fc0]'... 185551 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
