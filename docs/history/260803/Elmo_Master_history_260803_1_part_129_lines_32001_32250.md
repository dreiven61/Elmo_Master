...
>       '\t\t\t\t2754 창 ID: 59648\n' +
>       '\t\t\t\t\t2755 창 #pragma usingLtd SigCLib #pragma usingLtd _StdLib FUNCTION VIRTUAL GLOBAL LMCEcatInputLatch::RtWork VAR_INPUT EAX : UDINT; END_VAR VAR_OUTPUT state (EAX) : UDINT; END_VAR VAR cycleCounter : UDINT; timestampLow : UDINT; timestampHigh : UDINT; previousTimestampLow : UD'... 18310 more characters,
...
> {
>   "title": "입력 슬롯 개체 선택",
>   "code": "var cSlotIn = await globalThis.sky.click({window:globalThis.targetWindow,x:969,y:384,screenshotId:\"screenshot-1\"}); nodeRepl.write(cSlotIn);"
> }
> ```
>
> ```text
...
> {
>   "title": "입력 슬롯 선택 확인",
>   "code": "var sSlotIn = await globalThis.sky.get_window_state({window:globalThis.targetWindow,include_screenshot:true,include_text:true}); nodeRepl.write(sSlotIn);"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=32104 chars=9977 sha256=283ecdd100148dd413033c2309f59b3d537b8cd01af07f7f1b3c1e0193c80587]'... 293911 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=32113 chars=9977 sha256=5b074ec5efbb9d4b09dc495fb2e7bd3c79d1aedb6ce6a60fe58b55f2be9ccaab]'... 277307 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
>       '\t\t\t2753 창 LMCEcatInputLatch Secondary Actions: Raise ID: 65283\n' +
>       '\t\t\t\t2754 창 ID: 59648\n' +
>       '\t\t\t\t\t2755 창 #pragma usingLtd SigCLib #pragma usingLtd _StdLib FUNCTION VIRTUAL GLOBAL LMCEcatInputLatch::RtWork VAR_INPUT EAX : UDINT; END_VAR VAR_OUTPUT state (EAX) : UDINT; END_VAR VAR cycleCounter : UDINT; timestampLow : UDINT; timestampHigh : UDINT; previousTimestampLow : UDINT; master'... 18413 more characters,
>     focused_element: '246994 창 ID: 59648'
>   }
> }
> ```
...
> ```json
> {
>   "title": "입력 슬롯 ClassState 선택",
>   "code": "var cSlotInState = await globalThis.sky.click({window:globalThis.targetWindow,x:1069,y:348,screenshotId:\"screenshot-1\"}); nodeRepl.write(cSlotInState);"
> }
> ```
>
> ```text
...
> ```json
> {
>   "title": "ClassState 선택 상태 확인",
>   "code": "var sSlotInState = await globalThis.sky.get_window_state({window:globalThis.targetWindow,include_screenshot:true,include_text:true}); nodeRepl.write(sSlotInState);"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=32229 chars=9977 sha256=283ecdd100148dd413033c2309f59b3d537b8cd01af07f7f1b3c1e0193c80587]'... 295455 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=32238 chars=9977 sha256=5b074ec5efbb9d4b09dc495fb2e7bd3c79d1aedb6ce6a60fe58b55f2be9ccaab]'... 279723 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
