...
>     '\t\t14696 창\n' +
>     '\t\t14697 메뉴\n' +
>     '\t\t\t15233 메뉴 항목 Edit Source Enter\n' +
>     '\t\t\t15234 메뉴 항목 Edit Defines\n' +
>     '\t\t\t15235 메뉴 항목 Delete Del\n' +
>     '\t\t\t15236 메뉴 항목 Duplicate Class\n' +
>     '\t\t\t15237 메뉴 항목 Derive Class\n' +
>     '\t\t\t15238 메뉴 항목 Find Reference\n' +
>     '\t\t\t15239 메뉴 항목 Print Class\n' +
>     '\t\t\t15240 메뉴 항목 Export Class(es)\n' +
>     '\t\t\t15241 메뉴 항목 Reload Class\n' +
>     '\t\t\t15242 메뉴 항목 Re\\Import MatLab Model\n' +
>     '\t\t\t15243 메뉴 항목 Protection Setting\n' +
>     '\t\t\t15244 메뉴 항목 New Server\n' +
>     '\t\t\t15245 메뉴 항목 New Client\n' +
>     '\t\t\t15246 메뉴 항목 New Method\n' +
>     '\t\t\t15247 메뉴 항목 New Std. Methods\n' +
>     '\t\t\t15248 메뉴 항목 New Variable\n' +
>     '\t\t\t15249 메뉴 항목 New Type\n' +
>     '\t\t\t15250 메뉴 항목 New Table\n' +
>     '\t\t\t15251 메뉴 항목 Add Network\n' +
>     '\t\t\t15252 메뉴 항목 Add File...\n' +
>     '\t\t\t15253 메뉴 항목 Open Subfolders\n' +
>     '\t\t\t15254 메뉴 항목 Paste\n' +
>     '\t\t\t15255 메뉴 항목 Copy\n' +
>     '\t\t1 창 작업 영역 ID: 59648\n' +
...
>     '\t\t\t\t17 창 ID: 59648\n' +
>     '\t\t\t\t\t18 창 #pragma usingLtd SigCLib #define LMC_SDO_EXEC_IDLE 0 #define LMC_SDO_EXEC_ARMING 1 #define LMC_SDO_EXEC_RUNNING 2 #define LMC_SDO_EXEC_RESULT_READY 3 #define LMC_SDO_EXEC_ORPHANED 4 #define LMC_SDO_EXEC_QUARA'... 13217 more characters,
...
> ```json
> {
>   "title": "Create LASAL client declaration",
>   "code": "await globalThis.sky.click({window:globalThis.targetWindow,element_index:15245});"
> }
> ```
>
> ```text
> element 15245 is not available in cached app state for Lasal2.exe
> ```
>
...
> ```json
> {
>   "title": "Inspect LASAL menu screenshot bounds",
>   "code": "nodeRepl.write(globalThis.state.screenshots.map(s=>({id:s.id,w:s.width,h:s.height,x:s.originX,y:s.originY,z:s.zIndex})));"
> }
> ```
>
> ```text
> [
>   { id: 'screenshot-0', w: 1450, h: 763, x: -1880, y: 41, z: 0 },
>   { id: 'screenshot-1', w: 1440, h: 753, x: -1875, y: 46, z: 1 },
>   { id: 'screenshot-2', w: 209, h: 528, x: -620, y: 422, z: 2 },
>   { id: 'screenshot-3', w: 209, h: 4, x: -616, y: 950, z: 3 },
>   { id: 'screenshot-4', w: 4, h: 524, x: -411, y: 426, z: 4 }
> ]
> ```
>
> </details>
...
> ```json
> {
>   "title": "Open new client dialog",
>   "code": "await globalThis.sky.click({window:globalThis.targetWindow,x:1320,y:664,screenshotId:\"screenshot-0\"});"
> }
> ```
>
> ```text
...
> ```json
> {
>   "title": "Inspect new client dialog",
...
>     '\t\t14696 창\n' +
>     '\t\t14697 메뉴\n' +
>     '\t\t\t17801 메뉴 항목 Edit Source Enter\n' +
>     '\t\t\t17802 메뉴 항목 Edit Defines\n' +
>     '\t\t\t17803 메뉴 항목 Delete Del\n' +
>     '\t\t\t17804 메뉴 항목 Duplicate Class\n' +
>     '\t\t\t17805 메뉴 항목 Derive Class\n' +
>     '\t\t\t17806 메뉴 항목 Find Reference\n' +
>     '\t\t\t17807 메뉴 항목 Print Class\n' +
>     '\t\t\t17808 메뉴 항목 Export Class(es)\n' +
>     '\t\t\t17809 메뉴 항목 Reload Class\n' +
>     '\t\t\t17810 메뉴 항목 Re\\Import MatLab Model\n' +
>     '\t\t\t17811 메뉴 항목 Protection Setting\n' +
>     '\t\t\t17812 메뉴 항목 New Server\n' +
>     '\t\t\t17813 메뉴 항목 New Client\n' +
>     '\t\t\t17814 메뉴 항목 New Method\n' +
>     '\t\t\t17815 메뉴 항목 New Std. Methods\n' +
>     '\t\t\t17816 메뉴 항목 New Variable\n' +
>     '\t\t\t17817 메뉴 항목 New Type\n' +
>     '\t\t\t17818 메뉴 항목 New Table\n' +
>     '\t\t\t17819 메뉴 항목 Add Network\n' +
>     '\t\t\t17820 메뉴 항목 Add File...\n' +
>     '\t\t\t17821 메뉴 항목 Open Subfolders\n' +
>     '\t\t\t17822 메뉴 항목 Paste\n' +
>     '\t\t\t17823 메뉴 항목 Copy\n' +
>     '\t\t1 창 작업 영역 ID: 59648\n' +
>     '\t\t\t2753 창 LMCEcatInputLatch Secondary Actions: Raise ID: 65283\n' +
...
>     '\t\t\t16 창 LMCSdoExecutor Secondary Actions: Raise ID: 65281\n' +
>     '\t\t\t\t17 창 ID: 59648\n' +
>     '\t\t\t\t\t18 창 #pragma usingLtd SigCLib #define LMC_SDO_EXEC_IDLE 0 #define LMC_SDO_EXEC_ARMING 1 #define LMC_SDO_EXEC_RUNNING 2 #define LMC_SDO_EXEC_RESULT_READY 3 #define LMC_SDO_EXEC_ORPHANED 4 #define LMC_SDO_EXEC_QUARA'... 13799 more characters,
>   focused_element: '17887 편집 ID: 1'
> }
> ```
>
> Image output: image/jpeg
...
> ```json
> {
>   "title": "Name LASAL client Coupler",
>   "code": "await globalThis.sky.type_text({window:globalThis.targetWindow,text:\"Coupler\"});"
> }
> ```
>
> ```text
...
> ```json
> {
>   "title": "Confirm LASAL client name",
