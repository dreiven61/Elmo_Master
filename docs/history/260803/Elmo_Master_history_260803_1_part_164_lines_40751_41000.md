...
> ```json
> {
>   "title": "LASAL Class View 전환",
>   "code": "await sky.click({window:lasalWindow15,x:1364,y:408});"
> }
> ```
>
> ```text
...
> ```json
> {
>   "title": "LASAL Class View 전환 확인",
>   "code": "var classView31=await sky.get_window_state({window:lasalWindow15,include_text:false}); nodeRepl.write(classView31.window);"
> }
> ```
>
> ```text
...
> ```json
> {
>   "title": "LASAL Class View 새로 열기",
>   "code": "await sky.click({window:lasalWindow15,x:132,y:42});"
> }
> ```
>
> ```text
...
>   "code": "var viewMenu32=await sky.get_window_state({window:lasalWindow15,include_text:true}); nodeRepl.write(viewMenu32.accessibility.tree.split(\"\\n\").filter(x=>/메뉴 항목/.test(x)).slice(0,80));"
> }
> ```
>
> ```text
> [
>   '\t\t\t23936 메뉴 항목 Output Pane',
>   '\t\t\t23937 메뉴 항목 Properties Window',
>   '\t\t\t23938 메뉴 항목 Debugger Pane',
>   '\t\t\t23939 메뉴 항목 Python Pane',
>   '\t\t\t23940 메뉴 항목 DataAnalyzer Pane',
>   '\t\t\t23941 메뉴 항목 Drive Pane',
>   '\t\t\t23942 메뉴 항목 Multimaster Pane',
>   '\t\t\t23943 메뉴 항목 Code Analysis',
>   '\t\t\t23944 메뉴 항목 Trees',
>   '\t\t\t23945 메뉴 항목 Toolbars',
>   '\t\t\t23946 메뉴 항목 Status Bar',
>   '\t\t\t23947 메뉴 항목 Layout',
>   '\t\t\t23948 메뉴 항목 Graphical User Interface',
>   '\t\t\t\t23959 메뉴 항목 Macros',
>   '\t\t\t\t23960 메뉴 항목 Layouts',
>   '\t\t\t\t23962 메뉴 항목 Toolbar Options',
>   '\t\t\t\t23964 메뉴 항목 Toolbar Options',
>   '\t\t\t\t23967 메뉴 항목 Online Connection',
>   '\t\t\t\t23977 메뉴 항목 Toolbar Options',
>   '\t\t\t\t23978 메뉴 항목 Target Architecture',
>   '\t\t\t\t23994 메뉴 항목 (disabled) Undo (Strg+Z)',
>   '\t\t\t\t23995 메뉴 항목 (disabled) Redo (Strg+Y)',
>   '\t\t\t\t23998 메뉴 항목 FILE',
>   '\t\t\t\t23999 메뉴 항목 EDIT',
>   '\t\t\t\t24000 메뉴 항목 VIEW',
>   '\t\t\t\t\t\t24002 메뉴 항목 Output Pane',
>   '\t\t\t\t\t\t24003 메뉴 항목 Properties Window',
>   '\t\t\t\t\t\t24004 메뉴 항목 Debugger Pane',
>   '\t\t\t\t\t\t24005 메뉴 항목 Python Pane',
>   '\t\t\t\t\t\t24006 메뉴 항목 DataAnalyzer Pane',
>   '\t\t\t\t\t\t24007 메뉴 항목 Drive Pane',
>   '\t\t\t\t\t\t24008 메뉴 항목 Multimaster Pane',
>   '\t\t\t\t\t\t24009 메뉴 항목 Code Analysis',
>   '\t\t\t\t\t\t24010 메뉴 항목 Trees',
>   '\t\t\t\t\t\t24011 메뉴 항목 Toolbars',
>   '\t\t\t\t\t\t24012 메뉴 항목 Status Bar',
>   '\t\t\t\t\t\t24013 메뉴 항목 Layout',
>   '\t\t\t\t\t\t24014 메뉴 항목 Graphical User Interface',
>   '\t\t\t\t24015 메뉴 항목 PROJECT',
>   '\t\t\t\t24016 메뉴 항목 BUILD',
>   '\t\t\t\t24017 메뉴 항목 DEBUG',
>   '\t\t\t\t24018 메뉴 항목 ANALYZE',
...
>   '\t\t\t\t24021 메뉴 항목 WINDOW',
>   '\t\t\t\t24022 메뉴 항목 HELP',
>   '\t\t\t24038 메뉴 항목 Output Pane',
>   '\t\t\t24039 메뉴 항목 Properties Window',
>   '\t\t\t24040 메뉴 항목 Debugger Pane',
>   '\t\t\t24041 메뉴 항목 Python Pane',
>   '\t\t\t24042 메뉴 항목 DataAnalyzer Pane',
>   '\t\t\t24043 메뉴 항목 Drive Pane',
>   '\t\t\t24044 메뉴 항목 Multimaster Pane',
>   '\t\t\t24045 메뉴 항목 Code Analysis',
>   '\t\t\t24046 메뉴 항목 Trees',
>   '\t\t\t24047 메뉴 항목 Toolbars',
>   '\t\t\t24048 메뉴 항목 Status Bar',
>   '\t\t\t24049 메뉴 항목 Layout',
>   '\t\t\t24050 메뉴 항목 Graphical User Interface',
>   'The focused UI element is 24000 메뉴 항목 VIEW.'
> ]
> ```
>
> Image output: image/jpeg
...
> ```json
> {
>   "title": "LASAL Trees 메뉴 열기",
>   "code": "await sky.click({window:lasalWindow15,x:172,y:245});"
> }
> ```
>
> ```text
...
> ```json
> {
>   "title": "LASAL Trees 메뉴 확인",
>   "code": "var treesMenu33=await sky.get_window_state({window:lasalWindow15,include_text:true}); nodeRepl.write(treesMenu33.accessibility.tree.split(\"\\n\").filter(x=>/Class|Global|File|Lib|Trees/.test(x)).slice(0,80));"
> }
> ```
>
> ```text
...
>   '\t\t\t24293 메뉴 항목 File Explorer',
>   '\t\t\t24298 메뉴 항목 Libraries',
>   '\t\t\t24299 메뉴 항목 Class View',
>   '\t\t\t24300 메뉴 항목 Global View',
>   '\t\t\t24309 메뉴 항목 Trees',
>   '\t\t\t\t\t24311 메뉴 항목 File Explorer',
>   '\t\t\t\t\t24316 메뉴 항목 Libraries',
>   '\t\t\t\t\t24317 메뉴 항목 Class View',
>   '\t\t\t\t\t24318 메뉴 항목 Global View',
...
>   '\t\t\t\t\t\t24384 메뉴 항목 Trees',
>   '\t\t\t\t\t\t\t\t24386 메뉴 항목 File Explorer',
>   '\t\t\t\t\t\t\t\t24391 메뉴 항목 Libraries',
>   '\t\t\t\t\t\t\t\t24392 메뉴 항목 Class View',
>   '\t\t\t\t\t\t\t\t24393 메뉴 항목 Global View',
>   '\t\t97 Tab Class View ID: 401219616',
>   '\t\t\t\t\t\t\t\t\t23431 콘솔 트리 (selectable) _ClassOk',
>   '\t\t\t24409 탭 항목 (selectable) Lib',
>   '\t\t\t24410 탭 항목 (selectable) File',
>   '\t\t\t24411 탭 항목 (selectable) Global',
>   '\t\t\t24412 탭 항목 (selectable) Class',
>   '\t\t\t\t\t24414 custom Class',
>   '\t\t\t24429 메뉴 항목 Trees',
>   '\t\t\t\t\t24431 메뉴 항목 File Explorer',
>   '\t\t\t\t\t24436 메뉴 항목 Libraries',
>   '\t\t\t\t\t24437 메뉴 항목 Class View',
>   '\t\t\t\t\t24438 메뉴 항목 Global View',
>   'The focused UI element is 24309 메뉴 항목 Trees.'
> ]
> ```
>
> Image output: image/jpeg
...
> ```json
> {
>   "title": "LASAL Global View 숨기기",
>   "code": "await sky.click({window:lasalWindow15,x:371,y:397});"
> }
> ```
>
> ```text
...
> ```json
> {
>   "title": "LASAL Class View 정상화 확인",
>   "code": "var classView34=await sky.get_window_state({window:lasalWindow15,include_text:false}); nodeRepl.write(classView34.window);"
> }
> ```
>
> ```text
