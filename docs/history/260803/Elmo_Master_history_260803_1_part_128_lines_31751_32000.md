...
> Status: completed
>
> 먼저 남은 두 CREVIS 슬롯 연결을 IDE에서 정확히 마무리하고 저장 상태를 파일로 대조하겠습니다. 그다음 `IdeStructureReady` 검증을 통과시킨 뒤에만 실제 스냅샷/진단 핸들러 구현으로 넘어가겠습니다. PLC 다운로드나 Run은 하지 않습니다.
>
> MCP tool call
>
> node_repl.js
...
> ```json
> {
>   "title": "LASAL network state 확인",
>   "code": "var sNow = await globalThis.sky.get_window_state({window:globalThis.targetWindow,include_screenshot:true,include_text:true}); nodeRepl.write(sNow);"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=31842 chars=9977 sha256=a429bcb45353367824443e6bdd190064a8ac50f2a6bd1e771c57c677df13f7b4]'... 208595 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=31851 chars=9977 sha256=93202d42bbcfc72ccf2dc34f90c3c888217fac12f896ed05ca69612aa1991fc0]'... 193023 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
>       '\t\t\t2753 창 LMCEcatInputLatch Secondary Actions: Raise ID: 65283\n' +
>       '\t\t\t\t2754 창 ID: 59648\n' +
>       '\t\t\t\t\t2755 창 #pragma usingLtd SigCLib #pragma usingLtd _StdLib FUNCTION VIRTUAL GLOBAL LMCEcatInputLatch::RtWork VAR_INPUT EAX : UDINT; END_VAR VAR_OUTPUT state (EAX) : UDINT; END_VAR VAR cycleCounter : UDINT; timestampLow : UDINT; timestampHigh : UDINT; previousTimestampLow : UDINT; masterStat'... 18295 more characters,
>     focused_element: '155299 창 ID: 59648'
>   }
> }
> ```
...
> ```json
> {
>   "title": "EtherCAT 슬롯 서버 선택",
>   "code": "var c1 = await globalThis.sky.click({window:globalThis.targetWindow,x:829,y:114,screenshotId:\"screenshot-1\"}); nodeRepl.write(c1);"
> }
> ```
>
> ```text
...
> ```json
> {
>   "title": "EtherCAT 화면 확인",
>   "code": "var sEcat1 = await globalThis.sky.get_window_state({window:globalThis.targetWindow,include_screenshot:true,include_text:true}); nodeRepl.write(sEcat1);"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=31967 chars=9977 sha256=283ecdd100148dd413033c2309f59b3d537b8cd01af07f7f1b3c1e0193c80587]'... 293031 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=31976 chars=9977 sha256=5b074ec5efbb9d4b09dc495fb2e7bd3c79d1aedb6ce6a60fe58b55f2be9ccaab]'... 277559 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
>       id: 'screenshot-2',
>       zIndex: 2,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=31985 chars=9977 sha256=b01049eba717f48fffd03dde44e81f6b0022adf2af9f989046017af77ae82322]'... 7799 more characters,
>       originX: -1046,
>       originY: 131,
>       width: 776,
>       height: 35
