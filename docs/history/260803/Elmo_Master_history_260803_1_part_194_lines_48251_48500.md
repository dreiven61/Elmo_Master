...
> ```json
> {
>   "title": "LMCEcatInputLatch 선언 메뉴 열기",
>   "timeout_ms": 30000,
>   "code": "\nvar observation8 = globalThis.state;\nvar shot8 = observation8?.screenshots?.[0]?.id;\nif (!shot8) throw new Error(\"No fresh screenshot\");\nglobalThis.state = null;\nawait sky.click({window:observation8.window,screenshotId:shot8,x:1280,y:383,mouse_button:\"right\"});\nglobalThis.state = await sky.get_window_state({window:observation8.window,include_screenshot:true,include_text:true});\nglobalThis.targetWindow = state.window;\nnodeRepl.write(String(state.accessibility?.tree || state.accessibility?.document_text || \"\"));\n"
> }
> ```
>
> ```text
...
> 		2 상태 표시줄 ID: 59393
> 			3 텍스트
> 			4 텍스트 LMCEcatInputLatch::RtWork
> 			5 텍스트
> 			6 텍스트 Ln 6 Col 1
> 			7 텍스트
> 			8 텍스트 Offline
...
> 			13 도구 모음 Edit
> 				16853 단추 Toggle bookmark
> 				16854 단추 (disabled) Previous bookmark
> 				16855 단추 (disabled) Next bookmark
> 				16856 단추 (disabled) Delete all bookmarks
> 				16857 단추 (disabled) Previous bookmark in this file
> 				16858 단추 (disabled) Next bookmark in this file
> 				16859 단추 Comment selected text (Ctrl+Shift+C)
> 				16860 단추 Remove comment (Ctrl+Shift+X)
> 				16861 단추 Unindent (Shift+Tab)
> 				16862 단추 Indent (Tab)
...
> 				16864 메뉴 항목 Layouts
> 			28 도구 모음 Toolbox
> 				16865 단추 DataAnalyzer
> 				16866 메뉴 항목 Toolbar Options
> 			31 도구 모음 Net Edit
> 				16867 단추 (disabled) Select
> 				16868 메뉴 항목 Toolbar Options
> 			34 도구 모음 Debug
> 				16869 단추 Go online (Alt+F6)
> 				16870 단추 Change Online Settings
> 				16871 메뉴 항목 Online Connection
> 				16872 단추 (disabled) Set Online Connection For Current Project
> 				16873 단추 (disabled) Download (F6)
> 				16874 단추 Build Changes, Online, Download and Run (CTRL+ALT+F6)
> 				16875 단추 (disabled) Download Module on the Fly
> 				16876 단추 (disabled) Save Project on PLC
> 				16877 단추 (disabled) Start (F7)
> 				16878 단추 (disabled) Reset (F8)
> 				16879 단추 Toggle breakpoint (F4)
> 				16880 단추 Create condition breakpoint
> 				16881 메뉴 항목 Toolbar Options
> 			48 도구 모음 Build
> 				16882 메뉴 항목 Target Architecture
> 				16883 단추 Build changes (F9)
> 				16884 단추 Rebuild project (Strg+F9)
> 				16885 단추 (disabled) Cancel building (Ctrl+Break)
> 				16886 단추 Link project
> 			54 도구 모음 Standard
> 				16887 단추 New project (Strg+N)
> 				16888 단추 Open a file (Strg+Shift+O)
> 				16889 단추 Close active document (Strg+F4)
> 				16890 단추 (disabled) Save file (Strg+S)
> 				16891 단추 Open project (Strg+O)
> 				16892 단추 (disabled) Save project changes (Strg+Shift+S)
> 				16893 단추 Close project
> 				16894 단추 Print
> 				16895 단추 Cut (Strg+X)
> 				16896 단추 Copy (Strg+C)
> 				16897 단추 Paste (Strg+V)
> 				16898 메뉴 항목 (disabled) Undo (Strg+Z)
> 				16899 메뉴 항목 (disabled) Redo (Strg+Y)
> 				16900 단추 Navigate Backward (Alt+Left)
> 				16901 단추 (disabled) Navigate Forward (Alt +Right)
> 			70 메뉴 모음 Menu Bar
> 				16902 메뉴 항목 FILE
> 				16903 메뉴 항목 EDIT
> 				16904 메뉴 항목 VIEW
