> 				103805 메뉴 항목 Online Connection
> 				103815 메뉴 항목 Toolbar Options
> 				103816 메뉴 항목 Target Architecture
> 				103832 메뉴 항목 Undo (Strg+Z)
> 				103833 메뉴 항목 (disabled) Redo (Strg+Y)
> 				103836 메뉴 항목 FILE
> 				103837 메뉴 항목 EDIT
> 				103838 메뉴 항목 VIEW
> 				103839 메뉴 항목 PROJECT
> 				103840 메뉴 항목 BUILD
> 				103841 메뉴 항목 DEBUG
> 				103842 메뉴 항목 ANALYZE
> 				103843 메뉴 항목 TOOLS
> 				103844 메뉴 항목 EXTRAS
> 				103845 메뉴 항목 WINDOW
> 				103846 메뉴 항목 HELP[
>   { i: 0, id: 'screenshot-0', w: 1450, h: 763, ox: -1880, oy: 41 },
>   { i: 1, id: 'screenshot-1', w: 1440, h: 753, ox: -1875, oy: 46 },
>   { i: 2, id: 'screenshot-2', w: 169, h: 120, ox: -625, oy: 242 },
>   { i: 3, id: 'screenshot-3', w: 169, h: 4, ox: -621, oy: 362 },
>   { i: 4, id: 'screenshot-4', w: 4, h: 116, ox: -456, oy: 246 }
> ]
> ```
>
...
> ```json
> {
>   "title": "Name revision helper",
>   "code": "await globalThis.sky.click({window:globalThis.targetWindow,x:65,y:12,screenshotId:globalThis.state.screenshots[2].id}); await globalThis.sky.type_text({window:globalThis.targetWindow,text:\"AdvanceOutputRevision\"}); await globalThis.sky.press_key({window:globalThis.targetWindow,key:\"ENTER\"});"
> }
> ```
>
> ```text
...
> ```json
> {
>   "title": "Add Revision output",
>   "code": "await globalThis.sky.click({window:globalThis.targetWindow,element_index:104363,mouse_button:\"right\"});"
> }
> ```
>
> ```text
...
> ```json
> {
>   "title": "Create Revision output",
>   "code": "globalThis.state = await globalThis.sky.get_window_state({window:globalThis.targetWindow,include_screenshot:true,include_text:true}); nodeRepl.write(globalThis.state.screenshots.map((s,i)=>({i,id:s.id,w:s.width,h:s.height,ox:s.originX,oy:s.originY})));"
> }
> ```
>
> ```text
...
>   { i: 0, id: 'screenshot-0', w: 1450, h: 763, ox: -1880, oy: 41 },
>   { i: 1, id: 'screenshot-1', w: 1440, h: 753, ox: -1875, oy: 46 },
>   { i: 2, id: 'screenshot-2', w: 182, h: 192, ox: -562, oy: 422 },
>   { i: 3, id: 'screenshot-3', w: 182, h: 4, ox: -558, oy: 614 },
>   { i: 4, id: 'screenshot-4', w: 4, h: 188, ox: -380, oy: 426 }
> ]
> ```
>
> Image output: image/jpeg
...
> ```json
> {
>   "title": "Name Revision output",
>   "code": "await globalThis.sky.click({window:globalThis.targetWindow,x:75,y:150,screenshotId:globalThis.state.screenshots[2].id}); await globalThis.sky.type_text({window:globalThis.targetWindow,text:\"Revision\"}); await globalThis.sky.press_key({window:globalThis.targetWindow,key:\"ENTER\"});"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=18905 chars=9977 sha256=3d34baa568e0957b24c1eb43e1acaa925a0e32e1aeddde2bed3a14da52fe4653]'... 212007 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=18914 chars=9977 sha256=2743db4c85442c03990bff57c7553f8e898672daf40dd4399065c5f949a343a2]'... 192875 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
> ```json
> {
>   "title": "Enter Revision UDINT",
>   "code": "await globalThis.sky.click({window:globalThis.targetWindow,x:1340,y:498,screenshotId:globalThis.state.screenshots[0].id}); await globalThis.sky.type_text({window:globalThis.targetWindow,text:\"UDINT\"}); await globalThis.sky.press_key({window:globalThis.targetWindow,key:\"ENTER\"});"
> }
> ```
>
> ```text
...
> ```json
> {
>   "title": "Open diagnostics service",
>   "code": "await globalThis.sky.click({window:globalThis.targetWindow,x:330,y:116,screenshotId:globalThis.state.screenshots[0].id});"
> }
> ```
>
> ```text
