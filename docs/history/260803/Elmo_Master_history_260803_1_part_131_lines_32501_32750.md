...
> {
>   "title": "입력 슬롯 연결 적용",
>   "code": "var cPasteIn = await globalThis.sky.click({window:globalThis.targetWindow,x:656,y:458,screenshotId:\"screenshot-1\"}); nodeRepl.write(cPasteIn);"
> }
> ```
>
> ```text
...
> ```json
> {
>   "title": "출력 슬롯 서버 화면 열기",
>   "code": "var cEcatOutTab = await globalThis.sky.click({window:globalThis.targetWindow,x:837,y:114}); nodeRepl.write(cEcatOutTab);"
> }
> ```
>
> ```text
...
> ```json
> {
>   "title": "출력 슬롯 표시 공간 확보",
>   "code": "var closeNetView = await globalThis.sky.click({window:globalThis.targetWindow,x:1428,y:118}); nodeRepl.write(closeNetView);"
> }
> ```
>
> ```text
...
> {
>   "title": "출력 슬롯 위치 확인",
>   "code": "var sEcatOut = await globalThis.sky.get_window_state({window:globalThis.targetWindow,include_screenshot:true,include_text:false}); nodeRepl.write(sEcatOut);"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=32639 chars=9977 sha256=283ecdd100148dd413033c2309f59b3d537b8cd01af07f7f1b3c1e0193c80587]'... 289623 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=32648 chars=9977 sha256=5b074ec5efbb9d4b09dc495fb2e7bd3c79d1aedb6ce6a60fe58b55f2be9ccaab]'... 274131 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
> {
>   "title": "오른쪽 도킹 창 닫기",
>   "code": "var closeClassView = await globalThis.sky.click({window:globalThis.targetWindow,x:1426,y:112}); nodeRepl.write(closeClassView);"
> }
> ```
>
> ```text
...
> {
>   "title": "그래픽 영역 확인",
>   "code": "var sEcatWide = await globalThis.sky.get_window_state({window:globalThis.targetWindow,include_screenshot:true,include_text:false}); nodeRepl.write(sEcatWide);"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=32700 chars=9977 sha256=283ecdd100148dd413033c2309f59b3d537b8cd01af07f7f1b3c1e0193c80587]'... 289403 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=32709 chars=9977 sha256=5b074ec5efbb9d4b09dc495fb2e7bd3c79d1aedb6ce6a60fe58b55f2be9ccaab]'... 273803 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
> {
>   "title": "출력 슬롯 방향으로 이동",
>   "code": "for (var iScrollOut=0;iScrollOut<8;iScrollOut++){await globalThis.sky.click({window:globalThis.targetWindow,x:1157,y:514});} nodeRepl.write(\"scrolled\");"
> }
> ```
>
> ```text
...
> {
>   "title": "출력 슬롯 표시 확인",
>   "code": "var sEcatScrolled = await globalThis.sky.get_window_state({window:globalThis.targetWindow,include_screenshot:true,include_text:false}); nodeRepl.write(sEcatScrolled);"
> }
> ```
>
> ```text
