...
> ```json
> {
>   "title": "Coupler client endpoint 복사",
>   "code": "var copyCouplerClient = await globalThis.sky.click({window:globalThis.targetWindow,x:616,y:389,screenshotId:\"screenshot-1\"}); nodeRepl.write(copyCouplerClient);"
> }
> ```
>
> ```text
...
> ```json
> {
>   "title": "EtherCAT 서버 endpoint 선택",
>   "code": "var openEcatForCoupler = await globalThis.sky.click({window:globalThis.targetWindow,x:837,y:114,screenshotId:\"screenshot-1\"}); nodeRepl.write(openEcatForCoupler);"
> }
> ```
>
> ```text
...
> ```json
> {
>   "title": "Coupler ClassState 값 위치 확인",
>   "code": "var snapEcatCouplerValue = await globalThis.sky.get_window_state({window:globalThis.targetWindow,include_screenshot:true,include_text:true}); nodeRepl.write(snapEcatCouplerValue);"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=33811 chars=9977 sha256=283ecdd100148dd413033c2309f59b3d537b8cd01af07f7f1b3c1e0193c80587]'... 295415 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=33820 chars=9977 sha256=5b074ec5efbb9d4b09dc495fb2e7bd3c79d1aedb6ce6a60fe58b55f2be9ccaab]'... 281519 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
>       id: 'screenshot-2',
>       zIndex: 2,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=33829 chars=9977 sha256=8055f5065e5a3abd55031ce760c78095a99b5457ad7c48160090b74e49a39131]'... 7703 more characters,
>       originX: -1038,
>       originY: 131,
>       width: 776,
>       height: 35
...
>       '\t\t\t\t2754 창 ID: 59648\n' +
>       '\t\t\t\t\t2755 창 #pragma usingLtd SigCLib #pragma usingLtd _StdLib FUNCTION VIRTUAL GLOBAL LMCEcatInputLatch::RtWork VAR_INPUT EAX : UDINT; END_VAR VAR_OUTPUT state (EAX) : UDINT; END_VAR VAR cycleCounter : UDINT; timestampLow : UDINT; timestampHigh : UDINT; previousTimestampLow : UD'... 20088 more characters,
...
> ```json
> {
>   "title": "Coupler ClassState 값 메뉴 확인",
>   "code": "var ctxCouplerValue = await globalThis.sky.click({window:globalThis.targetWindow,x:798,y:271,mouse_button:\"right\",screenshotId:\"screenshot-1\"}); nodeRepl.write(ctxCouplerValue);"
> }
> ```
>
> ```text
...
> ```json
> {
>   "title": "Coupler 서버 endpoint 메뉴 확인",
>   "code": "var snapCouplerServerMenu = await globalThis.sky.get_window_state({window:globalThis.targetWindow,include_screenshot:true,include_text:true}); nodeRepl.write(snapCouplerServerMenu);"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=33948 chars=9977 sha256=283ecdd100148dd413033c2309f59b3d537b8cd01af07f7f1b3c1e0193c80587]'... 285879 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=33957 chars=9977 sha256=5b074ec5efbb9d4b09dc495fb2e7bd3c79d1aedb6ce6a60fe58b55f2be9ccaab]'... 269679 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
>       id: 'screenshot-2',
>       zIndex: 2,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=33966 chars=6392 sha256=1f1611127e8d6800a3bd77bb8f831e474c04ecbf295ee0239984d194b058d64a]',
>       originX: -1077,
>       originY: 317,
>       width: 195,
>       height: 98
...
>       id: 'screenshot-3',
>       zIndex: 3,
>       url: 'data:image/jpeg;base64,',
>       originX: -1073,
>       originY: 415,
>       width: 195,
>       height: 4
...
>       id: 'screenshot-4',
>       zIndex: 4,
>       url: 'data:image/jpeg;base64,',
>       originX: -882,
>       originY: 321,
>       width: 4,
>       height: 94
...
>       '\t\t274667 창\n' +
>       '\t\t274668 메뉴\n' +
>       '\t\t\t274669 메뉴 항목 Goto Definition F11\n' +
>       '\t\t\t274670 메뉴 항목 (disabled) Goto Client\n' +
>       '\t\t\t274671 메뉴 항목 (disabled) Find References\n' +
>       '\t\t\t274672 메뉴 항목 Find in Implementation\n' +
