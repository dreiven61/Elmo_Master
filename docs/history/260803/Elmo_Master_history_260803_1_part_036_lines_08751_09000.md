...
> 			56 도구 모음 Script
> 			57 도구 모음 Edit
> 				11102 단추 Toggle bookmark
> 				11103 단추 (disabled) Previous bookmark
> 				11104 단추 (disabled) Next bookmark
> 				11105 단추 (disabled) Delete all bookmarks
> 				11106 단추 (disabled) Previous bookmark in this file
> 				11107 단추 (disabled) Next bookmark in this file
> 				11108 단추 (disabled) Comment selected text (Ctrl+Shift+C)
> 				11109 단추 (disabled) Remove comment (Ctrl+Shift+X)
> 				11110 단추 (disabled) Unindent (Shift+Tab)
> 				11111 단추 (disabled) Indent (Tab)
> 			68 도구 모음 Macros Manager
> 				11112 메뉴 항목 Macros
> 			70 도구 모음 Layout Manager
> 				11113 메뉴 항목 Layouts
> 			72 도구 모음 Toolbox
> 				11114 단추 DataAnalyzer
> 				11115 단추 Interpreter
> 				11116 단추 DiasDrive
> 				11117 단추 PLC Diagnosis
> 				11118 단추 Hardware Editor
> 				11119 단추 Graphical Hardware Editor
> 				11120 단추 Connection Manager
> 				11121 단추 Task Configuration
> 			81 도구 모음 Net Edit
> 				11122 단추 (disabled) Select
> 				11123 단추 (disabled) Move view
> 				11124 단추 (disabled) Insert comment
> 				11125 단추 (disabled) Zoom(+/-)
> 				11126 단추 (disabled) Zoom to all
> 				11127 단추 (disabled) Zoom selection
> 			88 도구 모음 Debug
> 				11128 단추 Go online (Alt+F6)
> 				11129 단추 Change Online Settings
> 				11130 메뉴 항목 Online Connection
> 				11131 단추 (disabled) Set Online Connection For Current Project
> 				11132 단추 (disabled) Download (F6)
> 				11133 단추 Build Changes, Online, Download and Run (CTRL+ALT+F6)
> 				11134 단추 (disabled) Download Module on the Fly
> 				11135 단추 (disabled) Save Project on PLC
> 				11136 단추 (disabled) Start (F7)
> 				11137 단추 (disabled) Reset (F8)
> 				11138 단추 Toggle breakpoint (F4)
> 				11139 단추 Create condition breakpoint
> 				11140 단추 (disabled) Remove all breakpoint(s) (Shift+F4)
> 				11141 단추 AWL trigger on/off
> 				11142 단추 (disabled) Fix AWL trigger to current instruction
> 				11143 단추 Activate/Deactivate Live View
> 				11144 단추 Activate/Deactivate Auto Watch
> 				11145 단추 (disabled) Goto instruction pointer
> 				11146 단추 (disabled) Step into (F5)
> 				11147 단추 (disabled) Step over (Alt+F5)
> 				11148 단추 (disabled) Step out (Shift+F5)
> 				11149 단추 (disabled) Set instruction pointer
> 			111 도구 모음 Build
> 				11150 메뉴 항목 Target Architecture
> 				11151 단추 Build changes (F9)
> 				11152 단추 Rebuild project (Strg+F9)
> 				11153 단추 (disabled) Cancel building (Ctrl+Break)
> 				11154 단추 Link project
> 			117 도구 모음 Standard
> 				11155 단추 New project (Strg+N)
> 				11156 단추 Open a file (Strg+Shift+O)
> 				11157 단추 Close active document (Strg+F4)
> 				11158 단추 (disabled) Save file (Strg+S)
> 				11159 단추 Open project (Strg+O)
> 				11160 단추 (disabled) Save project changes (Strg+Shift+S)
> 				11161 단추 Close project
> 				11162 단추 Print
> 				11163 단추 Cut (Strg+X)
> 				11164 단추 Copy (Strg+C)
> 				11165 단추 Paste (Strg+V)
> 				11166 메뉴 항목 Undo (Strg+Z)
> 				11167 메뉴 항목 (disabled) Redo (Strg+Y)
> 				11168 단추 Navigate Backward (Alt+Left)
> 				11169 단추 (disabled) Navigate Forward (Alt +Right)
> 			133 메뉴 모음 Menu Bar
> 				11170 메뉴 항목 FILE
> 				11171 메뉴 항목 EDIT
> 				11172 메뉴 항목 VIEW
...
> 			11181 탭 항목 (selectable) Python Script
> 			11182 탭 항목 (selectable) Debugger
> 			11183 탭 항목 (selectable) Output
> 			169 단추 Close
...
> 			11198 탭 항목 (selectable) Lib
> 			11199 탭 항목 (selectable) File
> 			11200 탭 항목 (selectable) Global
> 			11201 탭 항목 (selectable) Net
> 			11202 탭 항목 (selectable) Class
> 			195 단추 Close
> 		196 Tab Properties ID: 424886560
> 			197 창 ID: 309505912
> 				198 TABLE Properties Window ID: 315226536
> 					11203 custom Name
> 					11204 custom Revision
> 					11205 custom GUID
> 					11206 custom BaseClass
> 					11207 custom Task Settings
> 					11208 custom Sigmatek
> 					11209 custom OSInterface
> 					11210 custom IconPath
> 					11211 custom SharedCommandTable
> 					11212 custom Objectsize
> 					11213 custom Singleton
> 					11214 custom Hidden
> 					11215 custom Deprecated
> 					11216 custom GCCOptions
> 					11217 custom Comment
> 					11218 custom Filename
> 				214 도구 모음 ID: 59392
> 					215 단추
> 					216 단추
> 			11219 탭 항목 (selectable) Properties
> 			218 단추 Close
>
