...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=19509 chars=9977 sha256=75cd9ec269e88b5b7459eef83796c8512720c57840f4fac779c9b5c1fa9d3c0c]'... 234811 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
>   "code": "await globalThis.sky.click({window:globalThis.targetWindow,x:1186,y:183,screenshotId:\"screenshot-0\"});"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=19597 chars=9977 sha256=88caf2d8b8adbb746dd508fa777a510c14b0568869e23e5d4af68e115558f220]'... 253835 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=19606 chars=9977 sha256=75cd9ec269e88b5b7459eef83796c8512720c57840f4fac779c9b5c1fa9d3c0c]'... 234179 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
>       '\t\t\t16 창 LMCSdoExecutor Secondary Actions: Raise ID: 65281\n' +
>       '\t\t\t\t17 창 ID: 59648\n' +
>       '\t\t\t\t\t18 창 #pragma usingLtd SigCLib #define LMC_SDO_EXEC_IDLE 0 #define LMC_SDO_EXEC_ARMING 1 #define LMC_SDO_EXEC_RUNNING 2 #define LMC_SDO_EXEC_RESULT_READY 3 #define LMC_SDO_EXEC_ORPHANED 4 #define LMC_SDO_EXEC_QUARANTINED 5 #define LMC_SDO_EXEC_RELEASING 6 #define LMC_SDO_EXEC_VALID 0$UDINT #define LMC_SDO_EXEC_INVALID_VERSION 1 #define LMC_SDO_EXEC_INVALID_STATE 2 #define LMC_SDO_EXEC_INVALID_DIRECTION 3 #define LMC_SDO_EXEC_INVALID_INDEX 4 #define LMC_SDO_EXEC_INVALID_SUBINDEX 5 #define LMC_SDO_EXEC_INVALID_TOKEN 6 #define LMC_SDO_EXEC_INVALID_LENGTH 7 FUNCTION VIRTUAL GLOBAL LMCSdoExecutor::ParaReadWrite::Write VAR_INPUT input (EAX) : DINT; END_VAR VAR_OUTPUT result (EAX) : DINT; END_VAR // The production executor cannot be started through the manual channel. result := ParaReadWrite; END_FUNCTION FUNCTION VIRTUAL GLOBAL LMCSdoExecutor::ParaType::Write VAR_INPUT input (E'... 14378 more characters,
>     focused_element: '143 트리 ID: 103'
>   }
> }
> ```
...
>   "code": "await globalThis.sky.click({window:globalThis.targetWindow,x:1203,y:242,screenshotId:\"screenshot-0\"});"
> }
> ```
>
> ```text
...
> 			55 도구 모음 Edit
> 				116539 단추 Toggle bookmark
> 				116540 단추 (disabled) Previous bookmark
> 				116541 단추 (disabled) Next bookmark
> 				116542 단추 (disabled) Delete all bookmarks
> 				116543 단추 (disabled) Previous bookmark in this file
> 				116544 단추 (disabled) Next bookmark in this file
> 				116545 단추 (disabled) Comment selected text (Ctrl+Shift+C)
> 				116546 단추 (disabled) Remove comment (Ctrl+Shift+X)
> 				116547 단추 (disabled) Unindent (Shift+Tab)
> 				116548 단추 (disabled) Indent (Tab)
> 			66 도구 모음 Macros Manager
> 				116549 메뉴 항목 Macros
> 			68 도구 모음 Layout Manager
> 				116550 메뉴 항목 Layouts
> 			70 도구 모음 Toolbox
> 				116551 단추 DataAnalyzer
> 				116552 메뉴 항목 Toolbar Options
> 			73 도구 모음 Net Edit
> 				116553 단추 (disabled) Select
> 				116554 메뉴 항목 Toolbar Options
> 			76 도구 모음 Debug
> 				116555 단추 Go online (Alt+F6)
> 				116556 단추 Change Online Settings
> 				116557 메뉴 항목 Online Connection
> 				116558 단추 (disabled) Set Online Connection For Current Project
> 				116559 단추 (disabled) Download (F6)
> 				116560 단추 Build Changes, Online, Download and Run (CTRL+ALT+F6)
> 				116561 단추 (disabled) Download Module on the Fly
> 				116562 단추 (disabled) Save Project on PLC
> 				116563 단추 (disabled) Start (F7)
> 				116564 단추 (disabled) Reset (F8)
> 				116565 단추 Toggle breakpoint (F4)
> 				116566 단추 Create condition breakpoint
> 				116567 메뉴 항목 Toolbar Options
> 			90 도구 모음 Build
> 				116568 메뉴 항목 Target Architecture
> 				116569 단추 Build changes (F9)
> 				116570 단추 Rebuild project (Strg+F9)
> 				116571 단추 (disabled) Cancel building (Ctrl+Break)
> 				116572 단추 Link project
> 			96 도구 모음 Standard
> 				116573 단추 New project (Strg+N)
> 				116574 단추 Open a file (Strg+Shift+O)
