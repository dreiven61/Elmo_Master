...
>       '\t\t\t\t2754 창 ID: 59648\n' +
>       '\t\t\t\t\t2755 창 #pragma usingLtd SigCLib #pragma usingLtd _StdLib FUNCTION VIRTUAL GLOBAL LMCEcatInputLatch::RtWork VAR_INPUT EAX : UDINT; END_VAR VAR_OUTPUT state (EAX) : UDINT; END_VAR VAR cycleCounter : UDINT; timestampLow : UDINT; timestampHigh : UDINT; previousTimestampLow : UDINT; master'... 18760 more characters,
...
> {
>   "title": "입력 슬롯 연결 복사",
>   "code": "var keyCopyIn = await globalThis.sky.press_key({window:globalThis.targetWindow,key:\"CTRL+C\"}); nodeRepl.write(keyCopyIn);"
> }
> ```
>
> ```text
...
> ```json
> {
>   "title": "Motion 네트워크로 이동",
>   "code": "var cMotionAgain = await globalThis.sky.click({window:globalThis.targetWindow,x:583,y:114}); nodeRepl.write(cMotionAgain);"
> }
> ```
>
> ```text
...
> ```json
> {
>   "title": "입력 슬롯 클라이언트 확인",
>   "code": "var sMotionIn = await globalThis.sky.get_window_state({window:globalThis.targetWindow,include_screenshot:true,include_text:false}); nodeRepl.write(sMotionIn);"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=32369 chars=9977 sha256=a429bcb45353367824443e6bdd190064a8ac50f2a6bd1e771c57c677df13f7b4]'... 212855 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=32378 chars=9977 sha256=93202d42bbcfc72ccf2dc34f90c3c888217fac12f896ed05ca69612aa1991fc0]'... 197619 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
>       id: 'screenshot-2',
>       zIndex: 2,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=32387 chars=9977 sha256=5a0f14134f3685abb73ae8c083f985d69660b208675ba77f30ddf2a00fcaad63]'... 7711 more characters,
>       originX: -1297,
>       originY: 129,
>       width: 742,
>       height: 35
...
> ```json
> {
>   "title": "입력 슬롯 연결 붙여넣기 메뉴",
>   "code": "var rInMenu = await globalThis.sky.click({window:globalThis.targetWindow,x:562,y:378,mouse_button:\"right\",screenshotId:\"screenshot-1\"}); nodeRepl.write(rInMenu);"
> }
> ```
>
> ```text
...
> {
>   "title": "붙여넣기 메뉴 확인",
>   "code": "var sInMenu = await globalThis.sky.get_window_state({window:globalThis.targetWindow,include_screenshot:true,include_text:true}); nodeRepl.write(sInMenu);"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=32441 chars=9977 sha256=a429bcb45353367824443e6bdd190064a8ac50f2a6bd1e771c57c677df13f7b4]'... 212719 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=32450 chars=9977 sha256=93202d42bbcfc72ccf2dc34f90c3c888217fac12f896ed05ca69612aa1991fc0]'... 197223 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
>       id: 'screenshot-2',
>       zIndex: 2,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=32459 chars=9076 sha256=70e9b3e82e9737f37ab4f65c242197cf7801218ecab719449ed486cbb8a30466]',
>       originX: -1313,
>       originY: 424,
>       width: 195,
>       height: 161
...
>       id: 'screenshot-3',
>       zIndex: 3,
>       url: 'data:image/jpeg;base64,',
>       originX: -1309,
>       originY: 585,
>       width: 195,
>       height: 4
...
>       id: 'screenshot-4',
>       zIndex: 4,
>       url: 'data:image/jpeg;base64,',
>       originX: -1118,
>       originY: 428,
>       width: 4,
>       height: 157
...
>       '\t\t258922 창\n' +
>       '\t\t258923 메뉴\n' +
>       '\t\t\t259088 메뉴 항목 (disabled) Goto Server\n' +
>       '\t\t\t259089 메뉴 항목 Change Initvalue F2\n' +
>       '\t\t\t259090 메뉴 항목 Copy\n' +
>       '\t\t\t259091 메뉴 항목 Paste Connection\n' +
>       '\t\t\t259092 메뉴 항목 (disabled) Delete Connection\n' +
>       '\t\t\t259093 메뉴 항목 Insert new IO-Element\n' +
>       '\t\t\t259094 메뉴 항목 Find in Implementation\n' +
>       '\t\t1 창 작업 영역 ID: 59648\n' +
>       '\t\t\t155298 창 Motion_Network Secondary Actions: Raise ID: 65284\n' +
>       '\t\t\t\t155299 창 ID: 59648\n' +
>       '\t\t\t\t\t162758 스크롤 막대 세로 ID: NonClientVerticalScrollBar\n' +
