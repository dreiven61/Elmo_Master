...
>       '\t\t\t\t\t\t2766 위치 조정 (disabled)\n' +
>       '\t\t\t16 창 LMCSdoExecutor Secondary Actions: Raise ID: 652'... 14138 more characters,
...
> ```json
> {
>   "title": "CREVIS Coupler 채널 연결",
>   "code": "await globalThis.sky.press_key({window:globalThis.targetWindow,key:\"ESC\"}); await globalThis.sky.click({window:globalThis.targetWindow,x:1280,y:258}); await globalThis.sky.press_key({window:globalThis.targetWindow,key:\"CTRL+C\"}); await globalThis.sky.click({window:globalThis.targetWindow,x:612,y:311}); await globalThis.sky.press_key({window:globalThis.targetWindow,key:\"SHIFT+F10\"});"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=24556 chars=9977 sha256=a429bcb45353367824443e6bdd190064a8ac50f2a6bd1e771c57c677df13f7b4]'... 216263 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=24565 chars=9977 sha256=93202d42bbcfc72ccf2dc34f90c3c888217fac12f896ed05ca69612aa1991fc0]'... 199763 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
>       id: 'screenshot-2',
>       zIndex: 2,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=24574 chars=4884 sha256=ffa435e82183ce65d2ac793d66873287ada020908a7bd6c2d475c8014e7d891c]',
>       originX: -1221,
>       originY: 356,
>       width: 195,
>       height: 73
...
>       '\t\t189550 창\n' +
>       '\t\t189551 메뉴\n' +
>       '\t\t\t189714 메뉴 항목 Goto Definition F11\n' +
>       '\t\t\t189715 메뉴 항목 (disabled) Goto Server\n' +
>       '\t\t\t189716 메뉴 항목 Find in Implementation\n' +
>       '\t\t1 창 작업 영역 ID: 59648\n' +
...
>       '\t\t\t\t\t\t178069 단추 페이지 오른쪽으로 ID: DownPageButton\n' +
...
>       '\t\t\t\t17 창 ID: 59648\n' +
>       '\t\t\t\t\t18 창 #pragma usingLtd SigCLib #define LMC_SDO_EXEC_IDLE 0 #define LMC_SDO_EXEC_ARMING 1 #define LMC_SDO_EXEC_R'... 14109 more characters,
>     focused_element: '155299 창 ID: 59648'
>   }
> }
> ```
...
> ```json
> {
>   "title": "Coupler 접속점 선택",
>   "code": "await globalThis.sky.press_key({window:globalThis.targetWindow,key:\"ESC\"}); await globalThis.sky.click({window:globalThis.targetWindow,x:586,y:330}); await globalThis.sky.press_key({window:globalThis.targetWindow,key:\"SHIFT+F10\"});"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=24707 chars=9977 sha256=a429bcb45353367824443e6bdd190064a8ac50f2a6bd1e771c57c677df13f7b4]'... 213747 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=24716 chars=9977 sha256=93202d42bbcfc72ccf2dc34f90c3c888217fac12f896ed05ca69612aa1991fc0]'... 196579 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
>       id: 'screenshot-2',
>       zIndex: 2,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=24725 chars=9076 sha256=70e9b3e82e9737f37ab4f65c242197cf7801218ecab719449ed486cbb8a30466]',
>       originX: -1221,
>       originY: 375,
>       width: 195,
>       height: 161
...
>       id: 'screenshot-3',
>       zIndex: 3,
>       url: 'data:image/jpeg;base64,',
>       originX: -1217,
>       originY: 536,
>       width: 195,
>       height: 4
...
>       id: 'screenshot-4',
>       zIndex: 4,
>       url: 'data:image/jpeg;base64,',
>       originX: -1026,
>       originY: 379,
>       width: 4,
>       height: 157
