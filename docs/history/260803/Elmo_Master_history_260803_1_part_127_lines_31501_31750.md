...
>       '\t\t\t\t2754 창 ID: 59648\n' +
>       '\t\t\t\t\t2755 창 #pragma usingLtd SigCLib #pragma usingLtd _StdLib FUNCTION VIRTUAL GLOBAL LMCEcatInputL'... 19002 more characters,
...
> ```json
> {
>   "title": "Coupler 연결 붙여넣기 시험",
>   "code": "await globalThis.sky.press_key({window:globalThis.targetWindow,key:\"CTRL+C\"}); await globalThis.sky.click({window:globalThis.targetWindow,x:582,y:118}); await new Promise(r=>setTimeout(r,400)); await globalThis.sky.click({window:globalThis.targetWindow,x:560,y:331,mouse_button:\"right\"}); await new Promise(r=>setTimeout(r,300)); var pasteProbe260730 = await globalThis.sky.get_window_state({window:globalThis.targetWindow,include_screenshot:true,include_text:true}); nodeRepl.write(pasteProbe260730);"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=31572 chars=9977 sha256=a429bcb45353367824443e6bdd190064a8ac50f2a6bd1e771c57c677df13f7b4]'... 214299 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=31581 chars=9977 sha256=93202d42bbcfc72ccf2dc34f90c3c888217fac12f896ed05ca69612aa1991fc0]'... 197639 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
>       id: 'screenshot-2',
>       zIndex: 2,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=31590 chars=9076 sha256=70e9b3e82e9737f37ab4f65c242197cf7801218ecab719449ed486cbb8a30466]',
>       originX: -1319,
>       originY: 372,
>       width: 195,
>       height: 161
...
>       id: 'screenshot-4',
>       zIndex: 4,
>       url: 'data:image/jpeg;base64,',
>       originX: -1124,
>       originY: 376,
>       width: 4,
>       height: 157
...
>       '\t\t\t2753 창 LMCEcatInputLatch Secondary Actions: Raise ID: 65283\n' +
>       '\t\t\t\t2754 창 ID: 59648\n' +
>       '\t\t\t\t\t2755 창 #pragma usingLtd SigCLib #pragma usingLtd _StdLib FUNCTION VIRTUAL GLOBAL LMCEcatInputLatch::RtWork VAR_INPUT EAX : UDINT; END_VAR VAR_OUTPUT state (EAX) : UDINT; END_VAR VAR cycleCounter : UDINT; timestampLow : UDINT; timestampHigh : UDINT; previousTimestampLow : UDINT; master'... 18254 more characters,
...
> {
>   "title": "Coupler 연결 생성",
>   "code": "await globalThis.sky.click({window:globalThis.targetWindow,x:640,y:408}); await new Promise(r=>setTimeout(r,500)); var couplerConnected260730 = await globalThis.sky.get_window_state({window:globalThis.targetWindow,include_screenshot:true,include_text:true}); nodeRepl.write(couplerConnected260730);"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=31715 chars=9977 sha256=a429bcb45353367824443e6bdd190064a8ac50f2a6bd1e771c57c677df13f7b4]'... 208943 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=31724 chars=9977 sha256=93202d42bbcfc72ccf2dc34f90c3c888217fac12f896ed05ca69612aa1991fc0]'... 192991 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
>       '\t\t251112 창\n' +
>       '\t\t251113 메뉴\n' +
>       '\t\t\t251524 메뉴 항목 (disabled) Goto Server\n' +
>       '\t\t\t251525 메뉴 항목 Change Initvalue F2\n' +
>       '\t\t\t251526 메뉴 항목 Copy\n' +
>       '\t\t\t251527 메뉴 항목 Paste Connection\n' +
>       '\t\t\t251528 메뉴 항목 (disabled) Delete Connection\n' +
>       '\t\t\t251529 메뉴 항목 Insert new IO-Element\n' +
>       '\t\t\t251530 메뉴 항목 Find in Implementation\n' +
>       '\t\t1 창 작업 영역 ID: 59648\n' +
>       '\t\t\t155298 창 Motion_Network Secondary Actions: Raise ID: 65284\n' +
>       '\t\t\t\t155299 창 ID: 59648\n' +
>       '\t\t\t\t\t162758 스크롤 막대 세로 ID: NonClientVerticalScrollBar\n' +
