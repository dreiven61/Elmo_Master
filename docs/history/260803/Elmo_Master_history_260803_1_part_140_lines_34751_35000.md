...
>       '\t\t\t\t2754 창 ID: 59648\n' +
>       '\t\t\t\t\t2755 창 #pragma usingLtd SigCLib #pragma usingLtd _StdLib FUNCTION VIRTUAL GLOBAL LMCEcatInputLatch::RtWork VAR_INPUT EAX : UDINT; END_VAR VAR_OUTPUT state (EAX) : UDINT; END_VAR VAR cycleCounter : UDINT; timestampLow : UDINT; timestampHigh : UDINT; previousTimestamp'... 19935 more characters,
...
> ```json
> {
>   "title": "Copy InputSlot client",
>   "code": "await globalThis.sky.click({window:globalThis.targetWindow,x:561,y:374,mouse_button:\"right\",screenshotId:\"screenshot-1\"}); var inputClientMenu = await globalThis.sky.get_window_state({window:globalThis.targetWindow,include_screenshot:true,include_text:true}); nodeRepl.write(inputClientMenu.accessibility.tree.slice(0,700));"
> }
> ```
>
> ```text
...
> {
>   "title": "Copy InputSlot client",
>   "code": "await globalThis.sky.click({window:globalThis.targetWindow,x:621,y:432}); await new Promise(r=>setTimeout(r,250));"
> }
> ```
>
> ```text
...
> ```json
> {
>   "title": "Select EtherCAT network",
>   "code": "await globalThis.sky.click({window:globalThis.targetWindow,x:849,y:115}); await new Promise(r=>setTimeout(r,300)); var ecatStateInput = await globalThis.sky.get_window_state({window:globalThis.targetWindow,include_screenshot:true,include_text:true}); nodeRepl.write(ecatStateInput);"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=34841 chars=9977 sha256=039c45972dfb5a2d5f3c053ad25eda3734eed93c88d91449ed0c19aa5b9dd444]'... 295807 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=34850 chars=9977 sha256=85a4765b11735a79be20c844a383f2a59d61b41d61d3ea72a165749c57446bb3]'... 282231 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
>       id: 'screenshot-2',
>       zIndex: 2,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=34859 chars=9977 sha256=f4918daeb39282e6f9d88f97928f6a132a00372d901e214eaa0798f6271594ed]'... 8203 more characters,
>       originX: -1032,
>       originY: 130,
>       width: 776,
>       height: 35
...
>       '\t\t\t2753 창 LMCEcatInputLatch Secondary Actions: Raise ID: 65283\n' +
>       '\t\t\t\t2754 창 ID: 59648\n' +
>       '\t\t\t\t\t2755 창 #pragma usingLtd SigCLib #pragma usingLtd _StdLib FUNCTION VIRTUAL GLOBAL LMCEcatInputLatch::RtWork VAR_INPUT EAX : UDINT; END_VAR VAR_OUTPUT state (EAX) : UDINT; END_VAR VAR cycleCounter : UDINT; timestampLow : UDINT; timestampHigh : UDINT; previousTimestampLow : UDINT; ma'... 20059 more characters,
...
> ```json
> {
>   "title": "Zoom input slot endpoint",
>   "code": "var ecatInputBuf = Buffer.from(ecatStateInput.screenshots[1].url.split(\",\")[1],\"base64\"); var ecatInputCrop = await sharpMod.default(ecatInputBuf).extract({left:1025,top:238,width:125,height:90}).resize(1000,720,{kernel:\"nearest\"}).png().toBuffer(); await nodeRepl.emitImage(ecatInputCrop);"
> }
> ```
>
...
> ```json
> {
>   "title": "Open input slot ClassState menu",
>   "code": "await globalThis.sky.click({window:globalThis.targetWindow,x:1099,y:276,mouse_button:\"right\",screenshotId:\"screenshot-1\"}); var inputServerMenu = await globalThis.sky.get_window_state({window:globalThis.targetWindow,include_screenshot:true,include_text:true}); nodeRepl.write(inputServerMenu.accessibility.tree.slice(0,650));"
> }
> ```
>
> ```text
...
> ```json
> {
>   "title": "Paste InputSlot connection",
