...
> ```json
> {
>   "code": "state = await sky.get_window_state({window: targetWindow, include_screenshot:true, include_text:true}); console.log(state.accessibility?.tree || ''); state.screenshots"
> }
> ```
>
> ```text
...
> 			55 도구 모음 Script
> 			56 도구 모음 Edit
> 				22290 단추 (disabled) Toggle bookmark
> 				22291 단추 (disabled) Previous bookmark
> 				22292 단추 (disabled) Next bookmark
> 				22293 단추 (disabled) Delete all bookmarks
> 				22294 단추 (disabled) Previous bookmark in this file
> 				22295 단추 (disabled) Next bookmark in this file
> 				22296 단추 (disabled) Comment selected text (Ctrl+Shift+C)
> 				22297 단추 (disabled) Remove comment (Ctrl+Shift+X)
> 				22298 단추 (disabled) Unindent (Shift+Tab)
> 				22299 단추 (disabled) Indent (Tab)
> 			67 도구 모음 Macros Manager
> 				22300 메뉴 항목 Macros
> 			69 도구 모음 Layout Manager
> 				22301 메뉴 항목 Layouts
> 			71 도구 모음 Toolbox
> 				22302 단추 DataAnalyzer
> 				22303 단추 Interpreter
> 				22304 단추 DiasDrive
> 				22305 단추 PLC Diagnosis
> 				22306 단추 Hardware Editor
> 				22307 단추 Graphical Hardware Editor
> 				22308 단추 Connection Manager
> 				22309 단추 Task Configuration
> 			80 도구 모음 Net Edit
> 				22310 단추 Select
> 				22311 단추 Move view
> 				22312 단추 Insert comment
> 				22313 단추 Zoom(+/-)
> 				22314 단추 Zoom to all
> 				22315 단추 (disabled) Zoom selection
> 			87 도구 모음 Debug
> 				22316 단추 Go online (Alt+F6)
> 				22317 단추 (disabled) Change Online Settings
> 				22318 메뉴 항목 Online Connection
> 				22319 단추 (disabled) Set Online Connection For Current Project
> 				22320 단추 Download (F6)
> 				22321 단추 Build Changes, Online, Download and Run (CTRL+ALT+F6)
> 				22322 단추 Download Module on the Fly
> 				22323 단추 (disabled) Save Project on PLC
> 				22324 단추 (disabled) Start (F7)
> 				22325 단추 Reset (F8)
> 				22326 단추 (disabled) Toggle breakpoint (F4)
> 				22327 단추 (disabled) Create condition breakpoint
> 				22328 단추 (disabled) Remove all breakpoint(s) (Shift+F4)
> 				22329 단추 AWL trigger on/off
> 				22330 단추 (disabled) Fix AWL trigger to current instruction
> 				22331 단추 Activate/Deactivate Live View
> 				22332 단추 Activate/Deactivate Auto Watch
> 				22333 단추 (disabled) Goto instruction pointer
> 				22334 단추 (disabled) Step into (F5)
> 				22335 단추 (disabled) Step over (Alt+F5)
> 				22336 단추 (disabled) Step out (Shift+F5)
> 				22337 단추 (disabled) Set instruction pointer
> 			110 도구 모음 Build
> 				22338 메뉴 항목 (disabled) Target Architecture
> 				22339 단추 Build changes (F9)
> 				22340 단추 Rebuild project (Strg+F9)
> 				22341 단추 (disabled) Cancel building (Ctrl+Break)
> 				22342 단추 Link project
> 			116 도구 모음 Standard
> 				22343 단추 New project (Strg+N)
> 				22344 단추 Open a file (Strg+Shift+O)
> 				22345 단추 Close active document (Strg+F4)
> 				22346 단추 (disabled) Save file (Strg+S)
> 				22347 단추 Open project (Strg+O)
> 				22348 단추 (disabled) Save project changes (Strg+Shift+S)
> 				22349 단추 Close project
> 				22350 단추 Print
> 				22351 단추 Cut (Strg+X)
> 				22352 단추 Copy (Strg+C)
> 				22353 단추 Paste (Strg+V)
> 				22354 메뉴 항목 (disabled) Undo (Strg+Z)
> 				22355 메뉴 항목 (disabled) Redo (Strg+Y)
> 				22356 단추 (disabled) Navigate Backward (Alt+Left)
> 				22357 단추 (disabled) Navigate Forward (Alt +Right)
> 			132 메뉴 모음 Menu Bar
> 				22358 메뉴 항목 FILE
> 				22359 메뉴 항목 EDIT
> 				22360 메뉴 항목 NETEDIT
...
> 			22370 탭 항목 (selectable) Python Script
> 			22371 탭 항목 (selectable) Debugger
> 			22372 탭 항목 (selectable) Output
> 			200 단추 Close
...
> 			22373 탭 항목 (selectable) Lib
> 			22374 탭 항목 (selectable) File
> 			22375 탭 항목 (selectable) Global
