...
> ```json
> {
>   "title": "속성 입력 인터페이스 확인",
>   "code": "nodeRepl.write({set_value:String(globalThis.sky.set_value),drag:String(globalThis.sky.drag)});"
> }
> ```
>
> ```text
...
> ```json
> {
>   "title": "pDest 형식 목록 다시 열기",
>   "code": "await globalThis.sky.click({window:globalThis.targetWindow,x:1431,y:492,screenshotId:globalThis.state.screenshots[1].id});"
> }
> ```
>
> ```text
...
> ```json
> {
>   "title": "형식 목록 하단으로 스크롤",
>   "code": "await globalThis.sky.scroll({window:globalThis.targetWindow,x:1386,y:708,scrollY:6198,scrollX:0});"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=17495 chars=9977 sha256=3d34baa568e0957b24c1eb43e1acaa925a0e32e1aeddde2bed3a14da52fe4653]'... 213963 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
