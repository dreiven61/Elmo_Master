...
> 					12566 custom Name
> 					12567 custom Revision
> 					12568 custom GUID
> 					12569 custom BaseClass
> 					12570 custom Task Settings
> 					12571 custom Sigmatek
> 					12572 custom OSInterface
> 					12573 custom IconPath
> 					12574 custom SharedCommandTable
> 					12575 custom Objectsize
> 					12576 custom Singleton
> 					12577 custom Hidden
> 					12578 custom Deprecated
> 					12579 custom GCCOptions
> 					12580 custom Comment
> 					12581 custom Filename
> 				214 도구 모음 ID: 59392
> 					215 단추
> 					216 단추
> 			12582 탭 항목 (selectable) Properties
> 			218 단추 Close
>
...
> 			56 도구 모음 Script
> 			57 도구 모음 Edit
> 				12999 단추 Toggle bookmark
> 				13000 단추 (disabled) Previous bookmark
> 				13001 단추 (disabled) Next bookmark
> 				13002 단추 (disabled) Delete all bookmarks
> 				13003 단추 (disabled) Previous bookmark in this file
> 				13004 단추 (disabled) Next bookmark in this file
> 				13005 단추 (disabled) Comment selected text (Ctrl+Shift+C)
> 				13006 단추 (disabled) Remove comment (Ctrl+Shift+X)
> 				13007 단추 (disabled) Unindent (Shift+Tab)
> 				13008 단추 (disabled) Indent (Tab)
> 			68 도구 모음 Macros Manager
> 				13009 메뉴 항목 Macros
> 			70 도구 모음 Layout Manager
> 				13010 메뉴 항목 Layouts
> 			72 도구 모음 Toolbox
> 				13011 단추 DataAnalyzer
> 				13012 단추 Interpreter
> 				13013 단추 DiasDrive
> 				13014 단추 PLC Diagnosis
> 				13015 단추 Hardware Editor
> 				13016 단추 Graphical Hardware Editor
> 				13017 단추 Connection Manager
> 				13018 단추 Task Configuration
> 			81 도구 모음 Net Edit
> 				13019 단추 (disabled) Select
> 				13020 단추 (disabled) Move view
> 				13021 단추 (disabled) Insert comment
> 				13022 단추 (disabled) Zoom(+/-)
> 				13023 단추 (disabled) Zoom to all
> 				13024 단추 (disabled) Zoom selection
> 			88 도구 모음 Debug
> 				13025 단추 Go online (Alt+F6)
> 				13026 단추 Change Online Settings
> 				13027 메뉴 항목 Online Connection
> 				13028 단추 (disabled) Set Online Connection For Current Project
> 				13029 단추 (disabled) Download (F6)
> 				13030 단추 Build Changes, Online, Download and Run (CTRL+ALT+F6)
> 				13031 단추 (disabled) Download Module on the Fly
> 				13032 단추 (disabled) Save Project on PLC
> 				13033 단추 (disabled) Start (F7)
> 				13034 단추 (disabled) Reset (F8)
> 				13035 단추 Toggle breakpoint (F4)
> 				13036 단추 Create condition breakpoint
> 				13037 단추 (disabled) Remove all breakpoint(s) (Shift+F4)
> 				13038 단추 AWL trigger on/off
> 				13039 단추 (disabled) Fix AWL trigger to current instruction
> 				13040 단추 Activate/Deactivate Live View
> 				13041 단추 Activate/Deactivate Auto Watch
> 				13042 단추 (disabled) Goto instruction pointer
> 				13043 단추 (disabled) Step into (F5)
> 				13044 단추 (disabled) Step over (Alt+F5)
> 				13045 단추 (disabled) Step out (Shift+F5)
> 				13046 단추 (disabled) Set instruction pointer
> 			111 도구 모음 Build
> 				13047 메뉴 항목 Target Architecture
> 				13048 단추 Build changes (F9)
> 				13049 단추 Rebuild project (Strg+F9)
> 				13050 단추 (disabled) Cancel building (Ctrl+Break)
> 				13051 단추 Link project
> 			117 도구 모음 Standard
> 				13052 단추 New project (Strg+N)
> 				13053 단추 Open a file (Strg+Shift+O)
> 				13054 단추 Close active document (Strg+F4)
> 				13055 단추 (disabled) Save file (Strg+S)
> 				13056 단추 Open project (Strg+O)
> 				13057 단추 (disabled) Save project changes (Strg+Shift+S)
> 				13058 단추 Close project
> 				13059 단추 Print
> 				13060 단추 Cut (Strg+X)
> 				13061 단추 Copy (Strg+C)
> 				13062 단추 Paste (Strg+V)
> 				13063 메뉴 항목 Undo (Strg+Z)
> 				13064 메뉴 항목 (disabled) Redo (Strg+Y)
> 				13065 단추 Navigate Backward (Alt+Left)
> 				13066 단추 (disabled) Navigate Forward (Alt +Right)
> 			133 메뉴 모음 Menu Bar
> 				13067 메뉴 항목 FILE
> 				13068 메뉴 항목 EDIT
> 				13069 메뉴 항목 VIEW
...
> 			13078 탭 항목 (selectable) Python Script
> 			13079 탭 항목 (selectable) Debugger
> 			13080 탭 항목 (selectable) Output
> 			169 단추 Close
