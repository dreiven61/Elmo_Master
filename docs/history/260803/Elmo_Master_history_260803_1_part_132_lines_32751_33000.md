...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=32761 chars=9977 sha256=283ecdd100148dd413033c2309f59b3d537b8cd01af07f7f1b3c1e0193c80587]'... 289603 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=32770 chars=9977 sha256=5b074ec5efbb9d4b09dc495fb2e7bd3c79d1aedb6ce6a60fe58b55f2be9ccaab]'... 273407 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
> ```json
> {
>   "title": "EtherCAT 네트워크 가로 이동",
>   "code": "for (var iHorizOut=0;iHorizOut<12;iHorizOut++){await globalThis.sky.click({window:globalThis.targetWindow,x:856,y:513});} nodeRepl.write(\"horizontal\");"
> }
> ```
>
> ```text
...
> {
>   "title": "출력 슬롯 위치 재확인",
>   "code": "var sEcatHoriz = await globalThis.sky.get_window_state({window:globalThis.targetWindow,include_screenshot:true,include_text:false}); nodeRepl.write(sEcatHoriz);"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=32822 chars=9977 sha256=283ecdd100148dd413033c2309f59b3d537b8cd01af07f7f1b3c1e0193c80587]'... 286851 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=32831 chars=9977 sha256=5b074ec5efbb9d4b09dc495fb2e7bd3c79d1aedb6ce6a60fe58b55f2be9ccaab]'... 272019 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
> ```json
> {
>   "title": "출력 슬롯 연결 탐색 메뉴",
>   "code": "var rLineOut = await globalThis.sky.click({window:globalThis.targetWindow,x:853,y:505,mouse_button:\"right\"}); nodeRepl.write(rLineOut);"
> }
> ```
>
> ```text
...
> {
>   "title": "연결 탐색 메뉴 확인",
>   "code": "var sLineMenu = await globalThis.sky.get_window_state({window:globalThis.targetWindow,include_screenshot:true,include_text:true}); nodeRepl.write(sLineMenu);"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=32883 chars=9977 sha256=283ecdd100148dd413033c2309f59b3d537b8cd01af07f7f1b3c1e0193c80587]'... 287087 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=32892 chars=9977 sha256=5b074ec5efbb9d4b09dc495fb2e7bd3c79d1aedb6ce6a60fe58b55f2be9ccaab]'... 272039 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
>       id: 'screenshot-2',
>       zIndex: 2,
>       url: 'data:image/jpeg;base64,',
>       originX: -1028,
>       originY: 544,
>       width: 147,
>       height: 48
...
>       id: 'screenshot-3',
>       zIndex: 3,
>       url: 'data:image/jpeg;base64,',
>       originX: -1024,
>       originY: 592,
>       width: 147,
>       height: 4
...
>       id: 'screenshot-4',
>       zIndex: 4,
>       url: 'data:image/jpeg;base64,',
>       originX: -881,
>       originY: 548,
>       width: 4,
>       height: 44
...
>       '\t\t\t\t2754 창 ID: 59648\n' +
>       '\t\t\t\t\t2755 창 #pragma usingLtd SigCLib #pragma usingLtd _StdLib FUNCTION VIRTUAL GLOBAL LMCEcatInputLatch::RtWork VAR_INPUT EAX : UDINT; END_VAR VAR_OUTPUT state (EAX) : UDINT; END_VAR VAR cycleCounter :'... 20176 more characters,
