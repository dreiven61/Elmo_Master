...
>       '\t\t\t\t\t9464 스크롤 막대 가로 ID: NonClient'... 21140 more characters,
...
> ```json
> {
>   "title": "LASAL 라이브러리 유지",
>   "code": "await globalThis.sky.click({window:globalThis.targetWindow,x:811,y:454,screenshotId:globalThis.state.screenshots[0].id}); globalThis.state=await globalThis.sky.get_window_state({window:globalThis.targetWindow,include_screenshot:true,include_text:true}); nodeRepl.write(globalThis.state);"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=57586 chars=9977 sha256=388ba7701fc4325482100153dde8b57fef0dc7c369b66abc342f23ba58e79c8a]'... 370671 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=57595 chars=9977 sha256=4197055967f223b19f6d768bfc3fef961174019ad4d4caddd861169b1489982c]'... 363791 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
>       id: 'screenshot-2',
>       zIndex: 2,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=57604 chars=9977 sha256=55d9dbc90143baa8c53a240ee9de67947c0af81ea91d4127e27e75b26d55e18b]'... 2471 more characters,
>       originX: -1326,
>       originY: 343,
>       width: 343,
>       height: 152
...
>       '\t\t\t\t\t\t9462 단추 페이지 아래로 ID: DownPageButton\n' +
>       '\t\t\t\t\t\t9463 단추 아래쪽 스크롤 화살표 ID: DownButton\n' +
>       '\t\t\t\t\t9464 스크롤 막대 가로 ID'... 22009 more characters,
>     focused_element: '179758 대화 상자 Lasal Class 2 Secondary Actions: Raise'
>   }
> }
> ```
>
...
> ```json
> {
>   "title": "잘못된 미저장 LASAL 상태 폐기",
>   "code": "await globalThis.sky.click({window:globalThis.targetWindow,x:759,y:431,screenshotId:globalThis.state.screenshots[0].id}); await new Promise(r=>setTimeout(r,1500)); nodeRepl.write(await globalThis.sky.list_windows());"
> }
> ```
>
> ```text
