...
>       '\t\t315852 창\n' +
>       '\t\t315853 메뉴\n' +
>       '\t\t\t317767 메뉴 항목 Edit Source Enter\n' +
>       '\t\t\t317768 메뉴 항목 Edit Defines\n' +
>       '\t\t\t317769 메뉴 항목 Delete Del\n' +
>       '\t\t\t317770 메뉴 항목 Duplicate Class\n' +
>       '\t\t\t317771 메뉴 항목 Derive Class\n' +
>       '\t\t\t317772 메뉴 항목 Find Reference\n' +
>       '\t\t\t317773 메뉴 항목 Print Class\n' +
>       '\t\t\t317774 메뉴 항목 Export Class(es)\n' +
>       '\t\t\t317775 메뉴 항목 Reload Class\n' +
>       '\t\t\t317776 메뉴 항목 Re\\Import MatLab Model\n' +
>       '\t\t\t317777 메뉴 항목 Protection Setting\n' +
>       '\t\t\t317778 메뉴 항목 New Server\n' +
>       '\t\t\t317779 메뉴 항목 New Client\n' +
>       '\t\t\t317780 메뉴 항목 New Method\n' +
>       '\t\t\t317781 메뉴 항목 New Std. Methods\n' +
>       '\t\t\t317782 메뉴 항목 New Variable\n' +
>       '\t\t\t317783 메뉴 항목 New Type\n' +
>       '\t\t\t317784 메뉴 항목 New Table\n' +
>       '\t\t\t317785 메뉴 항목 Add Network\n' +
>       '\t\t\t317786 메뉴 항목 Add File...\n' +
>       '\t\t\t317787 메뉴 항목 Open Subfolders\n' +
>       '\t\t\t317788 메뉴 항목 Paste\n' +
>       '\t\t\t317789 메뉴 항목 Copy\n' +
>       '\t\t1 창 작업 영역 ID: 59648\n' +
...
> ```json
> {
>   "title": "Open LASAL object smoke menu",
>   "code": "await globalThis.sky.click({window:globalThis.targetWindow,screenshotId:\"screenshot-1\",x:700,y:300,mouse_button:\"right\"}); await new Promise(r=>setTimeout(r,200)); var networkMenuSmoke = await globalThis.sky.get_window_state({window:globalThis.targetWindow,include_screenshot:true,include_text:true}); nodeRepl.write(networkMenuSmoke);"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=37607 chars=9977 sha256=a429bcb45353367824443e6bdd190064a8ac50f2a6bd1e771c57c677df13f7b4]'... 296727 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=37616 chars=9977 sha256=93202d42bbcfc72ccf2dc34f90c3c888217fac12f896ed05ca69612aa1991fc0]'... 276267 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
>       id: 'screenshot-2',
>       zIndex: 2,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=37625 chars=9977 sha256=195e1e0f4b583045a322cd0be56056304a13251e47c2e7e467b9db1117d6ae6d]'... 7223 more characters,
>       originX: -1175,
>       originY: 346,
>       width: 249,
>       height: 245
...
>       id: 'screenshot-4',
>       zIndex: 4,
>       url: 'data:image/jpeg;base64,',
>       originX: -926,
>       originY: 350,
>       width: 4,
>       height: 241
...
>       '\t\t\t\t3 창 ID: 59648\n' +
>       '\t\t\t\t\t4 창 #pragma usingLtd _StdLib #define LMC_DIAG_SCHEMA_VERSION 1 #define LMC'... 19270 more characters,
...
> ```json
> {
>   "title": "Locate LASAL implementation search",
>   "code": "await globalThis.sky.press_key({window:globalThis.targetWindow,key:\"Escape\"}); await globalThis.sky.click({window:globalThis.targetWindow,x:610,y:312,mouse_button:\"right\"}); await new Promise(r=>setTimeout(r,200)); var channelMenuSmoke = await globalThis.sky.get_window_state({window:globalThis.targetWindow,include_screenshot:true,include_text:true}); nodeRepl.write(channelMenuSmoke);"
> }
> ```
>
> ```text
