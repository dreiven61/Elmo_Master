...
> 			56 도구 모음 Script
> 			57 도구 모음 Edit
> 				11636 단추 Toggle bookmark
> 				11637 단추 (disabled) Previous bookmark
> 				11638 단추 (disabled) Next bookmark
> 				11639 단추 (disabled) Delete all bookmarks
> 				11640 단추 (disabled) Previous bookmark in this file
> 				11641 단추 (disabled) Next bookmark in this file
> 				11642 단추 (disabled) Comment selected text (Ctrl+Shift+C)
> 				11643 단추 (disabled) Remove comment (Ctrl+Shift+X)
> 				11644 단추 (disabled) Unindent (Shift+Tab)
> 				11645 단추 (disabled) Indent (Tab)
> 			68 도구 모음 Macros Manager
> 				11646 메뉴 항목 Macros
> 			70 도구 모음 Layout Manager
> 				11647 메뉴 항목 Layouts
> 			72 도구 모음 Toolbox
> 				11648 단추 DataAnalyzer
> 				11649 단추 Interpreter
> 				11650 단추 DiasDrive
> 				11651 단추 PLC Diagnosis
> 				11652 단추 Hardware Editor
> 				11653 단추 Graphical Hardware Editor
> 				11654 단추 Connection Manager
> 				11655 단추 Task Configuration
> 			81 도구 모음 Net Edit
> 				11656 단추 (disabled) Select
> 				11657 단추 (disabled) Move view
> 				11658 단추 (disabled) Insert comment
> 				11659 단추 (disabled) Zoom(+/-)
> 				11660 단추 (disabled) Zoom to all
> 				11661 단추 (disabled) Zoom selection
> 			88 도구 모음 Debug
> 				11662 단추 Go online (Alt+F6)
> 				11663 단추 Change Online Settings
> 				11664 메뉴 항목 Online Connection
> 				11665 단추 (disabled) Set Online Connection For Current Project
> 				11666 단추 (disabled) Download (F6)
> 				11667 단추 Build Changes, Online, Download and Run (CTRL+ALT+F6)
> 				11668 단추 (disabled) Download Module on the Fly
> 				11669 단추 (disabled) Save Project on PLC
> 				11670 단추 (disabled) Start (F7)
> 				11671 단추 (disabled) Reset (F8)
> 				11672 단추 Toggle breakpoint (F4)
> 				11673 단추 Create condition breakpoint
> 				11674 단추 (disabled) Remove all breakpoint(s) (Shift+F4)
> 				11675 단추 AWL trigger on/off
> 				11676 단추 (disabled) Fix AWL trigger to current instruction
> 				11677 단추 Activate/Deactivate Live View
> 				11678 단추 Activate/Deactivate Auto Watch
> 				11679 단추 (disabled) Goto instruction pointer
> 				11680 단추 (disabled) Step into (F5)
> 				11681 단추 (disabled) Step over (Alt+F5)
> 				11682 단추 (disabled) Step out (Shift+F5)
> 				11683 단추 (disabled) Set instruction pointer
> 			111 도구 모음 Build
> 				11684 메뉴 항목 Target Architecture
> 				11685 단추 Build changes (F9)
> 				11686 단추 Rebuild project (Strg+F9)
> 				11687 단추 (disabled) Cancel building (Ctrl+Break)
> 				11688 단추 Link project
> 			117 도구 모음 Standard
> 				11689 단추 New project (Strg+N)
> 				11690 단추 Open a file (Strg+Shift+O)
> 				11691 단추 Close active document (Strg+F4)
> 				11692 단추 (disabled) Save file (Strg+S)
> 				11693 단추 Open project (Strg+O)
> 				11694 단추 (disabled) Save project changes (Strg+Shift+S)
> 				11695 단추 Close project
> 				11696 단추 Print
> 				11697 단추 Cut (Strg+X)
> 				11698 단추 Copy (Strg+C)
> 				11699 단추 Paste (Strg+V)
> 				11700 메뉴 항목 Undo (Strg+Z)
> 				11701 메뉴 항목 (disabled) Redo (Strg+Y)
> 				11702 단추 Navigate Backward (Alt+Left)
> 				11703 단추 (disabled) Navigate Forward (Alt +Right)
> 			133 메뉴 모음 Menu Bar
> 				11704 메뉴 항목 FILE
> 				11705 메뉴 항목 EDIT
> 				11706 메뉴 항목 VIEW
...
> 			11715 탭 항목 (selectable) Python Script
> 			11716 탭 항목 (selectable) Debugger
> 			11717 탭 항목 (selectable) Output
> 			169 단추 Close
...
> 			11718 탭 항목 (selectable) Lib
> 			11719 탭 항목 (selectable) File
> 			11720 탭 항목 (selectable) Global
> 			11721 탭 항목 (selectable) Net
> 			11722 탭 항목 (selectable) Class
> 			195 단추 Close
> 		196 Tab Properties ID: 424886560
> 			197 창 ID: 309505912
> 				198 TABLE Properties Window ID: 315226536
> 					11723 편집 ID: 1059599624
> 					11724 custom Name
> 					11725 custom Revision
> 					11726 custom GUID
> 					11727 custom BaseClass
> 					11728 custom Task Settings
> 					11729 custom Sigmatek
> 					11730 custom OSInterface
> 					11731 custom IconPath
> 					11732 custom SharedCommandTable
> 					11733 custom Objectsize
> 					11734 custom Singleton
> 					11735 custom Hidden
> 					11736 custom Deprecated
> 					11737 custom GCCOptions
> 					11738 custom Comment
> 					11739 custom Filename
> 				214 도구 모음 ID: 59392
> 					215 단추
