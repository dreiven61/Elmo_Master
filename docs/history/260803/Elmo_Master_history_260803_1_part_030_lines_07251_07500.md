> 					203 custom Sigmatek
> 					204 custom OSInterface
> 					205 custom IconPath
> 					206 custom SharedCommandTable
> 					207 custom Objectsize
> 					208 custom Singleton
> 					209 custom Hidden
> 					210 custom Deprecated
> 					211 custom GCCOptions
> 					212 custom Comment
> 					213 custom Filename
> 				214 도구 모음 ID: 59392
> 					215 단추
> 					216 단추
> 			217 탭 항목 (selectable) Properties
> 			218 단추 Close
>
...
> 			56 도구 모음 Script
> 			57 도구 모음 Edit
> 				1764 단추 Toggle bookmark
> 				1765 단추 (disabled) Previous bookmark
> 				1766 단추 (disabled) Next bookmark
> 				1767 단추 (disabled) Delete all bookmarks
> 				1768 단추 (disabled) Previous bookmark in this file
> 				1769 단추 (disabled) Next bookmark in this file
> 				1770 단추 Comment selected text (Ctrl+Shift+C)
> 				1771 단추 Remove comment (Ctrl+Shift+X)
> 				1772 단추 Unindent (Shift+Tab)
> 				1773 단추 Indent (Tab)
...
> 				1775 메뉴 항목 Layouts
> 			72 도구 모음 Toolbox
> 				1776 단추 DataAnalyzer
> 				1777 단추 Interpreter
> 				1778 단추 DiasDrive
> 				1779 단추 PLC Diagnosis
> 				1780 단추 Hardware Editor
> 				1781 단추 Graphical Hardware Editor
> 				1782 단추 Connection Manager
> 				1783 단추 Task Configuration
> 			81 도구 모음 Net Edit
> 				1784 단추 (disabled) Select
> 				1785 단추 (disabled) Move view
> 				1786 단추 (disabled) Insert comment
> 				1787 단추 (disabled) Zoom(+/-)
> 				1788 단추 (disabled) Zoom to all
> 				1789 단추 (disabled) Zoom selection
> 			88 도구 모음 Debug
> 				1790 단추 Go online (Alt+F6)
> 				1791 단추 Change Online Settings
> 				1792 메뉴 항목 Online Connection
> 				1793 단추 (disabled) Set Online Connection For Current Project
> 				1794 단추 (disabled) Download (F6)
> 				1795 단추 Build Changes, Online, Download and Run (CTRL+ALT+F6)
> 				1796 단추 (disabled) Download Module on the Fly
> 				1797 단추 (disabled) Save Project on PLC
> 				1798 단추 (disabled) Start (F7)
> 				1799 단추 (disabled) Reset (F8)
> 				1800 단추 Toggle breakpoint (F4)
> 				1801 단추 Create condition breakpoint
> 				1802 단추 (disabled) Remove all breakpoint(s) (Shift+F4)
> 				1803 단추 AWL trigger on/off
> 				1804 단추 (disabled) Fix AWL trigger to current instruction
> 				1805 단추 Activate/Deactivate Live View
> 				1806 단추 Activate/Deactivate Auto Watch
> 				1807 단추 (disabled) Goto instruction pointer
> 				1808 단추 (disabled) Step into (F5)
> 				1809 단추 (disabled) Step over (Alt+F5)
> 				1810 단추 (disabled) Step out (Shift+F5)
> 				1811 단추 (disabled) Set instruction pointer
> 			111 도구 모음 Build
> 				1812 메뉴 항목 Target Architecture
> 				1813 단추 Build changes (F9)
> 				1814 단추 Rebuild project (Strg+F9)
> 				1815 단추 (disabled) Cancel building (Ctrl+Break)
> 				1816 단추 Link project
> 			117 도구 모음 Standard
> 				1817 단추 New project (Strg+N)
> 				1818 단추 Open a file (Strg+Shift+O)
> 				1819 단추 Close active document (Strg+F4)
> 				1820 단추 (disabled) Save file (Strg+S)
> 				1821 단추 Open project (Strg+O)
> 				1822 단추 (disabled) Save project changes (Strg+Shift+S)
> 				1823 단추 Close project
> 				1824 단추 Print
> 				1825 단추 Cut (Strg+X)
> 				1826 단추 Copy (Strg+C)
> 				1827 단추 Paste (Strg+V)
> 				1828 메뉴 항목 (disabled) Undo (Strg+Z)
> 				1829 메뉴 항목 (disabled) Redo (Strg+Y)
> 				1830 단추 Navigate Backward (Alt+Left)
> 				1831 단추 (disabled) Navigate Forward (Alt +Right)
> 			133 메뉴 모음 Menu Bar
> 				1832 메뉴 항목 FILE
> 				1833 메뉴 항목 EDIT
> 				1834 메뉴 항목 VIEW
...
> 			1843 탭 항목 (selectable) Python Script
> 			1844 탭 항목 (selectable) Debugger
> 			1845 탭 항목 (selectable) Output
> 			169 단추 Close
...
> 			1846 탭 항목 (selectable) Lib
> 			1847 탭 항목 (selectable) File
> 			1848 탭 항목 (selectable) Global
> 			1849 탭 항목 (selectable) Net
> 			1850 탭 항목 (selectable) Class
> 			195 단추 Close
