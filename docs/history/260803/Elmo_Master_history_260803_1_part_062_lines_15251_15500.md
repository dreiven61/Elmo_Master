...
> ```json
> {
>   "title": "Variables 폴더 찾기",
>   "code": "nodeRepl.write(globalThis.state.accessibility.tree.split(\"\\n\").filter(x=>/\\bVariables\\b/.test(x) && x.includes(\"트리\")).join(\"\\n\"));"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=15332 chars=9977 sha256=3d34baa568e0957b24c1eb43e1acaa925a0e32e1aeddde2bed3a14da52fe4653]'... 201783 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=15341 chars=9977 sha256=2743db4c85442c03990bff57c7553f8e898672daf40dd4399065c5f949a343a2]'... 181719 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
>       id: 'screenshot-2',
>       zIndex: 2,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=15350 chars=4900 sha256=99c271802d9ab6dec812d9fed094b5f1d4ed5f987502657d8319a0be3bc98022]',
>       originX: -634,
>       originY: 362,
>       width: 143,
>       height: 98
...
>       id: 'screenshot-4',
>       zIndex: 4,
>       url: 'data:image/jpeg;base64,',
>       originX: -491,
>       originY: 366,
>       width: 4,
>       height: 94
...
>       '\t\t59478 창\n' +
>       '\t\t59479 메뉴\n' +
>       '\t\t\t59699 메뉴 항목 New Variable\n' +
>       '\t\t\t59700 메뉴 항목 Sort Variables\n' +
>       '\t\t\t59701 메뉴 항목 Paste\n' +
>       '\t\t\t59702 메뉴 항목 Copy\n' +
>       '\t\t1 창 작업 영역 ID: 59648\n' +
...
> ```json
> {
>   "title": "OutputObserved 변수 생성",
>   "code": "await globalThis.sky.click({window:globalThis.targetWindow,element_index:59699});"
> }
> ```
>
> ```text
> element 59699 is not available in cached app state for Lasal2.exe
> ```
>
> MCP tool call
>
...
> {
>   "title": "OutputObserved 변수 생성",
>   "code": "await globalThis.sky.click({window:globalThis.targetWindow,x:1308,y:335,screenshotId:globalThis.state.screenshots[1].id});"
> }
> ```
>
> ```text
...
> ```json
> {
>   "title": "OutputObserved 이름 입력",
>   "code": "await globalThis.sky.type_text({window:globalThis.targetWindow,text:\"OutputObserved\"});"
> }
> ```
>
> ```text
