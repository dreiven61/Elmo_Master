...
> 			4633 탭 항목 (selectable) Lib
> 			4634 탭 항목 (selectable) File
> 			4635 탭 항목 (selectable) Global
> 			4636 탭 항목 (selectable) Net
> 			4637 탭 항목 (selectable) Class
> 			195 단추 Close
> 		196 Tab Properties ID: 424886560
> 			197 창 (disabled) ID: 309505912
> 				198 TABLE Properties Window ID: 315226536
> 					4638 custom Name
> 					4639 custom Revision
> 					4640 custom GUID
> 					4641 custom Task Settings
> 					4642 custom Sigmatek
> 					4643 custom OSInterface
> 					4644 custom IconPath
> 					4645 custom SharedCommandTable
> 					4646 custom Objectsize
> 					4647 custom Singleton
> 					4648 custom Hidden
> 					4649 custom Deprecated
> 					4650 custom GCCOptions
> 					4651 custom Comment
> 					4652 custom Filename
> 				214 도구 모음 ID: 59392
> 					215 단추
> 					216 단추
> 			4653 탭 항목 (selectable) Properties
> 			218 단추 Close
>
...
>
> ```text
> Window: "Lasal Class 2 (02.03.001) - {Elmo_EtherCAT_Test_4Axis} - LMCDiagnosticsService [RO]", App: Lasal2.exe.
> 	0 창 Lasal Class 2 (02.03.001) - {Elmo_EtherCAT_Test_4Axis} - LMCDiagnosticsService [RO] Secondary Actions: Raise
> 		1 창 작업 영역 ID: 59648
> 			2 창 LMCDiagnosticsService [RO] Secondary Actions: Raise ID: 65282
> 				3 창 ID: 59648
...
> 						15 위치 조정 (disabled)
> 			16 창 LMCSdoExecutor [RO] Secondary Actions: Raise ID: 65281
> 				17 창 ID: 59648
...
> 			56 도구 모음 Script
> 			57 도구 모음 Edit
> 				6123 단추 Toggle bookmark
> 				6124 단추 (disabled) Previous bookmark
> 				6125 단추 (disabled) Next bookmark
> 				6126 단추 (disabled) Delete all bookmarks
> 				6127 단추 (disabled) Previous bookmark in this file
> 				6128 단추 (disabled) Next bookmark in this file
> 				6129 단추 (disabled) Comment selected text (Ctrl+Shift+C)
> 				6130 단추 (disabled) Remove comment (Ctrl+Shift+X)
> 				6131 단추 (disabled) Unindent (Shift+Tab)
> 				6132 단추 (disabled) Indent (Tab)
> 			68 도구 모음 Macros Manager
> 				6133 메뉴 항목 Macros
> 			70 도구 모음 Layout Manager
> 				6134 메뉴 항목 Layouts
> 			72 도구 모음 Toolbox
> 				6135 단추 DataAnalyzer
> 				6136 단추 Interpreter
> 				6137 단추 DiasDrive
> 				6138 단추 PLC Diagnosis
> 				6139 단추 (disabled) Hardware Editor
> 				6140 단추 (disabled) Graphical Hardware Editor
> 				6141 단추 (disabled) Connection Manager
> 				6142 단추 (disabled) Task Configuration
> 			81 도구 모음 Net Edit
> 				6143 단추 (disabled) Select
> 				6144 단추 (disabled) Move view
> 				6145 단추 (disabled) Insert comment
> 				6146 단추 (disabled) Zoom(+/-)
> 				6147 단추 (disabled) Zoom to all
> 				6148 단추 (disabled) Zoom selection
> 			88 도구 모음 Debug
> 				6149 단추 (disabled) Go online (Alt+F6)
> 				6150 단추 (disabled) Change Online Settings
> 				6151 메뉴 항목 (disabled) Online Connection
> 				6152 단추 (disabled) Set Online Connection For Current Project
> 				6153 단추 (disabled) Download (F6)
> 				6154 단추 (disabled) Build Changes, Online, Download and Run (CTRL+ALT+F6)
> 				6155 단추 (disabled) Download Module on the Fly
> 				6156 단추 (disabled) Save Project on PLC
> 				6157 단추 (disabled) Start (F7)
> 				6158 단추 (disabled) Reset (F8)
> 				6159 단추 Toggle breakpoint (F4)
> 				6160 단추 Create condition breakpoint
> 				6161 단추 (disabled) Remove all breakpoint(s) (Shift+F4)
> 				6162 단추 AWL trigger on/off
> 				6163 단추 (disabled) Fix AWL trigger to current instruction
> 				6164 단추 Activate/Deactivate Live View
> 				6165 단추 Activate/Deactivate Auto Watch
> 				6166 단추 (disabled) Goto instruction pointer
> 				6167 단추 (disabled) Step into (F5)
> 				6168 단추 (disabled) Step over (Alt+F5)
> 				6169 단추 (disabled) Step out (Shift+F5)
> 				6170 단추 (disabled) Set instruction pointer
> 			111 도구 모음 Build
> 				6171 메뉴 항목 (disabled) Target Architecture
> 				6172 단추 (disabled) Build changes (F9)
> 				6173 단추 (disabled) Rebuild project (Strg+F9)
> 				6174 단추 Cancel building (Ctrl+Break)
> 				6175 단추 (disabled) Link project
> 			117 도구 모음 Standard
> 				6176 단추 (disabled) New project (Strg+N)
> 				6177 단추 Open a file (Strg+Shift+O)
> 				6178 단추 Close active document (Strg+F4)
> 				6179 단추 (disabled) Save file (Strg+S)
> 				6180 단추 (disabled) Open project (Strg+O)
> 				6181 단추 (disabled) Save project changes (Strg+Shift+S)
> 				6182 단추 (disabled) Close project
> 				6183 단추 Print
> 				6184 단추 Cut (Strg+X)
> 				6185 단추 Copy (Strg+C)
> 				6186 단추 (disabled) Paste (Strg+V)
> 				6187 메뉴 항목 (disabled) Undo (Strg+Z)
> 				6188 메뉴 항목 (disabled) Redo (Strg+Y)
> 				6189 단추 Navigate Backward (Alt+Left)
> 				6190 단추 (disabled) Navigate Forward (Alt +Right)
> 			133 메뉴 모음 Menu Bar
> 				6191 메뉴 항목 FILE
> 				6192 메뉴 항목 EDIT
> 				6193 메뉴 항목 VIEW
...
> 						6095 목록 항목 (selectable)
> 						6096 목록 항목 (selectable)
> 						6097 목록 항목 (selectable)
> 						6098 목록 항목 (selectable)
> 						6202 목록 항목 (selectable)
> 						6203 목록 항목 (selectable)
> 						6204 목록 항목 (selectable)
> 						6205 목록 항목 (selectable)
> 						6206 목록 항목 (selectable)
> 						6207 목록 항목 (selectable)
> 						6208 목록 항목 (selectable)
> 						6209 목록 항목 (selectable)
> 						6210 목록 항목 (selectable)
> 						6211 목록 항목 (selectable)
> 						6212 목록 항목 (selectable)
> 					162 스크롤 막대 (disabled) ID: 59904
> 						163 단추 왼쪽 스크롤 화살표 ID: UpButton
> 						164 위치 조정 위치 ID: ScrollbarThumb
> 						165 단추 오른쪽 스크롤 화살표 ID: DownButton
> 			6213 탭 항목 (selectable) Python Script
> 			6214 탭 항목 (selectable) Debugger
> 			6215 탭 항목 (selectable) Output
> 			169 단추 Close
