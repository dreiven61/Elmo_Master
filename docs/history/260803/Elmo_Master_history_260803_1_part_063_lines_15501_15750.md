...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=15514 chars=9977 sha256=3d34baa568e0957b24c1eb43e1acaa925a0e32e1aeddde2bed3a14da52fe4653]'... 210499 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=15523 chars=9977 sha256=2743db4c85442c03990bff57c7553f8e898672daf40dd4399065c5f949a343a2]'... 190851 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
> ```json
> {
>   "title": "OutputObserved을 BOOL로 지정",
...
>
> ```text
> 			63069 메뉴 항목 New Variable
> 			63070 메뉴 항목 Sort Variables
> 			63071 메뉴 항목 Paste
> 			63072 메뉴 항목 Copy
> 				63083 메뉴 항목 Macros
> 				63084 메뉴 항목 Layouts
> 				63086 메뉴 항목 Toolbar Options
> 				63088 메뉴 항목 Toolbar Options
> 				63091 메뉴 항목 Online Connection
> 				63101 메뉴 항목 Toolbar Options
> 				63102 메뉴 항목 Target Architecture
> 				63118 메뉴 항목 Undo (Strg+Z)
> 				63119 메뉴 항목 (disabled) Redo (Strg+Y)
> 				63122 메뉴 항목 FILE
> 				63123 메뉴 항목 EDIT
> 				63124 메뉴 항목 VIEW
> 				63125 메뉴 항목 PROJECT
...
> ```json
> {
>   "title": "OutputPreviousValid 변수 생성",
>   "code": "await globalThis.sky.click({window:globalThis.targetWindow,x:1310,y:311,screenshotId:globalThis.state.screenshots[1].id});"
> }
> ```
>
> ```text
...
> ```json
> {
>   "title": "OutputPreviousValid 이름 입력",
>   "code": "await globalThis.sky.type_text({window:globalThis.targetWindow,text:\"OutputPreviousValid\"});"
> }
> ```
>
> ```text
...
> ```json
> {
>   "title": "OutputPreviousValid 이름 확정",
>   "code": "await globalThis.sky.press_key({window:globalThis.targetWindow,key:\"ENTER\"});"
> }
> ```
>
