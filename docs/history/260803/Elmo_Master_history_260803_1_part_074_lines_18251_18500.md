>       '\t\t\t99174 메뉴 항목 (disabled) Move Down\n' +
>       '\t\t\t99175 메뉴 항목 Copy\n' +
>       '\t\t\t99176 메뉴 항목 New Input Variable\n' +
>       '\t\t\t99177 메뉴 항목 New Output Variable\n' +
>       '\t\t\t99178 메뉴 항목 Add to Newinst\n' +
>       '\t\t1 창 작업 영역 ID: 59648\n' +
...
> ```json
> {
>   "title": "Create DestSize input",
>   "code": "await globalThis.sky.click({window:globalThis.targetWindow,element_index:99176});"
> }
> ```
>
> ```text
> element 99176 is not available in cached app state for Lasal2.exe
> ```
>
> MCP tool call
>
...
> {
>   "title": "Create DestSize input",
>   "code": "await globalThis.sky.click({window:globalThis.targetWindow,x:75,y:129,screenshotId:globalThis.state.screenshots[2].id});"
> }
> ```
>
> ```text
...
> ```json
> {
>   "title": "Name DestSize input",
>   "code": "await globalThis.sky.type_text({window:globalThis.targetWindow,text:\"DestSize\"}); await globalThis.sky.press_key({window:globalThis.targetWindow,key:\"ENTER\"});"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=18370 chars=9977 sha256=3d34baa568e0957b24c1eb43e1acaa925a0e32e1aeddde2bed3a14da52fe4653]'... 211771 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=18379 chars=9977 sha256=2743db4c85442c03990bff57c7553f8e898672daf40dd4399065c5f949a343a2]'... 192795 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
> ```json
> {
>   "title": "Set DestSize type",
>   "code": "await globalThis.sky.click({window:globalThis.targetWindow,x:1340,y:498,screenshotId:globalThis.state.screenshots[0].id});"
> }
> ```
>
> ```text
...
> ```json
> {
>   "title": "Enter UDINT type",
>   "code": "await globalThis.sky.type_text({window:globalThis.targetWindow,text:\"UDINT\"}); await globalThis.sky.press_key({window:globalThis.targetWindow,key:\"ENTER\"});"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=18482 chars=9977 sha256=3d34baa568e0957b24c1eb43e1acaa925a0e32e1aeddde2bed3a14da52fe4653]'... 213071 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[OMITTED_BASE64 source=Emlo_Master_history_260803_1.md line=18491 chars=9977 sha256=2743db4c85442c03990bff57c7553f8e898672daf40dd4399065c5f949a343a2]'... 193275 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
