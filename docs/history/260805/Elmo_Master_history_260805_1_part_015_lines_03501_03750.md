...
>       '\t\t\t24770 탭 항목 (selectable) Python Script\n' +
>       '\t\t\t24771 탭 항목 (selectable) Debugger\n' +
>       '\t\t\t24772 탭 항목 (selectable) Output\n' +
>       '\t\t\t95 단추 Close\n' +
...
>       '\t\t\t24773 탭 항목 (selectable) Lib\n' +
>       '\t\t\t24774 탭 항목 (selectable) File\n' +
>       '\t\t\t24775 탭 항목 (selectable) Class\n' +
>       '\t\t\t102 단추 Close\n' +
...
> ```json
> {
>   "code": "await sky.click({window: targetWindow, x: 1183, y: 359, screenshotId: 'screenshot-1'}); state = await sky.get_window_state({window: targetWindow, include_text: true, include_screenshot: true}); nodeRepl.write(state);",
>   "title": "LMCDiagnosticsService 노드 펼치기"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[BASE64_OMITTED source_line=3609 chars=9977 sha256=78a0a86962f4f03eb4d8abf96da423da5a5ba21e020185db411cc7d2c9c3765d]'... 299283 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[BASE64_OMITTED source_line=3618 chars=9977 sha256=75cd9ec269e88b5b7459eef83796c8512720c57840f4fac779c9b5c1fa9d3c0c]'... 278119 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
>       '\t\t\t13 도구 모음 Edit\n' +
>       '\t\t\t\t25448 단추 Toggle bookmark\n' +
>       '\t\t\t\t25449 단추 (disabled) Previous bookmark\n' +
>       '\t\t\t\t25450 단추 (disabled) Next bookmark\n' +
>       '\t\t\t\t25451 단추 (disabled) Delete all bookmarks\n' +
>       '\t\t\t\t25452 단추 (disabled) Previous bookmark in this file\n' +
>       '\t\t\t\t25453 단추 (disabled) Next bookmark in this file\n' +
>       '\t\t\t\t25454 단추 Comment selected text (Ctrl+Shift+C)\n' +
>       '\t\t\t\t25455 단추 Remove comment (Ctrl+Shift+X)\n' +
>       '\t\t\t\t25456 단추 Unindent (Shift+Tab)\n' +
>       '\t\t\t\t25457 단추 Indent (Tab)\n' +
...
>       '\t\t\t\t25459 메뉴 항목 Layouts\n' +
>       '\t\t\t28 도구 모음 Toolbox\n' +
>       '\t\t\t\t25460 단추 DataAnalyzer\n' +
>       '\t\t\t\t25461 메뉴 항목 Toolbar Options\n' +
>       '\t\t\t31 도구 모음 Net Edit\n' +
>       '\t\t\t\t25462 단추 (disabled) Select\n' +
>       '\t\t\t\t25463 메뉴 항목 Toolbar Options\n' +
>       '\t\t\t34 도구 모음 Debug\n' +
>       '\t\t\t\t25464 단추 Go online (Alt+F6)\n' +
>       '\t\t\t\t25465 단추 Change Online Settings\n' +
>       '\t\t\t\t25466 메뉴 항목 Online Connection\n' +
>       '\t\t\t\t25467 단추 (disabled) Set Online Connection For Current Project\n' +
>       '\t\t\t\t25468 단추 (disabled) Download (F6)\n' +
>       '\t\t\t\t25469 단추 Build Changes, Online, Download and Run (CTRL+ALT+F6)\n' +
>       '\t\t\t\t25470 단추 (disabled) Download Module on the Fly\n' +
>       '\t\t\t\t25471 단추 (disabled) Save Project on PLC\n' +
>       '\t\t\t\t25472 단추 (disabled) Start (F7)\n' +
>       '\t\t\t\t25473 단추 (disabled) Reset (F8)\n' +
>       '\t\t\t\t25474 단추 Toggle breakpoint (F4)\n' +
>       '\t\t\t\t25475 단추 Create condition breakpoint\n' +
>       '\t\t\t\t25476 메뉴 항목 Toolbar Options\n' +
>       '\t\t\t48 도구 모음 Build\n' +
>       '\t\t\t\t25477 메뉴 항목 Target Architecture\n' +
>       '\t\t\t\t25478 단추 Build changes (F9)\n' +
>       '\t\t\t\t25479 단추 Rebuild project (Strg+F9)\n' +
>       '\t\t\t\t25480 단추 (disabled) Cancel building (Ctrl+Break)\n' +
>       '\t\t\t\t25481 단추 Link project\n' +
>       '\t\t\t54 도구 모음 Standard\n' +
>       '\t\t\t\t25482 단추 New project (Strg+N)\n' +
>       '\t\t\t\t25483 단추 Open a file (Strg+Shift+O)\n' +
>       '\t\t\t\t25484 단추 Close active document (Strg+F4)\n' +
>       '\t\t\t\t25485 단추 (disabled) Save file (Strg+S)\n' +
>       '\t\t\t\t25486 단추 Open project (Strg+O)\n' +
>       '\t\t\t\t25487 단추 (disabled) Save project changes (Strg+Shift+S)\n' +
>       '\t\t\t\t25488 단추 Close project\n' +
>       '\t\t\t\t25489 단추 Print\n' +
>       '\t\t\t\t25490 단추 Cut (Strg+X)\n' +
>       '\t\t\t\t25491 단추 Copy (Strg+C)\n' +
>       '\t\t\t\t25492 단추 Paste (Strg+V)\n' +
>       '\t\t\t\t25493 메뉴 항목 (disabled) Undo (Strg+Z)\n' +
>       '\t\t\t\t25494 메뉴 항목 (disabled) Redo (Strg+Y)\n' +
>       '\t\t\t\t25495 단추 (disabled) Navigate Backward (Alt+Left)\n' +
>       '\t\t\t\t25496 단추 (disabled) Navigate Forward (Alt +Right)\n' +
>       '\t\t\t70 메뉴 모음 Menu Bar\n' +
>       '\t\t\t\t25497 메뉴 항목 FILE\n' +
>       '\t\t\t\t25498 메뉴 항목 EDIT\n' +
>       '\t\t\t\t25499 메뉴 항목 VIEW\n' +
...
>       '\t\t\t\t\t\t90 위치 조정 위치 ID: ScrollbarThumb\n' +
>       '\t\t\t\t\t\t91 단추 오른쪽 스크롤 화살표 ID: DownButton\n' +
>       '\t\t\t25508 탭 항목 (selectable) Python Script\n' +
>       '\t\t\t25509 탭 항목 (selectable) Debugger\n' +
>       '\t\t\t25510 탭 항목 (selectable) Output\n' +
>       '\t\t\t95 단추 Close\n' +
>       '\t\t96 창 Splitter ID: 306256448\n' +
