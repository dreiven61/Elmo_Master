...
> 						2910 목록 항목 (selectable)
> 						2911 목록 항목 (selectable)
> 						2912 목록 항목 (selectable)
> 						2913 목록 항목 (selectable)
> 						2914 목록 항목 (selectable)
> 						2915 목록 항목 (selectable)
> 						2916 목록 항목 (selectable)
> 					73 스크롤 막대 ID: 59904
> 						74 단추 왼쪽 스크롤 화살표 ID: UpButton
> 						75 위치 조정 위치 ID: ScrollbarThumb
> 						76 단추 오른쪽 스크롤 화살표 ID: DownButton
> 			7762 탭 항목 (selectable) Python Script
> 			7763 탭 항목 (selectable) Debugger
> 			7764 탭 항목 (selectable) Output
> 			80 단추 Close
...
> 			7765 탭 항목 (selectable) Lib
> 			7766 탭 항목 (selectable) File
> 			7767 탭 항목 (selectable) Class
> 			7768 탭 항목 (selectable) Global
> 			88 단추 Close
...
> 					93 단추
> 					94 단추
> 			7769 탭 항목 (selectable) Properties
> 			96 단추 Close
> 		7770 메뉴 Build
> 			7771 메뉴 항목 Build F9
> 			7772 메뉴 항목 Rebuild All Ctrl+F9
> 			7773 메뉴 항목 Build Connection List
> 			7774 메뉴 항목 (disabled) Build Drive Tables
> 			7775 메뉴 항목 Write Server List
> 			7776 메뉴 항목 Compile Module Alt+F9
> 			7777 메뉴 항목 (disabled) Cancel Ctrl+Break
> 			7778 메뉴 항목 Link
>
...
> ```json
> {
>   "title": "Start C78 ARM Rebuild",
>   "code": "var obsRebuild1=state; state=null; await sky.click({window:obsRebuild1.window,element_index:7772}); state=await sky.get_window_state({window:obsRebuild1.window,include_screenshot:true,include_text:true}); targetWindow=state.window; nodeRepl.write(String(state.accessibility?.tree||''));"
> }
> ```
>
> ```text
> element 7772 is not available in cached app state for Lasal2.exe
> ```
>
> MCP tool call
>
...
> ```json
> {
>   "title": "Refresh LASAL build menu",
>   "code": "state=await sky.get_window_state({window:targetWindow,include_screenshot:true,include_text:false}); targetWindow=state.window; nodeRepl.write('Build menu refreshed');"
> }
> ```
>
> ```text
> Build menu refreshed
> ```
>
> Image output: image/jpeg
>
...
> {
>   "title": "Start C78 ARM Rebuild",
>   "code": "var obsRebuild2=state; var sidRebuild2=obsRebuild2.screenshots[0].id; state=null; await sky.click({window:obsRebuild2.window,screenshotId:sidRebuild2,x:275,y:88}); state=await sky.get_window_state({window:obsRebuild2.window,include_screenshot:true,include_text:true}); targetWindow=state.window; nodeRepl.write(String(state.accessibility?.tree||''));"
> }
> ```
>
> ```text
...
> 		7780 창
> 		7770 메뉴 Build
> 			10511 메뉴 항목 Build F9
> 			10512 메뉴 항목 Rebuild All Ctrl+F9
> 			10513 메뉴 항목 Build Connection List
> 			10514 메뉴 항목 (disabled) Build Drive Tables
> 			10515 메뉴 항목 Write Server List
> 			10516 메뉴 항목 Compile Module Alt+F9
> 			10517 메뉴 항목 (disabled) Cancel Ctrl+Break
> 			10518 메뉴 항목 Link
> 		1 창 작업 영역 ID: 59648
...
> 			13 도구 모음 Edit
> 				10519 단추 Toggle bookmark
> 				10520 단추 (disabled) Previous bookmark
> 				10521 단추 (disabled) Next bookmark
> 				10522 단추 (disabled) Delete all bookmarks
> 				10523 단추 (disabled) Previous bookmark in this file
> 				10524 단추 (disabled) Next bookmark in this file
> 				10525 단추 Comment selected text (Ctrl+Shift+C)
> 				10526 단추 Remove comment (Ctrl+Shift+X)
> 				10527 단추 Unindent (Shift+Tab)
> 				10528 단추 Indent (Tab)
...
> 				10530 메뉴 항목 Layouts
> 			28 도구 모음 Toolbox
> 				10531 단추 DataAnalyzer
> 				10532 메뉴 항목 Toolbar Options
> 			31 도구 모음 Net Edit
> 				10533 단추 (disabled) Select
> 				10534 메뉴 항목 Toolbar Options
> 			34 도구 모음 Debug
> 				10535 단추 Go online (Alt+F6)
> 				10536 메뉴 항목 Toolbar Options
> 			37 도구 모음 Build
> 				10537 메뉴 항목 Target Architecture
