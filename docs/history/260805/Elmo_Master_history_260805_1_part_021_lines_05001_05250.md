...
>       '\t\t\t\t\t5962 콘솔 트리 (se'... 473 more characters,
...
> ```json
> {
>   "code": "nodeRepl.write(state.accessibility.tree.split('\\n').filter(x => /New Method|Paste|Sort Methods|New Std/.test(x)).join('\\n'));",
>   "title": "Private 메뉴 명령 확인"
> }
> ```
>
> ```text
...
> ```json
> {
>   "code": "await sky.click({window: targetWindow, x: 1325, y: 277}); state = await sky.get_window_state({window: targetWindow, include_text: true, include_screenshot: true}); nodeRepl.write(state);",
>   "title": "Outcome 서명 복제"
> }
> ```
>
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[BASE64_OMITTED source_line=5074 chars=9977 sha256=ab762f360db3364eb65ebe6b20fb7f669d7efb6893e8ff8fe92c503c1e408bfc]'... 291563 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[BASE64_OMITTED source_line=5083 chars=9977 sha256=e5696bee197b55948ae5ac4ca489f923f484d6079e22fd2df71585b5baaf37f2]'... 271043 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
>       '\t\t30012 창\n' +
>       '\t\t30013 메뉴\n' +
>       '\t\t\t30878 메뉴 항목 New Method Ins\n' +
>       '\t\t\t30879 메뉴 항목 New Std. Methods\n' +
>       '\t\t\t30880 메뉴 항목 Sort Methods\n' +
>       '\t\t\t30881 메뉴 항목 Paste\n' +
>       '\t\t\t30882 메뉴 항목 Copy\n' +
>       '\t\t1 창 작업 영역 ID: 59648\n' +
...
>       '\t\t\t13 도구 모음 Edit\n' +
>       '\t\t\t\t30883 단추 Toggle bookmark\n' +
>       '\t\t\t\t30884 단추 (disabled) Previous bookmark\n' +
>       '\t\t\t\t30885 단추 (disabled) Next bookmark\n' +
>       '\t\t\t\t30886 단추 (disabled) Delete all bookmarks\n' +
>       '\t\t\t\t30887 단추 (disabled) Previous bookmark in this file\n' +
>       '\t\t\t\t30888 단추 (disabled) Next bookmark in this file\n' +
>       '\t\t\t\t30889 단추 (disabled) Comment selected text (Ctrl+Shift+C)\n' +
>       '\t\t\t\t30890 단추 (disabled) Remove comment (Ctrl+Shift+X)\n' +
>       '\t\t\t\t30891 단추 (disabled) Unindent (Shift+Tab)\n' +
>       '\t\t\t\t30892 단추 (disabled) Indent (Tab)\n' +
>       '\t\t\t24 도구 모음 Macros Manager\n' +
>       '\t\t\t\t30893 메뉴 항목 Macros\n' +
>       '\t\t\t26 도구 모음 Layout Manager\n' +
>       '\t\t\t\t30894 메뉴 항목 Layouts\n' +
>       '\t\t\t28 도구 모음 Toolbox\n' +
>       '\t\t\t\t30895 단추 DataAnalyzer\n' +
>       '\t\t\t\t30896 메뉴 항목 Toolbar Options\n' +
>       '\t\t\t31 도구 모음 Net Edit\n' +
>       '\t\t\t\t30897 단추 (disabled) Select\n' +
>       '\t\t\t\t30898 메뉴 항목 Toolbar Options\n' +
>       '\t\t\t34 도구 모음 Debug\n' +
>       '\t\t\t\t30899 단추 Go online (Alt+F6)\n' +
>       '\t\t\t\t30900 단추 Change Online Settings\n' +
>       '\t\t\t\t30901 메뉴 항목 Online Connection\n' +
>       '\t\t\t\t30902 단추 (disabled) Set Online Connection For Current Project\n' +
>       '\t\t\t\t30903 단추 (disabled) Download (F6)\n' +
>       '\t\t\t\t30904 단추 Build Changes, Online, Download and Run (CTRL+ALT+F6)\n' +
>       '\t\t\t\t30905 단추 (disabled) Download Module on the Fly\n' +
>       '\t\t\t\t30906 단추 (disabled) Save Project on PLC\n' +
>       '\t\t\t\t30907 단추 (disabled) Start (F7)\n' +
>       '\t\t\t\t30908 단추 (disabled) Reset (F8)\n' +
>       '\t\t\t\t30909 단추 Toggle breakpoint (F4)\n' +
>       '\t\t\t\t30910 단추 Create condition breakpoint\n' +
>       '\t\t\t\t30911 메뉴 항목 Toolbar Options\n' +
>       '\t\t\t48 도구 모음 Build\n' +
>       '\t\t\t\t30912 메뉴 항목 Target Architecture\n' +
>       '\t\t\t\t30913 단추 Build changes (F9)\n' +
>       '\t\t\t\t30914 단추 Rebuild project (Strg+F9)\n' +
>       '\t\t\t\t30915 단추 (disabled) Cancel building (Ctrl+Break)\n' +
>       '\t\t\t\t30916 단추 Link project\n' +
>       '\t\t\t54 도구 모음 Standard\n' +
>       '\t\t\t\t30917 단추 New project (Strg+N)\n' +
>       '\t\t\t\t30918 단추 Open a file (Strg+Shift+O)\n' +
>       '\t\t\t\t30919 단추 Close active document (Strg+F4)\n' +
>       '\t\t\t\t30920 단추 (disabled) Save file (Strg+S)\n' +
>       '\t\t\t\t30921 단추 Open project (Strg+O)\n' +
>       '\t\t\t\t30922 단추 (disabled) Save project changes (Strg+Shift+S)\n' +
>       '\t\t\t\t30923 단추 Close project\n' +
>       '\t\t\t\t30924 단추 Print\n' +
>       '\t\t\t\t30925 단추 Cut (Strg+X)\n' +
>       '\t\t\t\t30926 단추 Copy (Strg+C)\n' +
>       '\t\t\t\t30927 단추 Paste (Strg+V)\n' +
>       '\t\t\t\t30928 메뉴 항목 Undo (Strg+Z)\n' +
>       '\t\t\t\t30929 메뉴 항목 (disabled) Redo (Strg+Y)\n' +
>       '\t\t\t\t30930 단추 (disabled) Navigate Backward (Alt+Left)\n' +
>       '\t\t\t\t30931 단추 (disabled) Navigate Forward (Alt +Right)\n' +
>       '\t\t\t70 메뉴 모음 Menu Bar\n' +
>       '\t\t\t\t30932 메뉴 항목 FILE\n' +
>       '\t\t\t\t30933 메뉴 항목 EDIT\n' +
>       '\t\t\t\t30934 메뉴 항목 VIEW\n' +
...
>       '\t\t\t30943 탭 항목 (selectable) Python Script\n' +
>       '\t\t\t30944 탭 항목 (selectable) Debugger\n' +
>       '\t\t\t30945 탭 항목 (selectable) Output\n' +
>       '\t\t\t95 단추 Close\n' +
