...
>   "title": "Recheck LASAL rename state"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[BASE64_OMITTED source_line=6267 chars=9977 sha256=ab762f360db3364eb65ebe6b20fb7f669d7efb6893e8ff8fe92c503c1e408bfc]'... 304343 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[BASE64_OMITTED source_line=6276 chars=9977 sha256=e5696bee197b55948ae5ac4ca489f923f484d6079e22fd2df71585b5baaf37f2]'... 282671 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
>       id: 'screenshot-2',
>       zIndex: 2,
>       url: 'data:image/jpeg;base64,[BASE64_OMITTED source_line=6285 chars=9977 sha256=f056aa81196cf6adc1547d2fd68908838ef94634076ba71ca06fc15ad72bab7e]'... 4135 more characters,
>       originX: -559,
>       originY: 402,
>       width: 253,
>       height: 231
...
>       '\t\t\t13 도구 모음 Edit\n' +
>       '\t\t\t\t43336 단추 Toggle bookmark\n' +
>       '\t\t\t\t43337 단추 (disabled) Previous bookmark\n' +
>       '\t\t\t\t43338 단추 (disabled) Next bookmark\n' +
>       '\t\t\t\t43339 단추 (disabled) Delete all bookmarks\n' +
>       '\t\t\t\t43340 단추 (disabled) Previous bookmark in this file\n' +
>       '\t\t\t\t43341 단추 (disabled) Next bookmark in this file\n' +
>       '\t\t\t\t43342 단추 (disabled) Comment selected text (Ctrl+Shift+C)\n' +
>       '\t\t\t\t43343 단추 (disabled) Remove comment (Ctrl+Shift+X)\n' +
>       '\t\t\t\t43344 단추 (disabled) Unindent (Shift+Tab)\n' +
>       '\t\t\t\t43345 단추 (disabled) Indent (Tab)\n' +
>       '\t\t\t24 도구 모음 Macros Manager\n' +
>       '\t\t\t\t43346 메뉴 항목 Macros\n' +
>       '\t\t\t26 도구 모음 Layout Manager\n' +
>       '\t\t\t\t43347 메뉴 항목 Layouts\n' +
>       '\t\t\t28 도구 모음 Toolbox\n' +
>       '\t\t\t\t43348 단추 DataAnalyzer\n' +
>       '\t\t\t\t43349 메뉴 항목 Toolbar Options\n' +
>       '\t\t\t31 도구 모음 Net Edit\n' +
>       '\t\t\t\t43350 단추 (disabled) Select\n' +
>       '\t\t\t\t43351 메뉴 항목 Toolbar Options\n' +
>       '\t\t\t34 도구 모음 Debug\n' +
>       '\t\t\t\t43352 단추 Go online (Alt+F6)\n' +
>       '\t\t\t\t43353 단추 Change Online Settings\n' +
>       '\t\t\t\t43354 메뉴 항목 Online Connection\n' +
>       '\t\t\t\t43355 단추 (disabled) Set Online Connection For Current Project\n' +
>       '\t\t\t\t43356 단추 (disabled) Download (F6)\n' +
>       '\t\t\t\t43357 단추 Build Changes, Online, Download and Run (CTRL+ALT+F6)\n' +
>       '\t\t\t\t43358 단추 (disabled) Download Module on the Fly\n' +
>       '\t\t\t\t43359 단추 (disabled) Save Project on PLC\n' +
>       '\t\t\t\t43360 단추 (disabled) Start (F7)\n' +
>       '\t\t\t\t43361 단추 (disabled) Reset (F8)\n' +
>       '\t\t\t\t43362 단추 Toggle breakpoint (F4)\n' +
>       '\t\t\t\t43363 단추 Create condition breakpoint\n' +
>       '\t\t\t\t43364 메뉴 항목 Toolbar Options\n' +
>       '\t\t\t48 도구 모음 Build\n' +
>       '\t\t\t\t43365 메뉴 항목 Target Architecture\n' +
>       '\t\t\t\t43366 단추 Build changes (F9)\n' +
>       '\t\t\t\t43367 단추 Rebuild project (Strg+F9)\n' +
>       '\t\t\t\t43368 단추 (disabled) Cancel building (Ctrl+Break)\n' +
>       '\t\t\t\t43369 단추 Link project\n' +
>       '\t\t\t54 도구 모음 Standard\n' +
>       '\t\t\t\t43370 단추 New project (Strg+N)\n' +
>       '\t\t\t\t43371 단추 Open a file (Strg+Shift+O)\n' +
>       '\t\t\t\t43372 단추 Close active document (Strg+F4)\n' +
>       '\t\t\t\t43373 단추 Save file (Strg+S)\n' +
>       '\t\t\t\t43374 단추 Open project (Strg+O)\n' +
>       '\t\t\t\t43375 단추 Save project changes (Strg+Shift+S)\n' +
>       '\t\t\t\t43376 단추 Close project\n' +
>       '\t\t\t\t43377 단추 Print\n' +
>       '\t\t\t\t43378 단추 Cut (Strg+X)\n' +
>       '\t\t\t\t43379 단추 Copy (Strg+C)\n' +
>       '\t\t\t\t43380 단추 Paste (Strg+V)\n' +
>       '\t\t\t\t43381 메뉴 항목 Undo (Strg+Z)\n' +
>       '\t\t\t\t43382 메뉴 항목 (disabled) Redo (Strg+Y)\n' +
>       '\t\t\t\t43383 단추 (disabled) Navigate Backward (Alt+Left)\n' +
>       '\t\t\t\t43384 단추 (disabled) Navigate Forward (Alt +Right)\n' +
>       '\t\t\t70 메뉴 모음 Menu Bar\n' +
>       '\t\t\t\t43385 메뉴 항목 FILE\n' +
>       '\t\t\t\t43386 메뉴 항목 EDIT\n' +
>       '\t\t\t\t43387 메뉴 항목 VIEW\n' +
...
>       '\t\t\t43396 탭 항목 (selectable) Python Script\n' +
>       '\t\t\t43397 탭 항목 (selectable) Debugger\n' +
>       '\t\t\t43398 탭 항목 (selectable) Output\n' +
>       '\t\t\t95 단추 Close\n' +
...
> ```json
> {
>   "code": "await sky.press_key({window: targetWindow, key: 'Escape'}); state = await sky.get_window_state({window: targetWindow, include_text:true, include_screenshot:true}); nodeRepl.write(state)",
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[BASE64_OMITTED source_line=6498 chars=9977 sha256=ab762f360db3364eb65ebe6b20fb7f669d7efb6893e8ff8fe92c503c1e408bfc]'... 302387 more characters,
>       originX: -1880,
>       originY: 41,
