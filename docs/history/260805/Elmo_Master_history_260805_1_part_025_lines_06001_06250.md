...
> ```json
> {
>   "code": "await sky.click({window: targetWindow, element_index: 31022, mouse_button: 'right'}); state = await sky.get_window_state({window: targetWindow, include_text:true, include_screenshot:true}); nodeRepl.write(state)",
>   "title": "Open LASAL method menu"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[BASE64_OMITTED source_line=6021 chars=9977 sha256=ab762f360db3364eb65ebe6b20fb7f669d7efb6893e8ff8fe92c503c1e408bfc]'... 304087 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[BASE64_OMITTED source_line=6030 chars=9977 sha256=e5696bee197b55948ae5ac4ca489f923f484d6079e22fd2df71585b5baaf37f2]'... 282451 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
>       id: 'screenshot-2',
>       zIndex: 2,
>       url: 'data:image/jpeg;base64,[BASE64_OMITTED source_line=6039 chars=9977 sha256=957e6ba1eeea553846a93ca16e4954ccfa5668d95285e014177e3ea244c139a6]'... 3959 more characters,
>       originX: -559,
>       originY: 402,
>       width: 253,
>       height: 231
...
>       '\t\t\t13 도구 모음 Edit\n' +
>       '\t\t\t\t41730 단추 Toggle bookmark\n' +
>       '\t\t\t\t41731 단추 (disabled) Previous bookmark\n' +
>       '\t\t\t\t41732 단추 (disabled) Next bookmark\n' +
>       '\t\t\t\t41733 단추 (disabled) Delete all bookmarks\n' +
>       '\t\t\t\t41734 단추 (disabled) Previous bookmark in this file\n' +
>       '\t\t\t\t41735 단추 (disabled) Next bookmark in this file\n' +
>       '\t\t\t\t41736 단추 (disabled) Comment selected text (Ctrl+Shift+C)\n' +
>       '\t\t\t\t41737 단추 (disabled) Remove comment (Ctrl+Shift+X)\n' +
>       '\t\t\t\t41738 단추 (disabled) Unindent (Shift+Tab)\n' +
>       '\t\t\t\t41739 단추 (disabled) Indent (Tab)\n' +
>       '\t\t\t24 도구 모음 Macros Manager\n' +
>       '\t\t\t\t41740 메뉴 항목 Macros\n' +
>       '\t\t\t26 도구 모음 Layout Manager\n' +
>       '\t\t\t\t41741 메뉴 항목 Layouts\n' +
>       '\t\t\t28 도구 모음 Toolbox\n' +
>       '\t\t\t\t41742 단추 DataAnalyzer\n' +
>       '\t\t\t\t41743 메뉴 항목 Toolbar Options\n' +
>       '\t\t\t31 도구 모음 Net Edit\n' +
>       '\t\t\t\t41744 단추 (disabled) Select\n' +
>       '\t\t\t\t41745 메뉴 항목 Toolbar Options\n' +
>       '\t\t\t34 도구 모음 Debug\n' +
>       '\t\t\t\t41746 단추 Go online (Alt+F6)\n' +
>       '\t\t\t\t41747 단추 Change Online Settings\n' +
>       '\t\t\t\t41748 메뉴 항목 Online Connection\n' +
>       '\t\t\t\t41749 단추 (disabled) Set Online Connection For Current Project\n' +
>       '\t\t\t\t41750 단추 (disabled) Download (F6)\n' +
>       '\t\t\t\t41751 단추 Build Changes, Online, Download and Run (CTRL+ALT+F6)\n' +
>       '\t\t\t\t41752 단추 (disabled) Download Module on the Fly\n' +
>       '\t\t\t\t41753 단추 (disabled) Save Project on PLC\n' +
>       '\t\t\t\t41754 단추 (disabled) Start (F7)\n' +
>       '\t\t\t\t41755 단추 (disabled) Reset (F8)\n' +
>       '\t\t\t\t41756 단추 Toggle breakpoint (F4)\n' +
>       '\t\t\t\t41757 단추 Create condition breakpoint\n' +
>       '\t\t\t\t41758 메뉴 항목 Toolbar Options\n' +
>       '\t\t\t48 도구 모음 Build\n' +
>       '\t\t\t\t41759 메뉴 항목 Target Architecture\n' +
>       '\t\t\t\t41760 단추 Build changes (F9)\n' +
>       '\t\t\t\t41761 단추 Rebuild project (Strg+F9)\n' +
>       '\t\t\t\t41762 단추 (disabled) Cancel building (Ctrl+Break)\n' +
>       '\t\t\t\t41763 단추 Link project\n' +
>       '\t\t\t54 도구 모음 Standard\n' +
>       '\t\t\t\t41764 단추 New project (Strg+N)\n' +
>       '\t\t\t\t41765 단추 Open a file (Strg+Shift+O)\n' +
>       '\t\t\t\t41766 단추 Close active document (Strg+F4)\n' +
>       '\t\t\t\t41767 단추 Save file (Strg+S)\n' +
>       '\t\t\t\t41768 단추 Open project (Strg+O)\n' +
>       '\t\t\t\t41769 단추 Save project changes (Strg+Shift+S)\n' +
>       '\t\t\t\t41770 단추 Close project\n' +
>       '\t\t\t\t41771 단추 Print\n' +
>       '\t\t\t\t41772 단추 Cut (Strg+X)\n' +
>       '\t\t\t\t41773 단추 Copy (Strg+C)\n' +
>       '\t\t\t\t41774 단추 Paste (Strg+V)\n' +
>       '\t\t\t\t41775 메뉴 항목 Undo (Strg+Z)\n' +
>       '\t\t\t\t41776 메뉴 항목 (disabled) Redo (Strg+Y)\n' +
>       '\t\t\t\t41777 단추 (disabled) Navigate Backward (Alt+Left)\n' +
>       '\t\t\t\t41778 단추 (disabled) Navigate Forward (Alt +Right)\n' +
>       '\t\t\t70 메뉴 모음 Menu Bar\n' +
>       '\t\t\t\t41779 메뉴 항목 FILE\n' +
>       '\t\t\t\t41780 메뉴 항목 EDIT\n' +
>       '\t\t\t\t41781 메뉴 항목 VIEW\n' +
...
>       '\t\t\t41790 탭 항목 (selectable) Python Script\n' +
>       '\t\t\t41791 탭 항목 (selectable) Debugger\n' +
>       '\t\t\t41792 탭 항목 (selectable) Output\n' +
>       '\t\t\t95 단추 Close\n' +
...
> ```json
> {
>   "code": "await sky.set_value({window: targetWindow, element_index: 39382, value: 'HandleAxisDs402HomeRetire'}); state = await sky.get_window_state({window: targetWindow, include_text:true, include_screenshot:true}); nodeRepl.write(state)",
>   "title": "Rename LASAL retire method"
> }
> ```
>
> ```text
