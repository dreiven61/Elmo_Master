...
> 			13 도구 모음 Edit
> 				27557 단추 Toggle bookmark
> 				27558 단추 (disabled) Previous bookmark
> 				27559 단추 (disabled) Next bookmark
> 				27560 단추 (disabled) Delete all bookmarks
> 				27561 단추 (disabled) Previous bookmark in this file
> 				27562 단추 (disabled) Next bookmark in this file
> 				27563 단추 Comment selected text (Ctrl+Shift+C)
> 				27564 단추 Remove comment (Ctrl+Shift+X)
> 				27565 단추 Unindent (Shift+Tab)
> 				27566 단추 Indent (Tab)
...
> 				27568 메뉴 항목 Layouts
> 			28 도구 모음 Toolbox
> 				27569 단추 DataAnalyzer
> 				27570 메뉴 항목 Toolbar Options
> 			31 도구 모음 Net Edit
> 				27571 단추 (disabled) Select
> 				27572 메뉴 항목 Toolbar Options
> 			34 도구 모음 Debug
> 				27573 단추 Go online (Alt+F6)
> 				27574 메뉴 항목 Toolbar Options
> 			37 도구 모음 Build
> 				27575 메뉴 항목 Target Architecture
> 				27576 메뉴 항목 Toolbar Options
> 			40 도구 모음 Standard
> 				27577 단추 New project (Strg+N)
> 				27578 단추 Open a file (Strg+Shift+O)
> 				27579 단추 Close active document (Strg+F4)
> 				27580 단추 (disabled) Save file (Strg+S)
> 				27581 단추 Open project (Strg+O)
> 				27582 단추 (disabled) Save project changes (Strg+Shift+S)
> 				27583 단추 Close project
> 				27584 단추 Print
> 				27585 단추 Cut (Strg+X)
> 				27586 단추 Copy (Strg+C)
> 				27587 단추 (disabled) Paste (Strg+V)
> 				27588 메뉴 항목 (disabled) Undo (Strg+Z)
> 				27589 메뉴 항목 (disabled) Redo (Strg+Y)
> 				27590 메뉴 항목 Toolbar Options
> 			55 메뉴 모음 Menu Bar
> 				27591 메뉴 항목 FILE
> 				27592 메뉴 항목 EDIT
> 				27593 메뉴 항목 VIEW
...
> 			27602 탭 항목 (selectable) Python Script
> 			27603 탭 항목 (selectable) Debugger
> 			27604 탭 항목 (selectable) Output
> 			80 단추 Close
...
> 			27605 탭 항목 (selectable) Lib
> 			27606 탭 항목 (selectable) File
> 			27607 탭 항목 (selectable) Class
> 			27608 탭 항목 (selectable) Global
> 			88 단추 Close
...
> 					93 단추
> 					94 단추
> 			27609 탭 항목 (selectable) Properties
> 			96 단추 Close
>
...
> ```json
> {
>   "title": "Expand ownership service class",
>   "code": "var obsClassTree2=state; var sidClassTree2=obsClassTree2.screenshots[0].id; state=null; await sky.click({window:obsClassTree2.window,screenshotId:sidClassTree2,x:707,y:139}); state=await sky.get_window_state({window:obsClassTree2.window,include_screenshot:true,include_text:true}); targetWindow=state.window; nodeRepl.write(String(state.accessibility?.tree||''));"
> }
> ```
>
> ```text
