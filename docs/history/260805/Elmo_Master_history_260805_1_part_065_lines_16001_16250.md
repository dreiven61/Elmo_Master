...
> 			13 도구 모음 Edit
> 				19886 단추 Toggle bookmark
> 				19887 단추 (disabled) Previous bookmark
> 				19888 단추 (disabled) Next bookmark
> 				19889 단추 (disabled) Delete all bookmarks
> 				19890 단추 (disabled) Previous bookmark in this file
> 				19891 단추 (disabled) Next bookmark in this file
> 				19892 단추 (disabled) Comment selected text (Ctrl+Shift+C)
> 				19893 단추 (disabled) Remove comment (Ctrl+Shift+X)
> 				19894 단추 (disabled) Unindent (Shift+Tab)
> 				19895 단추 (disabled) Indent (Tab)
> 			24 도구 모음 Macros Manager
> 				19896 메뉴 항목 Macros
> 			26 도구 모음 Layout Manager
> 				19897 메뉴 항목 Layouts
> 			28 도구 모음 Toolbox
> 				19898 단추 DataAnalyzer
> 				19899 메뉴 항목 Toolbar Options
> 			31 도구 모음 Net Edit
> 				19900 단추 (disabled) Select
> 				19901 메뉴 항목 Toolbar Options
> 			34 도구 모음 Debug
> 				19902 단추 Go online (Alt+F6)
> 				19903 메뉴 항목 Toolbar Options
> 			37 도구 모음 Build
> 				19904 메뉴 항목 Target Architecture
> 				19905 메뉴 항목 Toolbar Options
> 			40 도구 모음 Standard
> 				19906 단추 New project (Strg+N)
> 				19907 단추 Open a file (Strg+Shift+O)
> 				19908 단추 Close active document (Strg+F4)
> 				19909 단추 Save file (Strg+S)
> 				19910 단추 Open project (Strg+O)
> 				19911 단추 Save project changes (Strg+Shift+S)
> 				19912 단추 Close project
> 				19913 단추 Print
> 				19914 단추 Cut (Strg+X)
> 				19915 단추 Copy (Strg+C)
> 				19916 단추 Paste (Strg+V)
> 				19917 메뉴 항목 Undo (Strg+Z)
> 				19918 메뉴 항목 (disabled) Redo (Strg+Y)
> 				19919 메뉴 항목 Toolbar Options
> 			55 메뉴 모음 Menu Bar
> 				19920 메뉴 항목 FILE
> 				19921 메뉴 항목 EDIT
> 				19922 메뉴 항목 VIEW
...
> 			19931 탭 항목 (selectable) Python Script
> 			19932 탭 항목 (selectable) Debugger
> 			19933 탭 항목 (selectable) Output
> 			80 단추 Close
...
> 			19934 탭 항목 (selectable) Lib
> 			19935 탭 항목 (selectable) File
> 			19936 탭 항목 (selectable) Class
> 			87 단추 Close
...
> 					19937 custom Name
> 					19938 custom Revision
> 					19939 custom GUID
> 					19940 custom Task Settings
> 					19941 custom Sigmatek
> 					19942 custom OSInterface
> 					19943 custom IconPath
> 					19944 custom SharedCommandTable
> 					19945 custom Objectsize
> 					19946 custom Singleton
> 					19947 custom Hidden
> 					19948 custom Deprecated
> 					19949 custom GCCOptions
> 					19950 custom Comment
> 					19951 custom Filename
> 				91 도구 모음 ID: 59392
> 					92 단추
> 					93 단추
> 			19952 탭 항목 (selectable) Properties
> 			95 단추 Close
>
...
> ```json
> {
>   "title": "Diagnostics 메서드 변수 메뉴",
>   "code": "var obsDiagMethodContext=globalThis.state; var sidDiagMethodContext=obsDiagMethodContext.screenshots[0].id; globalThis.state=null; try{await sky.click({window:obsDiagMethodContext.window,screenshotId:sidDiagMethodContext,x:850,y:138,mouse_button:'right'}); globalThis.state=await sky.get_window_state({window:obsDiagMethodContext.window,include_screenshot:true,include_text:true});}catch(error){throw new Error('Method context outcome unknown: '+String(error));} globalThis.targetWindow=state.window; nodeRepl.write(String(state.accessibility?.tree||''));",
>   "timeout_ms": 30000
> }
> ```
>
