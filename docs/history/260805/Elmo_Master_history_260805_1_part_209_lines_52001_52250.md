...
> ```json
> {
>   "title": "입력 항목 추가 메뉴 열기",
>   "code": "await sky.perform_secondary_action({window:globalThis.targetWindow77,x:854,y:219}); nodeRepl.write(\"opened secondary action\");"
> }
> ```
>
> ```text
...
> {
>   "title": "보조 동작 API 확인",
>   "code": "try { nodeRepl.write(await sky.documentation(\"api\")); } catch(e) { nodeRepl.write(e.message); }"
> }
> ```
>
> ````text
...
> {
>   "title": "입력 항목 추가 메뉴 열기",
>   "code": "await sky.click({window:globalThis.targetWindow77,x:850,y:220,mouse_button:\"right\"}); nodeRepl.write(\"opened context menu\");"
> }
> ```
>
> ```text
...
> {
>   "title": "항목 메뉴 닫기",
>   "code": "await sky.press_key({window:globalThis.targetWindow77,key:\"Escape\"}); nodeRepl.write(\"closed context menu\");"
> }
> ```
>
> ```text
