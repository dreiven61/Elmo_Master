...
> 		2 상태 표시줄 ID: 59393
> 			3 텍스트
> 			4 텍스트 LMCControlCommandService::ReserveAxisOwnership
> 			5 텍스트
> 			6 텍스트 Ln 1177 Col 1
> 			7 텍스트
> 			8 텍스트 Offline
...
> 			13 도구 모음 Script
> 			14 도구 모음 Edit
> 				6407 단추 Toggle bookmark
> 				6408 단추 (disabled) Previous bookmark
> 				6409 단추 (disabled) Next bookmark
> 				6410 단추 (disabled) Delete all bookmarks
> 				6411 단추 (disabled) Previous bookmark in this file
> 				6412 단추 (disabled) Next bookmark in this file
> 				6413 단추 Comment selected text (Ctrl+Shift+C)
> 				6414 단추 Remove comment (Ctrl+Shift+X)
> 				6415 단추 Unindent (Shift+Tab)
> 				6416 단추 Indent (Tab)
...
> 				6418 메뉴 항목 Layouts
> 			29 도구 모음 Toolbox
> 				6419 단추 DataAnalyzer
> 				6420 메뉴 항목 Toolbar Options
> 			32 도구 모음 Net Edit
> 				6421 단추 (disabled) Select
> 				6422 메뉴 항목 Toolbar Options
> 			35 도구 모음 Debug
> 				6423 단추 Go online (Alt+F6)
> 				6424 단추 Change Online Settings
> 				6425 메뉴 항목 Online Connection
> 				6426 단추 (disabled) Set Online Connection For Current Project
> 				6427 단추 (disabled) Download (F6)
> 				6428 단추 Build Changes, Online, Download and Run (CTRL+ALT+F6)
> 				6429 단추 (disabled) Download Module on the Fly
> 				6430 단추 (disabled) Save Project on PLC
> 				6431 단추 (disabled) Start (F7)
> 				6432 단추 (disabled) Reset (F8)
> 				6433 단추 Toggle breakpoint (F4)
> 				6434 단추 Create condition breakpoint
> 				6435 메뉴 항목 Toolbar Options
> 			49 도구 모음 Build
> 				6436 메뉴 항목 Target Architecture
> 				6437 단추 Build changes (F9)
> 				6438 단추 Rebuild project (Strg+F9)
> 				6439 단추 (disabled) Cancel building (Ctrl+Break)
> 				6440 단추 Link project
> 			55 도구 모음 Standard
> 				6441 단추 New project (Strg+N)
> 				6442 단추 Open a file (Strg+Shift+O)
> 				6443 단추 Close active document (Strg+F4)
> 				6444 단추 (disabled) Save file (Strg+S)
> 				6445 단추 Open project (Strg+O)
> 				6446 단추 (disabled) Save project changes (Strg+Shift+S)
> 				6447 단추 Close project
> 				6448 단추 Print
> 				6449 단추 Cut (Strg+X)
> 				6450 단추 Copy (Strg+C)
> 				6451 단추 (disabled) Paste (Strg+V)
> 				6452 메뉴 항목 (disabled) Undo (Strg+Z)
> 				6453 메뉴 항목 (disabled) Redo (Strg+Y)
> 				6454 단추 Navigate Backward (Alt+Left)
> 				6455 단추 (disabled) Navigate Forward (Alt +Right)
> 			71 메뉴 모음 Menu Bar
> 				6456 메뉴 항목 FILE
> 				6457 메뉴 항목 EDIT
> 				6458 메뉴 항목 VIEW
...
> 			6467 탭 항목 (selectable) Python Script
> 			6468 탭 항목 (selectable) Debugger
> 			6469 탭 항목 (selectable) Output
> 			97 단추 Close
...
> 			6470 탭 항목 (selectable) Lib
> 			6471 탭 항목 (selectable) File
> 			6472 탭 항목 (selectable) Global
> 			6473 탭 항목 (selectable) Net
> 			6474 탭 항목 (selectable) Class
> 			106 단추 Close
...
> ```json
> {
>   "code": "{const observation=globalThis.state;if(!observation?.accessibility)throw new Error('reobserve');globalThis.state=null;await sky.click({window:observation.window,element_index:1211,click_count:2});globalThis.state=await sky.get_window_state({window:observation.window,include_screenshot:true,include_text:true});globalThis.targetWindow=state.window;nodeRepl.write(String(state.accessibility?.tree||state.accessibility?.document_text||''))}",
>   "title": "LMCControlCommandService 선언 트리 열기"
> }
> ```
>
> ```text
