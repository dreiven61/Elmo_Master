...
>       '\t\t\t13 도구 모음 Edit\n' +
>       '\t\t\t\t44431 단추 Toggle bookmark\n' +
>       '\t\t\t\t44432 단추 (disabled) Previous bookmark\n' +
>       '\t\t\t\t44433 단추 (disabled) Next bookmark\n' +
>       '\t\t\t\t44434 단추 (disabled) Delete all bookmarks\n' +
>       '\t\t\t\t44435 단추 (disabled) Previous bookmark in this file\n' +
>       '\t\t\t\t44436 단추 (disabled) Next bookmark in this file\n' +
>       '\t\t\t\t44437 단추 (disabled) Comment selected text (Ctrl+Shift+C)\n' +
>       '\t\t\t\t44438 단추 (disabled) Remove comment (Ctrl+Shift+X)\n' +
>       '\t\t\t\t44439 단추 (disabled) Unindent (Shift+Tab)\n' +
>       '\t\t\t\t44440 단추 (disabled) Indent (Tab)\n' +
>       '\t\t\t24 도구 모음 Macros Manager\n' +
>       '\t\t\t\t44441 메뉴 항목 Macros\n' +
>       '\t\t\t26 도구 모음 Layout Manager\n' +
>       '\t\t\t\t44442 메뉴 항목 Layouts\n' +
>       '\t\t\t28 도구 모음 Toolbox\n' +
>       '\t\t\t\t44443 단추 DataAnalyzer\n' +
>       '\t\t\t\t44444 메뉴 항목 Toolbar Options\n' +
>       '\t\t\t31 도구 모음 Net Edit\n' +
>       '\t\t\t\t44445 단추 (disabled) Select\n' +
>       '\t\t\t\t44446 메뉴 항목 Toolbar Options\n' +
>       '\t\t\t34 도구 모음 Debug\n' +
>       '\t\t\t\t44447 단추 Go online (Alt+F6)\n' +
>       '\t\t\t\t44448 단추 Change Online Settings\n' +
>       '\t\t\t\t44449 메뉴 항목 Online Connection\n' +
>       '\t\t\t\t44450 단추 (disabled) Set Online Connection For Current Project\n' +
>       '\t\t\t\t44451 단추 (disabled) Download (F6)\n' +
>       '\t\t\t\t44452 단추 Build Changes, Online, Download and Run (CTRL+ALT+F6)\n' +
>       '\t\t\t\t44453 단추 (disabled) Download Module on the Fly\n' +
>       '\t\t\t\t44454 단추 (disabled) Save Project on PLC\n' +
>       '\t\t\t\t44455 단추 (disabled) Start (F7)\n' +
>       '\t\t\t\t44456 단추 (disabled) Reset (F8)\n' +
>       '\t\t\t\t44457 단추 Toggle breakpoint (F4)\n' +
>       '\t\t\t\t44458 단추 Create condition breakpoint\n' +
>       '\t\t\t\t44459 메뉴 항목 Toolbar Options\n' +
>       '\t\t\t48 도구 모음 Build\n' +
>       '\t\t\t\t44460 메뉴 항목 Target Architecture\n' +
>       '\t\t\t\t44461 단추 Build changes (F9)\n' +
>       '\t\t\t\t44462 단추 Rebuild project (Strg+F9)\n' +
>       '\t\t\t\t44463 단추 (disabled) Cancel building (Ctrl+Break)\n' +
>       '\t\t\t\t44464 단추 Link project\n' +
>       '\t\t\t54 도구 모음 Standard\n' +
>       '\t\t\t\t44465 단추 New project (Strg+N)\n' +
>       '\t\t\t\t44466 단추 Open a file (Strg+Shift+O)\n' +
>       '\t\t\t\t44467 단추 Close active document (Strg+F4)\n' +
>       '\t\t\t\t44468 단추 Save file (Strg+S)\n' +
>       '\t\t\t\t44469 단추 Open project (Strg+O)\n' +
>       '\t\t\t\t44470 단추 Save project changes (Strg+Shift+S)\n' +
>       '\t\t\t\t44471 단추 Close project\n' +
>       '\t\t\t\t44472 단추 Print\n' +
>       '\t\t\t\t44473 단추 Cut (Strg+X)\n' +
>       '\t\t\t\t44474 단추 Copy (Strg+C)\n' +
>       '\t\t\t\t44475 단추 Paste (Strg+V)\n' +
>       '\t\t\t\t44476 메뉴 항목 Undo (Strg+Z)\n' +
>       '\t\t\t\t44477 메뉴 항목 (disabled) Redo (Strg+Y)\n' +
>       '\t\t\t\t44478 단추 (disabled) Navigate Backward (Alt+Left)\n' +
>       '\t\t\t\t44479 단추 (disabled) Navigate Forward (Alt +Right)\n' +
>       '\t\t\t70 메뉴 모음 Menu Bar\n' +
>       '\t\t\t\t44480 메뉴 항목 FILE\n' +
>       '\t\t\t\t44481 메뉴 항목 EDIT\n' +
>       '\t\t\t\t44482 메뉴 항목 VIEW\n' +
...
>       '\t\t\t44491 탭 항목 (selectable) Python Script\n' +
>       '\t\t\t44492 탭 항목 (selectable) Debugger\n' +
>       '\t\t\t44493 탭 항목 (selectable) Output\n' +
>       '\t\t\t95 단추 Close\n' +
...
> ```json
> {
>   "code": "await sky.type_text({window: targetWindow, text: 'HandleAxisDs402HomeRetire'}); state = await sky.get_window_state({window: targetWindow, include_text:true, include_screenshot:true}); nodeRepl.write(state)",
>   "title": "Enter LASAL retire method name"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[BASE64_OMITTED source_line=6938 chars=9977 sha256=ab762f360db3364eb65ebe6b20fb7f669d7efb6893e8ff8fe92c503c1e408bfc]'... 302483 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[BASE64_OMITTED source_line=6947 chars=9977 sha256=e5696bee197b55948ae5ac4ca489f923f484d6079e22fd2df71585b5baaf37f2]'... 280675 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
>       '\t\t12 창 xtpBarTop ID: 59419\n' +
>       '\t\t\t13 도구 모음 Edit\n' +
>       '\t\t\t\t44869 단추 Toggle bookmark\n' +
>       '\t\t\t\t44870 단추 (disabled) Previous bookmark\n' +
>       '\t\t\t\t44871 단추 (disabled) Next bookmark\n' +
>       '\t\t\t\t44872 단추 (disabled) Delete all bookmarks\n' +
>       '\t\t\t\t44873 단추 (disabled) Previous bookmark in this file\n' +
>       '\t\t\t\t44874 단추 (disabled) Next bookmark in this file\n' +
>       '\t\t\t\t44875 단추 (disabled) Comment selected text (Ctrl+Shift+C)\n' +
>       '\t\t\t\t44876 단추 (disabled) Remove comment (Ctrl+Shift+X)\n' +
>       '\t\t\t\t44877 단추 (disabled) Unindent (Shift+Tab)\n' +
>       '\t\t\t\t44878 단추 (disabled) Indent (Tab)\n' +
>       '\t\t\t24 도구 모음 Macros Manager\n' +
>       '\t\t\t\t44879 메뉴 항목 Macros\n' +
>       '\t\t\t26 도구 모음 Layout Manager\n' +
>       '\t\t\t\t44880 메뉴 항목 Layouts\n' +
>       '\t\t\t28 도구 모음 Toolbox\n' +
>       '\t\t\t\t44881 단추 DataAnalyzer\n' +
>       '\t\t\t\t44882 메뉴 항목 Toolbar Options\n' +
