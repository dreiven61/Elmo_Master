> 				2372 단추 (disabled) Go online (Alt+F6)
> 				2373 메뉴 항목 Toolbar Options
> 			37 도구 모음 Build
> 				2374 메뉴 항목 (disabled) Target Architecture
> 				2375 메뉴 항목 Toolbar Options
> 			40 도구 모음 Standard
> 				2376 단추 (disabled) New project (Strg+N)
> 				2377 단추 Open a file (Strg+Shift+O)
> 				2378 단추 (disabled) Close active document (Strg+F4)
> 				2379 단추 (disabled) Save file (Strg+S)
> 				2380 단추 (disabled) Open project (Strg+O)
> 				2381 단추 (disabled) Save project changes (Strg+Shift+S)
> 				2382 단추 (disabled) Close project
> 				2383 단추 (disabled) Print
> 				2384 단추 Cut (Strg+X)
> 				2385 단추 Copy (Strg+C)
> 				2386 단추 Paste (Strg+V)
> 				2387 메뉴 항목 (disabled) Undo (Strg+Z)
> 				2388 메뉴 항목 (disabled) Redo (Strg+Y)
> 				2389 메뉴 항목 Toolbar Options
> 			55 메뉴 모음 Menu Bar
> 				2390 메뉴 항목 FILE
> 				2391 메뉴 항목 EDIT
> 				2392 메뉴 항목 VIEW
...
> 				71 창 ID: 1200
> 					72 LIST ID: 1201
> 						2111 스크롤 막대 세로 ID: NonClientVerticalScrollBar
> 							2112 단추 위쪽 스크롤 화살표 ID: UpButton
> 							2113 단추 페이지 위로 ID: UpPageButton
> 							2114 위치 조정 위치 ID: ScrollbarThumb
> 							2115 단추 아래쪽 스크롤 화살표 ID: DownButton
> 						1839 목록 항목 (selectable)
> 						1840 목록 항목 (selectable)
> 						1841 목록 항목 (selectable)
> 						1895 목록 항목 (selectable)
> 						1896 목록 항목 (selectable)
> 						1897 목록 항목 (selectable)
> 						2057 목록 항목 (selectable)
> 						2116 목록 항목 (selectable)
> 						2117 목록 항목 (selectable)
> 						2280 목록 항목 (selectable)
> 						2281 목록 항목 (selectable)
> 						2335 목록 항목 (selectable)
> 						2336 목록 항목 (selectable)
> 						2337 목록 항목 (selectable)
> 						2338 목록 항목 (selectable)
> 						2339 목록 항목 (selectable)
> 						2340 목록 항목 (selectable)
> 						2341 목록 항목 (selectable)
> 						2342 목록 항목 (selectable)
> 						2343 목록 항목 (selectable)
> 						2344 목록 항목 (selectable)
> 						2345 목록 항목 (selectable)
> 						2346 목록 항목 (selectable)
> 						2347 목록 항목 (selectable)
> 						2401 목록 항목 (selectable)
> 						2402 목록 항목 (selectable)
> 						2403 목록 항목 (selectable)
> 						2404 목록 항목 (selectable)
> 						2405 목록 항목 (selectable)
> 						2406 목록 항목 (selectable)
> 						2407 목록 항목 (selectable)
> 						2408 목록 항목 (selectable)
> 						2409 목록 항목 (selectable)
> 						2410 목록 항목 (selectable)
> 						2411 목록 항목 (selectable)
> 						2412 목록 항목 (selectable)
> 						2413 목록 항목 (selectable)
> 						2414 목록 항목 (selectable)
> 						2415 목록 항목 (selectable)
> 						2416 목록 항목 (selectable)
> 						2417 목록 항목 (selectable)
> 						2418 목록 항목 (selectable)
> 						2419 목록 항목 (selectable)
> 						2420 목록 항목 (selectable)
> 						2421 목록 항목 (selectable)
> 						2422 목록 항목 (selectable)
> 						2423 목록 항목 (selectable)
> 						2424 목록 항목 (selectable)
> 						2425 목록 항목 (selectable)
> 						2426 목록 항목 (selectable)
> 						2427 목록 항목 (selectable)
> 						2428 목록 항목 (selectable)
> 						2429 목록 항목 (selectable)
> 						2430 목록 항목 (selectable)
> 						2431 목록 항목 (selectable)
> 						2432 목록 항목 (selectable)
> 						2433 목록 항목 (selectable)
> 						2434 목록 항목 (selectable)
> 						2435 목록 항목 (selectable)
> 						2436 목록 항목 (selectable)
> 						2437 목록 항목 (selectable)
> 						2438 목록 항목 (selectable)
> 						2439 목록 항목 (selectable)
> 						2440 목록 항목 (selectable)
> 						2441 목록 항목 (selectable)
> 						2442 목록 항목 (selectable)
> 						2443 목록 항목 (selectable)
> 						2444 목록 항목 (selectable)
> 						2445 목록 항목 (selectable)
> 						2446 목록 항목 (selectable)
> 						2447 목록 항목 (selectable)
> 						2448 목록 항목 (selectable)
> 						2449 목록 항목 (selectable)
> 						2450 목록 항목 (selectable)
> 						2451 목록 항목 (selectable)
> 						2452 목록 항목 (selectable)
> 					73 스크롤 막대 ID: 59904
> 						74 단추 왼쪽 스크롤 화살표 ID: UpButton
> 						75 위치 조정 위치 ID: ScrollbarThumb
> 						76 단추 오른쪽 스크롤 화살표 ID: DownButton
> 			2453 탭 항목 (selectable) Python Script
> 			2454 탭 항목 (selectable) Debugger
> 			2455 탭 항목 (selectable) Output
> 			80 단추 Close
> 		81 창 Splitter ID: 379914392
> 		82 Tab Class View ID: 379754008
> 			83 트리 (disabled) ID: 103
> 			2456 탭 항목 (selectable) Lib
> 			2457 탭 항목 (selectable) File
> 			2458 탭 항목 (selectable) Class
> 			2459 탭 항목 (selectable) Global
> 			88 단추 Close
> 		89 Tab Properties ID: 379754464
> 			90 창 (disabled) ID: 269687312
> 				91 TABLE Properties Window ID: 271397096
> 				92 도구 모음 ID: 59392
> 					93 단추
> 					94 단추
> 			2460 탭 항목 (selectable) Properties
> 			96 단추 Close
>
...
>   "code": "await new Promise(r=>setTimeout(r,8000)); state=await sky.get_window_state({window:targetWindow,include_screenshot:true,include_text:true}); targetWindow=state.window; nodeRepl.write(String(state.accessibility?.tree||''));",
>   "timeout_ms": 30000
> }
> ```
>
...
> 			13 도구 모음 Edit
> 				3318 단추 Toggle bookmark
> 				3319 단추 (disabled) Previous bookmark
> 				3320 단추 (disabled) Next bookmark
> 				3321 단추 (disabled) Delete all bookmarks
> 				3322 단추 (disabled) Previous bookmark in this file
> 				3323 단추 (disabled) Next bookmark in this file
> 				3324 단추 Comment selected text (Ctrl+Shift+C)
> 				3325 단추 Remove comment (Ctrl+Shift+X)
> 				3326 단추 Unindent (Shift+Tab)
> 				3327 단추 Indent (Tab)
