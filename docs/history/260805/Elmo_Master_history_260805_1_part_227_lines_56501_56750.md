> 					8978 custom Comment
> 					8979 custom Filename
> 				110 도구 모음 ID: 59392
> 					111 단추
> 					112 단추
> 			8980 탭 항목 (selectable) Properties
> 			114 단추 Close
>
...
> ```json
> {
>   "code": "{const observation=globalThis.state;if(!observation?.accessibility)throw new Error('reobserve');globalThis.state=null;await sky.click({window:observation.window,element_index:8369,mouse_button:'right'});globalThis.state=await sky.get_window_state({window:observation.window,include_screenshot:true,include_text:true});globalThis.targetWindow=state.window;nodeRepl.write(String(state.accessibility?.tree||state.accessibility?.document_text||''))}",
>   "title": "변수 추가 메뉴 열기"
> }
> ```
>
...
> 			13 도구 모음 Script
> 			14 도구 모음 Edit
> 				9539 단추 Toggle bookmark
> 				9540 단추 (disabled) Previous bookmark
> 				9541 단추 (disabled) Next bookmark
> 				9542 단추 (disabled) Delete all bookmarks
> 				9543 단추 (disabled) Previous bookmark in this file
> 				9544 단추 (disabled) Next bookmark in this file
> 				9545 단추 (disabled) Comment selected text (Ctrl+Shift+C)
> 				9546 단추 (disabled) Remove comment (Ctrl+Shift+X)
> 				9547 단추 (disabled) Unindent (Shift+Tab)
> 				9548 단추 (disabled) Indent (Tab)
> 			25 도구 모음 Macros Manager
> 				9549 메뉴 항목 Macros
> 			27 도구 모음 Layout Manager
> 				9550 메뉴 항목 Layouts
> 			29 도구 모음 Toolbox
> 				9551 단추 DataAnalyzer
> 				9552 메뉴 항목 Toolbar Options
> 			32 도구 모음 Net Edit
> 				9553 단추 (disabled) Select
> 				9554 메뉴 항목 Toolbar Options
> 			35 도구 모음 Debug
> 				9555 단추 Go online (Alt+F6)
> 				9556 단추 Change Online Settings
> 				9557 메뉴 항목 Online Connection
> 				9558 단추 (disabled) Set Online Connection For Current Project
> 				9559 단추 (disabled) Download (F6)
> 				9560 단추 Build Changes, Online, Download and Run (CTRL+ALT+F6)
> 				9561 단추 (disabled) Download Module on the Fly
> 				9562 단추 (disabled) Save Project on PLC
> 				9563 단추 (disabled) Start (F7)
> 				9564 단추 (disabled) Reset (F8)
> 				9565 단추 Toggle breakpoint (F4)
> 				9566 단추 Create condition breakpoint
> 				9567 메뉴 항목 Toolbar Options
> 			49 도구 모음 Build
> 				9568 메뉴 항목 Target Architecture
> 				9569 단추 Build changes (F9)
> 				9570 단추 Rebuild project (Strg+F9)
> 				9571 단추 (disabled) Cancel building (Ctrl+Break)
> 				9572 단추 Link project
> 			55 도구 모음 Standard
> 				9573 단추 New project (Strg+N)
> 				9574 단추 Open a file (Strg+Shift+O)
> 				9575 단추 Close active document (Strg+F4)
> 				9576 단추 (disabled) Save file (Strg+S)
> 				9577 단추 Open project (Strg+O)
> 				9578 단추 (disabled) Save project changes (Strg+Shift+S)
> 				9579 단추 Close project
> 				9580 단추 Print
> 				9581 단추 Cut (Strg+X)
> 				9582 단추 Copy (Strg+C)
> 				9583 단추 Paste (Strg+V)
> 				9584 메뉴 항목 (disabled) Undo (Strg+Z)
> 				9585 메뉴 항목 (disabled) Redo (Strg+Y)
> 				9586 단추 Navigate Backward (Alt+Left)
> 				9587 단추 (disabled) Navigate Forward (Alt +Right)
> 			71 메뉴 모음 Menu Bar
> 				9588 메뉴 항목 FILE
> 				9589 메뉴 항목 EDIT
> 				9590 메뉴 항목 VIEW
...
> 			9599 탭 항목 (selectable) Python Script
> 			9600 탭 항목 (selectable) Debugger
> 			9601 탭 항목 (selectable) Output
> 			97 단추 Close
