...
> 			13 도구 모음 Script
> 			14 도구 모음 Edit
> 				8897 단추 Toggle bookmark
> 				8898 단추 (disabled) Previous bookmark
> 				8899 단추 (disabled) Next bookmark
> 				8900 단추 (disabled) Delete all bookmarks
> 				8901 단추 (disabled) Previous bookmark in this file
> 				8902 단추 (disabled) Next bookmark in this file
> 				8903 단추 (disabled) Comment selected text (Ctrl+Shift+C)
> 				8904 단추 (disabled) Remove comment (Ctrl+Shift+X)
> 				8905 단추 (disabled) Unindent (Shift+Tab)
> 				8906 단추 (disabled) Indent (Tab)
> 			25 도구 모음 Macros Manager
> 				8907 메뉴 항목 Macros
> 			27 도구 모음 Layout Manager
> 				8908 메뉴 항목 Layouts
> 			29 도구 모음 Toolbox
> 				8909 단추 DataAnalyzer
> 				8910 메뉴 항목 Toolbar Options
> 			32 도구 모음 Net Edit
> 				8911 단추 (disabled) Select
> 				8912 메뉴 항목 Toolbar Options
> 			35 도구 모음 Debug
> 				8913 단추 Go online (Alt+F6)
> 				8914 단추 Change Online Settings
> 				8915 메뉴 항목 Online Connection
> 				8916 단추 (disabled) Set Online Connection For Current Project
> 				8917 단추 (disabled) Download (F6)
> 				8918 단추 Build Changes, Online, Download and Run (CTRL+ALT+F6)
> 				8919 단추 (disabled) Download Module on the Fly
> 				8920 단추 (disabled) Save Project on PLC
> 				8921 단추 (disabled) Start (F7)
> 				8922 단추 (disabled) Reset (F8)
> 				8923 단추 Toggle breakpoint (F4)
> 				8924 단추 Create condition breakpoint
> 				8925 메뉴 항목 Toolbar Options
> 			49 도구 모음 Build
> 				8926 메뉴 항목 Target Architecture
> 				8927 단추 Build changes (F9)
> 				8928 단추 Rebuild project (Strg+F9)
> 				8929 단추 (disabled) Cancel building (Ctrl+Break)
> 				8930 단추 Link project
> 			55 도구 모음 Standard
> 				8931 단추 New project (Strg+N)
> 				8932 단추 Open a file (Strg+Shift+O)
> 				8933 단추 Close active document (Strg+F4)
> 				8934 단추 (disabled) Save file (Strg+S)
> 				8935 단추 Open project (Strg+O)
> 				8936 단추 (disabled) Save project changes (Strg+Shift+S)
> 				8937 단추 Close project
> 				8938 단추 Print
> 				8939 단추 Cut (Strg+X)
> 				8940 단추 Copy (Strg+C)
> 				8941 단추 Paste (Strg+V)
> 				8942 메뉴 항목 (disabled) Undo (Strg+Z)
> 				8943 메뉴 항목 (disabled) Redo (Strg+Y)
> 				8944 단추 Navigate Backward (Alt+Left)
> 				8945 단추 (disabled) Navigate Forward (Alt +Right)
> 			71 메뉴 모음 Menu Bar
> 				8946 메뉴 항목 FILE
> 				8947 메뉴 항목 EDIT
> 				8948 메뉴 항목 VIEW
...
> 			8957 탭 항목 (selectable) Python Script
> 			8958 탭 항목 (selectable) Debugger
> 			8959 탭 항목 (selectable) Output
> 			97 단추 Close
...
> 			8960 탭 항목 (selectable) Lib
> 			8961 탭 항목 (selectable) File
> 			8962 탭 항목 (selectable) Global
> 			8963 탭 항목 (selectable) Net
> 			8964 탭 항목 (selectable) Class
> 			106 단추 Close
...
> 					8965 custom Name
> 					8966 custom Revision
> 					8967 custom GUID
> 					8968 custom Task Settings
> 					8969 custom Sigmatek
> 					8970 custom OSInterface
> 					8971 custom IconPath
> 					8972 custom SharedCommandTable
> 					8973 custom Objectsize
> 					8974 custom Singleton
> 					8975 custom Hidden
> 					8976 custom Deprecated
> 					8977 custom GCCOptions
