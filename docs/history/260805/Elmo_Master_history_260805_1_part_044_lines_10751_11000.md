...
> ```json
> {
>   "code": "nodeRepl.write(JSON.stringify(Object.keys(globalThis).filter(k=>/doc|sky|computer/i.test(k)),null,2))",
>   "title": "GUI API 도움말 확인"
> }
> ```
>
> ```text
...
> ```json
> {
>   "code": "var skyApiDoc57 = await sky.documentation(\"api\"); nodeRepl.write(String(skyApiDoc57).slice(0,30000))",
>   "title": "GUI API 규약 확인"
> }
> ```
>
