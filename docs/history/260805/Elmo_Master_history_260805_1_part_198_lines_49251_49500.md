...
> ```json
> {
>   "title": "Monitor LASAL observer search",
>   "code": "await new Promise(r=>setTimeout(r,20000)); state=await sky.get_window_state({window:targetWindow,include_screenshot:true,include_text:true}); targetWindow=state.window; nodeRepl.write(String(state.accessibility?.tree||''));",
>   "timeout_ms": 40000
> }
> ```
>
...
> 			13 도구 모음 Edit
> 				22671 단추 Toggle bookmark
> 				22672 단추 (disabled) Previous bookmark
> 				22673 단추 (disabled) Next bookmark
> 				22674 단추 (disabled) Delete all bookmarks
> 				22675 단추 (disabled) Previous bookmark in this file
> 				22676 단추 (disabled) Next bookmark in this file
> 				22677 단추 Comment selected text (Ctrl+Shift+C)
> 				22678 단추 Remove comment (Ctrl+Shift+X)
> 				22679 단추 Unindent (Shift+Tab)
> 				22680 단추 Indent (Tab)
...
> 				22682 메뉴 항목 Layouts
> 			28 도구 모음 Toolbox
> 				22683 단추 DataAnalyzer
> 				22684 메뉴 항목 Toolbar Options
> 			31 도구 모음 Net Edit
> 				22685 단추 (disabled) Select
> 				22686 메뉴 항목 Toolbar Options
> 			34 도구 모음 Debug
> 				22687 단추 Go online (Alt+F6)
> 				22688 메뉴 항목 Toolbar Options
> 			37 도구 모음 Build
> 				22689 메뉴 항목 Target Architecture
> 				22690 메뉴 항목 Toolbar Options
> 			40 도구 모음 Standard
> 				22691 단추 New project (Strg+N)
> 				22692 단추 Open a file (Strg+Shift+O)
> 				22693 단추 Close active document (Strg+F4)
> 				22694 단추 (disabled) Save file (Strg+S)
> 				22695 단추 Open project (Strg+O)
> 				22696 단추 (disabled) Save project changes (Strg+Shift+S)
> 				22697 단추 Close project
> 				22698 단추 Print
> 				22699 단추 Cut (Strg+X)
> 				22700 단추 Copy (Strg+C)
> 				22701 단추 (disabled) Paste (Strg+V)
> 				22702 메뉴 항목 (disabled) Undo (Strg+Z)
> 				22703 메뉴 항목 (disabled) Redo (Strg+Y)
> 				22704 메뉴 항목 Toolbar Options
> 			55 메뉴 모음 Menu Bar
> 				22705 메뉴 항목 FILE
> 				22706 메뉴 항목 EDIT
> 				22707 메뉴 항목 VIEW
...
> 						14382 목록 항목 (selectable)
> 						14383 목록 항목 (selectable)
> 						14384 목록 항목 (selectable)
> 						14385 목록 항목 (selectable)
> 						14386 목록 항목 (selectable)
> 						14387 목록 항목 (selectable)
> 						14388 목록 항목 (selectable)
> 						14389 목록 항목 (selectable)
> 						14390 목록 항목 (selectable)
> 						14391 목록 항목 (selectable)
> 						14392 목록 항목 (selectable)
> 						14393 목록 항목 (selectable)
> 						14394 목록 항목 (selectable)
> 						14395 목록 항목 (selectable)
> 						14396 목록 항목 (selectable)
> 						14397 목록 항목 (selectable)
> 						14398 목록 항목 (selectable)
> 						14399 목록 항목 (selectable)
> 						14400 목록 항목 (selectable)
> 						14401 목록 항목 (selectable)
> 						14402 목록 항목 (selectable)
> 						14403 목록 항목 (selectable)
> 						14404 목록 항목 (selectable)
> 						14405 목록 항목 (selectable)
> 						14406 목록 항목 (selectable)
> 						14407 목록 항목 (selectable)
> 						21430 목록 항목 (selectable)
> 						21431 목록 항목 (selectable)
> 						21432 목록 항목 (selectable)
> 						21433 목록 항목 (selectable)
> 						21434 목록 항목 (selectable)
> 						21435 목록 항목 (selectable)
> 						21436 목록 항목 (selectable)
> 						21437 목록 항목 (selectable)
> 						21438 목록 항목 (selectable)
> 						21492 목록 항목 (selectable)
> 						21493 목록 항목 (selectable)
> 						21494 목록 항목 (selectable)
> 						21495 목록 항목 (selectable)
> 						21496 목록 항목 (selectable)
> 					73 스크롤 막대 ID: 59904
> 						74 단추 왼쪽 스크롤 화살표 ID: UpButton
> 						75 위치 조정 위치 ID: ScrollbarThumb
> 						76 단추 오른쪽 스크롤 화살표 ID: DownButton
> 			22716 탭 항목 (selectable) Python Script
> 			22717 탭 항목 (selectable) Debugger
> 			22718 탭 항목 (selectable) Output
> 			80 단추 Close
...
> 			22719 탭 항목 (selectable) Lib
> 			22720 탭 항목 (selectable) File
> 			22721 탭 항목 (selectable) Class
> 			22722 탭 항목 (selectable) Global
> 			88 단추 Close
...
> 					93 단추
> 					94 단추
> 			22723 탭 항목 (selectable) Properties
> 			96 단추 Close
>
