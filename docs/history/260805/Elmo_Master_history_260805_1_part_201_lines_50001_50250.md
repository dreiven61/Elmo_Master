...
> 			13 도구 모음 Edit
> 				28247 단추 Toggle bookmark
> 				28248 단추 (disabled) Previous bookmark
> 				28249 단추 (disabled) Next bookmark
> 				28250 단추 (disabled) Delete all bookmarks
> 				28251 단추 (disabled) Previous bookmark in this file
> 				28252 단추 (disabled) Next bookmark in this file
> 				28253 단추 Comment selected text (Ctrl+Shift+C)
> 				28254 단추 Remove comment (Ctrl+Shift+X)
> 				28255 단추 Unindent (Shift+Tab)
> 				28256 단추 Indent (Tab)
...
> 				28258 메뉴 항목 Layouts
> 			28 도구 모음 Toolbox
> 				28259 단추 DataAnalyzer
> 				28260 메뉴 항목 Toolbar Options
> 			31 도구 모음 Net Edit
> 				28261 단추 (disabled) Select
> 				28262 메뉴 항목 Toolbar Options
> 			34 도구 모음 Debug
> 				28263 단추 Go online (Alt+F6)
> 				28264 메뉴 항목 Toolbar Options
> 			37 도구 모음 Build
> 				28265 메뉴 항목 Target Architecture
> 				28266 메뉴 항목 Toolbar Options
> 			40 도구 모음 Standard
> 				28267 단추 New project (Strg+N)
> 				28268 단추 Open a file (Strg+Shift+O)
> 				28269 단추 Close active document (Strg+F4)
> 				28270 단추 (disabled) Save file (Strg+S)
> 				28271 단추 Open project (Strg+O)
> 				28272 단추 (disabled) Save project changes (Strg+Shift+S)
> 				28273 단추 Close project
> 				28274 단추 Print
> 				28275 단추 Cut (Strg+X)
> 				28276 단추 Copy (Strg+C)
> 				28277 단추 (disabled) Paste (Strg+V)
> 				28278 메뉴 항목 (disabled) Undo (Strg+Z)
> 				28279 메뉴 항목 (disabled) Redo (Strg+Y)
> 				28280 메뉴 항목 Toolbar Options
> 			55 메뉴 모음 Menu Bar
> 				28281 메뉴 항목 FILE
> 				28282 메뉴 항목 EDIT
> 				28283 메뉴 항목 VIEW
...
> 						23832 목록 항목 (selectable)
> 						23833 목록 항목 (selectable)
> 						23834 목록 항목 (selectable)
> 						23835 목록 항목 (selectable)
> 						23836 목록 항목 (selectable)
...
> 			28292 탭 항목 (selectable) Python Script
> 			28293 탭 항목 (selectable) Debugger
> 			28294 탭 항목 (selectable) Output
> 			80 단추 Close
...
> 					27658 단추 페이지 위로 ID: UpPageButton
> 					2922 위치 조정 위치 ID: ScrollbarThumb
> 					28295 단추 페이지 아래로 ID: DownPageButton
> 					2924 단추 아래쪽 스크롤 화살표 ID: DownButton
> 				2925 콘솔 트리 (selectable) Elmo_EtherCAT_Test_4Axis
> 					2926 콘솔 트리 (selectable) External
> 					2927 콘솔 트리 (selectable) Sigmatek
> 					2928 콘솔 트리 (selectable) Elmo_1
> 					2929 콘솔 트리 (selectable) Elmo_2
...
> 						28296 콘솔 트리 (selectable) Servers
> 						28297 콘솔 트리 (selectable) Clients
> 						28298 콘솔 트리 (selectable) Methods
> 						28299 콘솔 트리 (selectable) Variables
> 						28300 콘솔 트리 (selectable) Objects
> 						28301 콘솔 트리 (selectable) Dependencies
...
> 			28302 탭 항목 (selectable) Lib
> 			28303 탭 항목 (selectable) File
> 			28304 탭 항목 (selectable) Class
> 			28305 탭 항목 (selectable) Global
> 			88 단추 Close
> 		89 Tab Properties ID: 379754464
> 			90 창 ID: 269687312
> 				91 TABLE Properties Window ID: 271397096
> 					28306 스크롤 막대 세로 ID: NonClientVerticalScrollBar
> 						28307 단추 위쪽 스크롤 화살표 ID: UpButton
> 						28308 위치 조정 위치 ID: ScrollbarThumb
> 						28309 단추 페이지 아래로 ID: DownPageButton
> 						28310 단추 아래쪽 스크롤 화살표 ID: DownButton
> 					28311 custom Name
> 					28312 custom Revision
> 					28313 custom GUID
> 					28314 custom Task Settings
> 					28315 custom Sigmatek
> 					28316 custom OSInterface
> 					28317 custom IconPath
> 					28318 custom SharedCommandTable
> 					28319 custom Objectsize
> 					28320 custom Singleton
> 					28321 custom Hidden
> 					28322 custom Deprecated
> 					28323 custom GCCOptions
> 					28324 custom Comment
> 					28325 custom Filename
> 				92 도구 모음 ID: 59392
> 					93 단추
> 					94 단추
> 			28326 탭 항목 (selectable) Properties
> 			96 단추 Close
>
...
> ```json
> {
>   "title": "Expand ownership service methods",
>   "code": "var obsMethods1=state; var sidMethods1=obsMethods1.screenshots[0].id; state=null; await sky.click({window:obsMethods1.window,screenshotId:sidMethods1,x:723,y:200}); state=await sky.get_window_state({window:obsMethods1.window,include_screenshot:true,include_text:true}); targetWindow=state.window; nodeRepl.write(String(state.accessibility?.tree||''));"
> }
> ```
>
> ```text
...
> 		12 창 xtpBarTop ID: 59419
> 			13 도구 모음 Edit
> 				28871 단추 Toggle bookmark
> 				28872 단추 (disabled) Previous bookmark
> 				28873 단추 (disabled) Next bookmark
> 				28874 단추 (disabled) Delete all bookmarks
> 				28875 단추 (disabled) Previous bookmark in this file
> 				28876 단추 (disabled) Next bookmark in this file
> 				28877 단추 (disabled) Comment selected text (Ctrl+Shift+C)
> 				28878 단추 (disabled) Remove comment (Ctrl+Shift+X)
> 				28879 단추 (disabled) Unindent (Shift+Tab)
> 				28880 단추 (disabled) Indent (Tab)
