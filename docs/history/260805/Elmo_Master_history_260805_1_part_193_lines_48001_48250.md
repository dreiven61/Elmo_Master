...
> 			15218 탭 항목 (selectable) Python Script
> 			15219 탭 항목 (selectable) Debugger
> 			15220 탭 항목 (selectable) Output
> 			80 단추 Close
...
> 			15221 탭 항목 (selectable) Lib
> 			15222 탭 항목 (selectable) File
> 			15223 탭 항목 (selectable) Class
> 			15224 탭 항목 (selectable) Global
> 			88 단추 Close
...
> 					93 단추
> 					94 단추
> 			15225 탭 항목 (selectable) Properties
> 			96 단추 Close
>
...
>   "code": "await new Promise(r=>setTimeout(r,15000)); state=await sky.get_window_state({window:targetWindow,include_screenshot:true,include_text:true}); targetWindow=state.window; nodeRepl.write(String(state.accessibility?.tree||''));",
>   "timeout_ms": 30000
> }
> ```
>
...
> 			13 도구 모음 Edit
> 				17081 단추 Toggle bookmark
> 				17082 단추 (disabled) Previous bookmark
> 				17083 단추 (disabled) Next bookmark
> 				17084 단추 (disabled) Delete all bookmarks
> 				17085 단추 (disabled) Previous bookmark in this file
> 				17086 단추 (disabled) Next bookmark in this file
> 				17087 단추 Comment selected text (Ctrl+Shift+C)
> 				17088 단추 Remove comment (Ctrl+Shift+X)
> 				17089 단추 Unindent (Shift+Tab)
> 				17090 단추 Indent (Tab)
...
> 				17092 메뉴 항목 Layouts
> 			28 도구 모음 Toolbox
> 				17093 단추 DataAnalyzer
> 				17094 메뉴 항목 Toolbar Options
> 			31 도구 모음 Net Edit
> 				17095 단추 (disabled) Select
> 				17096 메뉴 항목 Toolbar Options
> 			34 도구 모음 Debug
> 				17097 단추 Go online (Alt+F6)
> 				17098 메뉴 항목 Toolbar Options
> 			37 도구 모음 Build
> 				17099 메뉴 항목 Target Architecture
> 				17100 메뉴 항목 Toolbar Options
> 			40 도구 모음 Standard
> 				17101 단추 New project (Strg+N)
> 				17102 단추 Open a file (Strg+Shift+O)
> 				17103 단추 Close active document (Strg+F4)
> 				17104 단추 (disabled) Save file (Strg+S)
> 				17105 단추 Open project (Strg+O)
> 				17106 단추 (disabled) Save project changes (Strg+Shift+S)
> 				17107 단추 Close project
> 				17108 단추 Print
> 				17109 단추 Cut (Strg+X)
> 				17110 단추 Copy (Strg+C)
> 				17111 단추 (disabled) Paste (Strg+V)
> 				17112 메뉴 항목 (disabled) Undo (Strg+Z)
> 				17113 메뉴 항목 (disabled) Redo (Strg+Y)
> 				17114 메뉴 항목 Toolbar Options
> 			55 메뉴 모음 Menu Bar
> 				17115 메뉴 항목 FILE
> 				17116 메뉴 항목 EDIT
> 				17117 메뉴 항목 VIEW
