...
> ```json
> {
>   "code": "await sky.click({window: targetWindow, x: 1336, y: 359, button: 'right'}); state = await sky.get_window_state({window: targetWindow, include_text:true, include_screenshot:true}); nodeRepl.write(state)",
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[BASE64_OMITTED source_line=5802 chars=9977 sha256=ab762f360db3364eb65ebe6b20fb7f669d7efb6893e8ff8fe92c503c1e408bfc]'... 302171 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[BASE64_OMITTED source_line=5811 chars=9977 sha256=e5696bee197b55948ae5ac4ca489f923f484d6079e22fd2df71585b5baaf37f2]'... 280383 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
>       '\t\t\t13 도구 모음 Edit\n' +
>       '\t\t\t\t39246 단추 Toggle bookmark\n' +
>       '\t\t\t\t39247 단추 (disabled) Previous bookmark\n' +
>       '\t\t\t\t39248 단추 (disabled) Next bookmark\n' +
>       '\t\t\t\t39249 단추 (disabled) Delete all bookmarks\n' +
>       '\t\t\t\t39250 단추 (disabled) Previous bookmark in this file\n' +
>       '\t\t\t\t39251 단추 (disabled) Next bookmark in this file\n' +
>       '\t\t\t\t39252 단추 (disabled) Comment selected text (Ctrl+Shift+C)\n' +
>       '\t\t\t\t39253 단추 (disabled) Remove comment (Ctrl+Shift+X)\n' +
>       '\t\t\t\t39254 단추 (disabled) Unindent (Shift+Tab)\n' +
>       '\t\t\t\t39255 단추 (disabled) Indent (Tab)\n' +
>       '\t\t\t24 도구 모음 Macros Manager\n' +
>       '\t\t\t\t39256 메뉴 항목 Macros\n' +
>       '\t\t\t26 도구 모음 Layout Manager\n' +
>       '\t\t\t\t39257 메뉴 항목 Layouts\n' +
>       '\t\t\t28 도구 모음 Toolbox\n' +
>       '\t\t\t\t39258 단추 DataAnalyzer\n' +
>       '\t\t\t\t39259 메뉴 항목 Toolbar Options\n' +
>       '\t\t\t31 도구 모음 Net Edit\n' +
>       '\t\t\t\t39260 단추 (disabled) Select\n' +
>       '\t\t\t\t39261 메뉴 항목 Toolbar Options\n' +
>       '\t\t\t34 도구 모음 Debug\n' +
>       '\t\t\t\t39262 단추 Go online (Alt+F6)\n' +
>       '\t\t\t\t39263 단추 Change Online Settings\n' +
>       '\t\t\t\t39264 메뉴 항목 Online Connection\n' +
>       '\t\t\t\t39265 단추 (disabled) Set Online Connection For Current Project\n' +
>       '\t\t\t\t39266 단추 (disabled) Download (F6)\n' +
>       '\t\t\t\t39267 단추 Build Changes, Online, Download and Run (CTRL+ALT+F6)\n' +
>       '\t\t\t\t39268 단추 (disabled) Download Module on the Fly\n' +
>       '\t\t\t\t39269 단추 (disabled) Save Project on PLC\n' +
>       '\t\t\t\t39270 단추 (disabled) Start (F7)\n' +
>       '\t\t\t\t39271 단추 (disabled) Reset (F8)\n' +
>       '\t\t\t\t39272 단추 Toggle breakpoint (F4)\n' +
>       '\t\t\t\t39273 단추 Create condition breakpoint\n' +
>       '\t\t\t\t39274 메뉴 항목 Toolbar Options\n' +
>       '\t\t\t48 도구 모음 Build\n' +
>       '\t\t\t\t39275 메뉴 항목 Target Architecture\n' +
>       '\t\t\t\t39276 단추 Build changes (F9)\n' +
>       '\t\t\t\t39277 단추 Rebuild project (Strg+F9)\n' +
>       '\t\t\t\t39278 단추 (disabled) Cancel building (Ctrl+Break)\n' +
>       '\t\t\t\t39279 단추 Link project\n' +
>       '\t\t\t54 도구 모음 Standard\n' +
>       '\t\t\t\t39280 단추 New project (Strg+N)\n' +
>       '\t\t\t\t39281 단추 Open a file (Strg+Shift+O)\n' +
>       '\t\t\t\t39282 단추 Close active document (Strg+F4)\n' +
>       '\t\t\t\t39283 단추 Save file (Strg+S)\n' +
>       '\t\t\t\t39284 단추 Open project (Strg+O)\n' +
>       '\t\t\t\t39285 단추 Save project changes (Strg+Shift+S)\n' +
>       '\t\t\t\t39286 단추 Close project\n' +
>       '\t\t\t\t39287 단추 Print\n' +
>       '\t\t\t\t39288 단추 Cut (Strg+X)\n' +
>       '\t\t\t\t39289 단추 Copy (Strg+C)\n' +
>       '\t\t\t\t39290 단추 Paste (Strg+V)\n' +
>       '\t\t\t\t39291 메뉴 항목 Undo (Strg+Z)\n' +
>       '\t\t\t\t39292 메뉴 항목 (disabled) Redo (Strg+Y)\n' +
>       '\t\t\t\t39293 단추 (disabled) Navigate Backward (Alt+Left)\n' +
>       '\t\t\t\t39294 단추 (disabled) Navigate Forward (Alt +Right)\n' +
>       '\t\t\t70 메뉴 모음 Menu Bar\n' +
>       '\t\t\t\t39295 메뉴 항목 FILE\n' +
>       '\t\t\t\t39296 메뉴 항목 EDIT\n' +
>       '\t\t\t\t39297 메뉴 항목 VIEW\n' +
...
>       '\t\t\t39306 탭 항목 (selectable) Python Script\n' +
>       '\t\t\t39307 탭 항목 (selectable) Debugger\n' +
>       '\t\t\t39308 탭 항목 (selectable) Output\n' +
>       '\t\t\t95 단추 Close\n' +
