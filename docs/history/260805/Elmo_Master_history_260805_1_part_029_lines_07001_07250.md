>       '\t\t\t31 도구 모음 Net Edit\n' +
>       '\t\t\t\t44883 단추 (disabled) Select\n' +
>       '\t\t\t\t44884 메뉴 항목 Toolbar Options\n' +
>       '\t\t\t34 도구 모음 Debug\n' +
>       '\t\t\t\t44885 단추 Go online (Alt+F6)\n' +
>       '\t\t\t\t44886 단추 Change Online Settings\n' +
>       '\t\t\t\t44887 메뉴 항목 Online Connection\n' +
>       '\t\t\t\t44888 단추 (disabled) Set Online Connection For Current Project\n' +
>       '\t\t\t\t44889 단추 (disabled) Download (F6)\n' +
>       '\t\t\t\t44890 단추 Build Changes, Online, Download and Run (CTRL+ALT+F6)\n' +
>       '\t\t\t\t44891 단추 (disabled) Download Module on the Fly\n' +
>       '\t\t\t\t44892 단추 (disabled) Save Project on PLC\n' +
>       '\t\t\t\t44893 단추 (disabled) Start (F7)\n' +
>       '\t\t\t\t44894 단추 (disabled) Reset (F8)\n' +
>       '\t\t\t\t44895 단추 Toggle breakpoint (F4)\n' +
>       '\t\t\t\t44896 단추 Create condition breakpoint\n' +
>       '\t\t\t\t44897 메뉴 항목 Toolbar Options\n' +
>       '\t\t\t48 도구 모음 Build\n' +
>       '\t\t\t\t44898 메뉴 항목 Target Architecture\n' +
>       '\t\t\t\t44899 단추 Build changes (F9)\n' +
>       '\t\t\t\t44900 단추 Rebuild project (Strg+F9)\n' +
>       '\t\t\t\t44901 단추 (disabled) Cancel building (Ctrl+Break)\n' +
>       '\t\t\t\t44902 단추 Link project\n' +
>       '\t\t\t54 도구 모음 Standard\n' +
>       '\t\t\t\t44903 단추 New project (Strg+N)\n' +
>       '\t\t\t\t44904 단추 Open a file (Strg+Shift+O)\n' +
>       '\t\t\t\t44905 단추 Close active document (Strg+F4)\n' +
>       '\t\t\t\t44906 단추 Save file (Strg+S)\n' +
>       '\t\t\t\t44907 단추 Open project (Strg+O)\n' +
>       '\t\t\t\t44908 단추 Save project changes (Strg+Shift+S)\n' +
>       '\t\t\t\t44909 단추 Close project\n' +
>       '\t\t\t\t44910 단추 Print\n' +
>       '\t\t\t\t44911 단추 Cut (Strg+X)\n' +
>       '\t\t\t\t44912 단추 Copy (Strg+C)\n' +
>       '\t\t\t\t44913 단추 Paste (Strg+V)\n' +
>       '\t\t\t\t44914 메뉴 항목 Undo (Strg+Z)\n' +
>       '\t\t\t\t44915 메뉴 항목 (disabled) Redo (Strg+Y)\n' +
>       '\t\t\t\t44916 단추 (disabled) Navigate Backward (Alt+Left)\n' +
>       '\t\t\t\t44917 단추 (disabled) Navigate Forward (Alt +Right)\n' +
>       '\t\t\t70 메뉴 모음 Menu Bar\n' +
>       '\t\t\t\t44918 메뉴 항목 FILE\n' +
>       '\t\t\t\t44919 메뉴 항목 EDIT\n' +
>       '\t\t\t\t44920 메뉴 항목 VIEW\n' +
...
>       '\t\t\t44929 탭 항목 (selectable) Python Script\n' +
>       '\t\t\t44930 탭 항목 (selectable) Debugger\n' +
>       '\t\t\t44931 탭 항목 (selectable) Output\n' +
>       '\t\t\t95 단추 Close\n' +
...
> ```json
> {
>   "code": "await sky.press_key({window: targetWindow, key: 'Return'}); state = await sky.get_window_state({window: targetWindow, include_text:true, include_screenshot:true}); nodeRepl.write(state)",
>   "title": "Commit LASAL method rename"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[BASE64_OMITTED source_line=7158 chars=9977 sha256=ab762f360db3364eb65ebe6b20fb7f669d7efb6893e8ff8fe92c503c1e408bfc]'... 301635 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[BASE64_OMITTED source_line=7167 chars=9977 sha256=e5696bee197b55948ae5ac4ca489f923f484d6079e22fd2df71585b5baaf37f2]'... 279879 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
>       '\t\t\t13 도구 모음 Edit\n' +
>       '\t\t\t\t45234 단추 Toggle bookmark\n' +
>       '\t\t\t\t45235 단추 (disabled) Previous bookmark\n' +
>       '\t\t\t\t45236 단추 (disabled) Next bookmark\n' +
>       '\t\t\t\t45237 단추 (disabled) Delete all bookmarks\n' +
>       '\t\t\t\t45238 단추 (disabled) Previous bookmark in this file\n' +
>       '\t\t\t\t45239 단추 (disabled) Next bookmark in this file\n' +
>       '\t\t\t\t45240 단추 (disabled) Comment selected text (Ctrl+Shift+C)\n' +
>       '\t\t\t\t45241 단추 (disabled) Remove comment (Ctrl+Shift+X)\n' +
>       '\t\t\t\t45242 단추 (disabled) Unindent (Shift+Tab)\n' +
>       '\t\t\t\t45243 단추 (disabled) Indent (Tab)\n' +
>       '\t\t\t24 도구 모음 Macros Manager\n' +
>       '\t\t\t\t45244 메뉴 항목 Macros\n' +
>       '\t\t\t26 도구 모음 Layout Manager\n' +
>       '\t\t\t\t45245 메뉴 항목 Layouts\n' +
>       '\t\t\t28 도구 모음 Toolbox\n' +
>       '\t\t\t\t45246 단추 DataAnalyzer\n' +
>       '\t\t\t\t45247 메뉴 항목 Toolbar Options\n' +
>       '\t\t\t31 도구 모음 Net Edit\n' +
>       '\t\t\t\t45248 단추 (disabled) Select\n' +
>       '\t\t\t\t45249 메뉴 항목 Toolbar Options\n' +
>       '\t\t\t34 도구 모음 Debug\n' +
>       '\t\t\t\t45250 단추 Go online (Alt+F6)\n' +
>       '\t\t\t\t45251 단추 Change Online Settings\n' +
>       '\t\t\t\t45252 메뉴 항목 Online Connection\n' +
>       '\t\t\t\t45253 단추 (disabled) Set Online Connection For Current Project\n' +
>       '\t\t\t\t45254 단추 (disabled) Download (F6)\n' +
>       '\t\t\t\t45255 단추 Build Changes, Online, Download and Run (CTRL+ALT+F6)\n' +
>       '\t\t\t\t45256 단추 (disabled) Download Module on the Fly\n' +
>       '\t\t\t\t45257 단추 (disabled) Save Project on PLC\n' +
>       '\t\t\t\t45258 단추 (disabled) Start (F7)\n' +
>       '\t\t\t\t45259 단추 (disabled) Reset (F8)\n' +
>       '\t\t\t\t45260 단추 Toggle breakpoint (F4)\n' +
>       '\t\t\t\t45261 단추 Create condition breakpoint\n' +
>       '\t\t\t\t45262 메뉴 항목 Toolbar Options\n' +
>       '\t\t\t48 도구 모음 Build\n' +
>       '\t\t\t\t45263 메뉴 항목 Target Architecture\n' +
>       '\t\t\t\t45264 단추 Build changes (F9)\n' +
>       '\t\t\t\t45265 단추 Rebuild project (Strg+F9)\n' +
>       '\t\t\t\t45266 단추 (disabled) Cancel building (Ctrl+Break)\n' +
>       '\t\t\t\t45267 단추 Link project\n' +
>       '\t\t\t54 도구 모음 Standard\n' +
>       '\t\t\t\t45268 단추 New project (Strg+N)\n' +
>       '\t\t\t\t45269 단추 Open a file (Strg+Shift+O)\n' +
>       '\t\t\t\t45270 단추 Close active document (Strg+F4)\n' +
>       '\t\t\t\t45271 단추 Save file (Strg+S)\n' +
>       '\t\t\t\t45272 단추 Open project (Strg+O)\n' +
>       '\t\t\t\t45273 단추 Save project changes (Strg+Shift+S)\n' +
