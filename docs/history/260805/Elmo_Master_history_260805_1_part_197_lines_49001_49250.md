> ```text
> 20452 대화 상자 Find in Files Secondary Actions: Raise
> ```
>
...
> ```json
> {
>   "title": "Run LASAL observer search",
>   "code": "var obsFindObs5=state; state=null; await sky.press_key({window:obsFindObs5.window,key:'Return'}); state=await sky.get_window_state({window:obsFindObs5.window,include_screenshot:true,include_text:true}); targetWindow=state.window; nodeRepl.write(String(state.accessibility?.tree||''));"
> }
> ```
>
> ```text
...
> 			13 도구 모음 Edit
> 				20696 단추 Toggle bookmark
> 				20697 단추 (disabled) Previous bookmark
> 				20698 단추 (disabled) Next bookmark
> 				20699 단추 (disabled) Delete all bookmarks
> 				20700 단추 (disabled) Previous bookmark in this file
> 				20701 단추 (disabled) Next bookmark in this file
> 				20702 단추 Comment selected text (Ctrl+Shift+C)
> 				20703 단추 Remove comment (Ctrl+Shift+X)
> 				20704 단추 Unindent (Shift+Tab)
> 				20705 단추 Indent (Tab)
...
> 				20707 메뉴 항목 Layouts
> 			28 도구 모음 Toolbox
> 				20708 단추 DataAnalyzer
> 				20709 메뉴 항목 Toolbar Options
> 			31 도구 모음 Net Edit
> 				20710 단추 (disabled) Select
> 				20711 메뉴 항목 Toolbar Options
> 			34 도구 모음 Debug
> 				20712 단추 Go online (Alt+F6)
> 				20713 메뉴 항목 Toolbar Options
> 			37 도구 모음 Build
> 				20714 메뉴 항목 Target Architecture
> 				20715 메뉴 항목 Toolbar Options
> 			40 도구 모음 Standard
> 				20716 단추 New project (Strg+N)
> 				20717 단추 Open a file (Strg+Shift+O)
> 				20718 단추 Close active document (Strg+F4)
> 				20719 단추 (disabled) Save file (Strg+S)
> 				20720 단추 Open project (Strg+O)
> 				20721 단추 (disabled) Save project changes (Strg+Shift+S)
> 				20722 단추 Close project
> 				20723 단추 Print
> 				20724 단추 Cut (Strg+X)
> 				20725 단추 Copy (Strg+C)
> 				20726 단추 (disabled) Paste (Strg+V)
> 				20727 메뉴 항목 (disabled) Undo (Strg+Z)
> 				20728 메뉴 항목 (disabled) Redo (Strg+Y)
> 				20729 메뉴 항목 Toolbar Options
> 			55 메뉴 모음 Menu Bar
> 				20730 메뉴 항목 FILE
> 				20731 메뉴 항목 EDIT
> 				20732 메뉴 항목 VIEW
...
> 			20741 탭 항목 (selectable) Python Script
> 			20742 탭 항목 (selectable) Debugger
> 			20743 탭 항목 (selectable) Output
> 			80 단추 Close
...
> 			20744 탭 항목 (selectable) Lib
> 			20745 탭 항목 (selectable) File
> 			20746 탭 항목 (selectable) Class
> 			20747 탭 항목 (selectable) Global
> 			88 단추 Close
...
> 					93 단추
> 					94 단추
> 			20748 탭 항목 (selectable) Properties
> 			96 단추 Close
>
