> 				11835 단추 Go online (Alt+F6)
> 				11836 단추 Change Online Settings
> 				11837 메뉴 항목 Online Connection
> 				11838 단추 (disabled) Set Online Connection For Current Project
> 				11839 단추 (disabled) Download (F6)
> 				11840 단추 Build Changes, Online, Download and Run (CTRL+ALT+F6)
> 				11841 단추 (disabled) Download Module on the Fly
> 				11842 단추 (disabled) Save Project on PLC
> 				11843 단추 (disabled) Start (F7)
> 				11844 단추 (disabled) Reset (F8)
> 				11845 단추 Toggle breakpoint (F4)
> 				11846 단추 Create condition breakpoint
> 				11847 메뉴 항목 Toolbar Options
> 			49 도구 모음 Build
> 				11848 메뉴 항목 Target Architecture
> 				11849 단추 Build changes (F9)
> 				11850 단추 Rebuild project (Strg+F9)
> 				11851 단추 (disabled) Cancel building (Ctrl+Break)
> 				11852 단추 Link project
> 			55 도구 모음 Standard
> 				11853 단추 New project (Strg+N)
> 				11854 단추 Open a file (Strg+Shift+O)
> 				11855 단추 Close active document (Strg+F4)
> 				11856 단추 Save file (Strg+S)
> 				11857 단추 Open project (Strg+O)
> 				11858 단추 Save project changes (Strg+Shift+S)
> 				11859 단추 Close project
> 				11860 단추 Print
> 				11861 단추 Cut (Strg+X)
> 				11862 단추 Copy (Strg+C)
> 				11863 단추 Paste (Strg+V)
> 				11864 메뉴 항목 Undo (Strg+Z)
> 				11865 메뉴 항목 (disabled) Redo (Strg+Y)
> 				11866 단추 Navigate Backward (Alt+Left)
> 				11867 단추 (disabled) Navigate Forward (Alt +Right)
> 			71 메뉴 모음 Menu Bar
> 				11868 메뉴 항목 FILE
> 				11869 메뉴 항목 EDIT
> 				11870 메뉴 항목 VIEW
...
> 			11879 탭 항목 (selectable) Python Script
> 			11880 탭 항목 (selectable) Debugger
> 			11881 탭 항목 (selectable) Output
> 			97 단추 Close
...
> 			11882 탭 항목 (selectable) Lib
> 			11883 탭 항목 (selectable) File
> 			11884 탭 항목 (selectable) Global
> 			11885 탭 항목 (selectable) Net
> 			11886 탭 항목 (selectable) Class
> 			106 단추 Close
...
> 					11888 custom GUID
> 					11889 custom Type
> 					11890 custom Element Type
> 					11891 custom Pointer
> 					11892 custom Comment
> 				110 도구 모음 ID: 59392
> 					111 단추
> 					112 단추
> 			11893 탭 항목 (selectable) Properties
> 			114 단추 Close
>
> The focused UI element is 109 TABLE Properties Window ID: 272020368.
> ```
>
...
> ```json
> {
>   "code": "{const observation=globalThis.state;const sid=observation?.screenshots?.[0]?.id;if(!sid)throw new Error('no screenshot');globalThis.state=null;await sky.click({window:observation.window,screenshotId:sid,x:1029,y:382});globalThis.state=await sky.get_window_state({window:observation.window,include_screenshot:true,include_text:true});globalThis.targetWindow=state.window;nodeRepl.write(String(state.accessibility?.tree||state.accessibility?.document_text||''))}",
>   "title": "ownership lease 배열 범위 열기"
> }
> ```
>
> ```text
...
> 			13 도구 모음 Script
> 			14 도구 모음 Edit
> 				12644 단추 Toggle bookmark
> 				12645 단추 (disabled) Previous bookmark
> 				12646 단추 (disabled) Next bookmark
