...
> 			13 도구 모음 Edit
> 				19262 단추 Toggle bookmark
> 				19263 단추 (disabled) Previous bookmark
> 				19264 단추 (disabled) Next bookmark
> 				19265 단추 (disabled) Delete all bookmarks
> 				19266 단추 (disabled) Previous bookmark in this file
> 				19267 단추 (disabled) Next bookmark in this file
> 				19268 단추 (disabled) Comment selected text (Ctrl+Shift+C)
> 				19269 단추 (disabled) Remove comment (Ctrl+Shift+X)
> 				19270 단추 (disabled) Unindent (Shift+Tab)
> 				19271 단추 (disabled) Indent (Tab)
> 			24 도구 모음 Macros Manager
> 				19272 메뉴 항목 Macros
> 			26 도구 모음 Layout Manager
> 				19273 메뉴 항목 Layouts
> 			28 도구 모음 Toolbox
> 				19274 단추 DataAnalyzer
> 				19275 메뉴 항목 Toolbar Options
> 			31 도구 모음 Net Edit
> 				19276 단추 (disabled) Select
> 				19277 메뉴 항목 Toolbar Options
> 			34 도구 모음 Debug
> 				19278 단추 Go online (Alt+F6)
> 				19279 메뉴 항목 Toolbar Options
> 			37 도구 모음 Build
> 				19280 메뉴 항목 Target Architecture
> 				19281 메뉴 항목 Toolbar Options
> 			40 도구 모음 Standard
> 				19282 단추 New project (Strg+N)
> 				19283 단추 Open a file (Strg+Shift+O)
> 				19284 단추 Close active document (Strg+F4)
> 				19285 단추 Save file (Strg+S)
> 				19286 단추 Open project (Strg+O)
> 				19287 단추 Save project changes (Strg+Shift+S)
> 				19288 단추 Close project
> 				19289 단추 Print
> 				19290 단추 Cut (Strg+X)
> 				19291 단추 Copy (Strg+C)
> 				19292 단추 Paste (Strg+V)
> 				19293 메뉴 항목 Undo (Strg+Z)
> 				19294 메뉴 항목 (disabled) Redo (Strg+Y)
> 				19295 메뉴 항목 Toolbar Options
> 			55 메뉴 모음 Menu Bar
> 				19296 메뉴 항목 FILE
> 				19297 메뉴 항목 EDIT
> 				19298 메뉴 항목 VIEW
...
> 			19307 탭 항목 (selectable) Python Script
> 			19308 탭 항목 (selectable) Debugger
> 			19309 탭 항목 (selectable) Output
> 			80 단추 Close
...
> 			19331 탭 항목 (selectable) Lib
> 			19332 탭 항목 (selectable) File
> 			19333 탭 항목 (selectable) Class
> 			87 단추 Close
...
> 					19334 custom Name
> 					19335 custom Revision
> 					19336 custom GUID
> 					19337 custom Task Settings
> 					19338 custom Sigmatek
> 					19339 custom OSInterface
> 					19340 custom IconPath
> 					19341 custom SharedCommandTable
> 					19342 custom Objectsize
> 					19343 custom Singleton
> 					19344 custom Hidden
> 					19345 custom Deprecated
> 					19346 custom GCCOptions
> 					19347 custom Comment
> 					19348 custom Filename
> 				91 도구 모음 ID: 59392
> 					92 단추
> 					93 단추
> 			19349 탭 항목 (selectable) Properties
> 			95 단추 Close
>
...
> ```json
> {
>   "title": "Diagnostics 메서드 선택 준비",
>   "code": "var obsDiagMethodScroll=globalThis.state; globalThis.state=null; try{await sky.scroll({window:obsDiagMethodScroll.window,x:850,y:240,scrollX:0,scrollY:650}); globalThis.state=await sky.get_window_state({window:obsDiagMethodScroll.window,include_screenshot:true,include_text:true});}catch(error){throw new Error('Private method scroll outcome unknown: '+String(error));} globalThis.targetWindow=state.window; nodeRepl.write(String(state.accessibility?.tree||''));",
>   "timeout_ms": 30000
> }
> ```
>
