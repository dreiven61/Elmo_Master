...
>       '\t\t\t25518 탭 항목 (selectable) Lib\n' +
>       '\t\t\t25519 탭 항목 (selectable) File\n' +
>       '\t\t\t25520 탭 항목 (selectable) Class\n' +
>       '\t\t\t102 단추 Close\n' +
...
>       '\t\t\t\t\t25521 custom Name\n' +
>       '\t\t\t\t\t25522 custom Revision\n' +
>       '\t\t\t\t\t25523 custom GUID\n' +
>       '\t\t\t\t\t25524 custom Task Settings\n' +
>       '\t\t\t\t\t25525 custom Sigmatek\n' +
>       '\t\t\t\t\t25526 custom OSInterface\n' +
>       '\t\t\t\t\t25527 custom IconPath\n' +
>       '\t\t\t\t\t25528 custom SharedCommandTable\n' +
>       '\t\t\t\t\t25529 custom Objectsize\n' +
>       '\t\t\t\t\t25530 custom Singleton\n' +
>       '\t\t\t\t\t25531 custom Hidden\n' +
>       '\t\t\t\t\t'... 4051 more characters,
...
> ```json
> {
>   "code": "await sky.click({window: targetWindow, x: 1198, y: 318, screenshotId: 'screenshot-1'}); state = await sky.get_window_state({window: targetWindow, include_text: true, include_screenshot: true}); nodeRepl.write(state);",
>   "title": "Methods 트리 펼치기"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[BASE64_OMITTED source_line=3837 chars=9977 sha256=78a0a86962f4f03eb4d8abf96da423da5a5ba21e020185db411cc7d2c9c3765d]'... 298995 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[BASE64_OMITTED source_line=3846 chars=9977 sha256=75cd9ec269e88b5b7459eef83796c8512720c57840f4fac779c9b5c1fa9d3c0c]'... 277647 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
>       '\t\t\t13 도구 모음 Edit\n' +
>       '\t\t\t\t26111 단추 Toggle bookmark\n' +
>       '\t\t\t\t26112 단추 (disabled) Previous bookmark\n' +
>       '\t\t\t\t26113 단추 (disabled) Next bookmark\n' +
>       '\t\t\t\t26114 단추 (disabled) Delete all bookmarks\n' +
>       '\t\t\t\t26115 단추 (disabled) Previous bookmark in this file\n' +
>       '\t\t\t\t26116 단추 (disabled) Next bookmark in this file\n' +
>       '\t\t\t\t26117 단추 (disabled) Comment selected text (Ctrl+Shift+C)\n' +
>       '\t\t\t\t26118 단추 (disabled) Remove comment (Ctrl+Shift+X)\n' +
>       '\t\t\t\t26119 단추 (disabled) Unindent (Shift+Tab)\n' +
>       '\t\t\t\t26120 단추 (disabled) Indent (Tab)\n' +
>       '\t\t\t24 도구 모음 Macros Manager\n' +
>       '\t\t\t\t26121 메뉴 항목 Macros\n' +
>       '\t\t\t26 도구 모음 Layout Manager\n' +
>       '\t\t\t\t26122 메뉴 항목 Layouts\n' +
>       '\t\t\t28 도구 모음 Toolbox\n' +
>       '\t\t\t\t26123 단추 DataAnalyzer\n' +
>       '\t\t\t\t26124 메뉴 항목 Toolbar Options\n' +
>       '\t\t\t31 도구 모음 Net Edit\n' +
>       '\t\t\t\t26125 단추 (disabled) Select\n' +
>       '\t\t\t\t26126 메뉴 항목 Toolbar Options\n' +
>       '\t\t\t34 도구 모음 Debug\n' +
>       '\t\t\t\t26127 단추 Go online (Alt+F6)\n' +
>       '\t\t\t\t26128 단추 Change Online Settings\n' +
>       '\t\t\t\t26129 메뉴 항목 Online Connection\n' +
>       '\t\t\t\t26130 단추 (disabled) Set Online Connection For Current Project\n' +
>       '\t\t\t\t26131 단추 (disabled) Download (F6)\n' +
>       '\t\t\t\t26132 단추 Build Changes, Online, Download and Run (CTRL+ALT+F6)\n' +
>       '\t\t\t\t26133 단추 (disabled) Download Module on the Fly\n' +
>       '\t\t\t\t26134 단추 (disabled) Save Project on PLC\n' +
>       '\t\t\t\t26135 단추 (disabled) Start (F7)\n' +
>       '\t\t\t\t26136 단추 (disabled) Reset (F8)\n' +
>       '\t\t\t\t26137 단추 Toggle breakpoint (F4)\n' +
>       '\t\t\t\t26138 단추 Create condition breakpoint\n' +
>       '\t\t\t\t26139 메뉴 항목 Toolbar Options\n' +
>       '\t\t\t48 도구 모음 Build\n' +
>       '\t\t\t\t26140 메뉴 항목 Target Architecture\n' +
>       '\t\t\t\t26141 단추 Build changes (F9)\n' +
>       '\t\t\t\t26142 단추 Rebuild project (Strg+F9)\n' +
>       '\t\t\t\t26143 단추 (disabled) Cancel building (Ctrl+Break)\n' +
>       '\t\t\t\t26144 단추 Link project\n' +
>       '\t\t\t54 도구 모음 Standard\n' +
>       '\t\t\t\t26145 단추 New project (Strg+N)\n' +
>       '\t\t\t\t26146 단추 Open a file (Strg+Shift+O)\n' +
>       '\t\t\t\t26147 단추 Close active document (Strg+F4)\n' +
>       '\t\t\t\t26148 단추 (disabled) Save file (Strg+S)\n' +
>       '\t\t\t\t26149 단추 Open project (Strg+O)\n' +
>       '\t\t\t\t26150 단추 (disabled) Save project changes (Strg+Shift+S)\n' +
>       '\t\t\t\t26151 단추 Close project\n' +
>       '\t\t\t\t26152 단추 Print\n' +
>       '\t\t\t\t26153 단추 Cut (Strg+X)\n' +
>       '\t\t\t\t26154 단추 Copy (Strg+C)\n' +
>       '\t\t\t\t26155 단추 Paste (Strg+V)\n' +
>       '\t\t\t\t26156 메뉴 항목 (disabled) Undo (Strg+Z)\n' +
>       '\t\t\t\t26157 메뉴 항목 (disabled) Redo (Strg+Y)\n' +
>       '\t\t\t\t26158 단추 (disabled) Navigate Backward (Alt+Left)\n' +
>       '\t\t\t\t26159 단추 (disabled) Navigate Forward (Alt +Right)\n' +
>       '\t\t\t70 메뉴 모음 Menu Bar\n' +
>       '\t\t\t\t26160 메뉴 항목 FILE\n' +
>       '\t\t\t\t26161 메뉴 항목 EDIT\n' +
>       '\t\t\t\t26162 메뉴 항목 VIEW\n' +
...
>       '\t\t\t26171 탭 항목 (selectable) Python Script\n' +
>       '\t\t\t26172 탭 항목 (selectable) Debugger\n' +
>       '\t\t\t26173 탭 항목 (selectable) Output\n' +
>       '\t\t\t95 단추 Close\n' +
