...
> 			9602 탭 항목 (selectable) Lib
> 			9603 탭 항목 (selectable) File
> 			9604 탭 항목 (selectable) Global
> 			9605 탭 항목 (selectable) Net
> 			9606 탭 항목 (selectable) Class
> 			106 단추 Close
...
> 					111 단추
> 					112 단추
> 			9607 탭 항목 (selectable) Properties
> 			114 단추 Close
>
...
> ```json
> {
>   "code": "{const observation=globalThis.state;const sid=observation?.screenshots?.[0]?.id;if(!sid)throw new Error('no screenshot');globalThis.state=null;await sky.click({window:observation.window,screenshotId:sid,x:1120,y:276});globalThis.state=await sky.get_window_state({window:observation.window,include_screenshot:true,include_text:true});globalThis.targetWindow=state.window;nodeRepl.write(String(state.accessibility?.tree||state.accessibility?.document_text||''))}",
>   "title": "새 ownership 변수 추가"
> }
> ```
>
> ```text
...
> 		9609 창
> 		9610 메뉴
> 			10122 메뉴 항목 New Variable
> 			10123 메뉴 항목 Sort Variables
> 			10124 메뉴 항목 Paste
> 			10125 메뉴 항목 Copy
> 		1 창 작업 영역 ID: 59648
...
> 			13 도구 모음 Script
> 			14 도구 모음 Edit
> 				10126 단추 Toggle bookmark
> 				10127 단추 (disabled) Previous bookmark
> 				10128 단추 (disabled) Next bookmark
> 				10129 단추 (disabled) Delete all bookmarks
> 				10130 단추 (disabled) Previous bookmark in this file
> 				10131 단추 (disabled) Next bookmark in this file
> 				10132 단추 (disabled) Comment selected text (Ctrl+Shift+C)
> 				10133 단추 (disabled) Remove comment (Ctrl+Shift+X)
> 				10134 단추 (disabled) Unindent (Shift+Tab)
> 				10135 단추 (disabled) Indent (Tab)
> 			25 도구 모음 Macros Manager
> 				10136 메뉴 항목 Macros
> 			27 도구 모음 Layout Manager
> 				10137 메뉴 항목 Layouts
> 			29 도구 모음 Toolbox
> 				10138 단추 DataAnalyzer
> 				10139 메뉴 항목 Toolbar Options
> 			32 도구 모음 Net Edit
> 				10140 단추 (disabled) Select
> 				10141 메뉴 항목 Toolbar Options
> 			35 도구 모음 Debug
> 				10142 단추 Go online (Alt+F6)
> 				10143 단추 Change Online Settings
> 				10144 메뉴 항목 Online Connection
> 				10145 단추 (disabled) Set Online Connection For Current Project
> 				10146 단추 (disabled) Download (F6)
> 				10147 단추 Build Changes, Online, Download and Run (CTRL+ALT+F6)
> 				10148 단추 (disabled) Download Module on the Fly
> 				10149 단추 (disabled) Save Project on PLC
> 				10150 단추 (disabled) Start (F7)
> 				10151 단추 (disabled) Reset (F8)
> 				10152 단추 Toggle breakpoint (F4)
> 				10153 단추 Create condition breakpoint
> 				10154 메뉴 항목 Toolbar Options
> 			49 도구 모음 Build
> 				10155 메뉴 항목 Target Architecture
> 				10156 단추 Build changes (F9)
> 				10157 단추 Rebuild project (Strg+F9)
> 				10158 단추 (disabled) Cancel building (Ctrl+Break)
> 				10159 단추 Link project
> 			55 도구 모음 Standard
> 				10160 단추 New project (Strg+N)
> 				10161 단추 Open a file (Strg+Shift+O)
> 				10162 단추 Close active document (Strg+F4)
> 				10163 단추 (disabled) Save file (Strg+S)
> 				10164 단추 Open project (Strg+O)
> 				10165 단추 (disabled) Save project changes (Strg+Shift+S)
> 				10166 단추 Close project
> 				10167 단추 Print
> 				10168 단추 Cut (Strg+X)
> 				10169 단추 Copy (Strg+C)
> 				10170 단추 Paste (Strg+V)
> 				10171 메뉴 항목 (disabled) Undo (Strg+Z)
> 				10172 메뉴 항목 (disabled) Redo (Strg+Y)
> 				10173 단추 Navigate Backward (Alt+Left)
> 				10174 단추 (disabled) Navigate Forward (Alt +Right)
> 			71 메뉴 모음 Menu Bar
> 				10175 메뉴 항목 FILE
> 				10176 메뉴 항목 EDIT
> 				10177 메뉴 항목 VIEW
...
> 			10186 탭 항목 (selectable) Python Script
> 			10187 탭 항목 (selectable) Debugger
> 			10188 탭 항목 (selectable) Output
> 			97 단추 Close
