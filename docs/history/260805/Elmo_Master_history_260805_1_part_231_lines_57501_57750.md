> 				12647 단추 (disabled) Delete all bookmarks
> 				12648 단추 (disabled) Previous bookmark in this file
> 				12649 단추 (disabled) Next bookmark in this file
> 				12650 단추 (disabled) Comment selected text (Ctrl+Shift+C)
> 				12651 단추 (disabled) Remove comment (Ctrl+Shift+X)
> 				12652 단추 (disabled) Unindent (Shift+Tab)
> 				12653 단추 (disabled) Indent (Tab)
> 			25 도구 모음 Macros Manager
> 				12654 메뉴 항목 Macros
> 			27 도구 모음 Layout Manager
> 				12655 메뉴 항목 Layouts
> 			29 도구 모음 Toolbox
> 				12656 단추 DataAnalyzer
> 				12657 메뉴 항목 Toolbar Options
> 			32 도구 모음 Net Edit
> 				12658 단추 (disabled) Select
> 				12659 메뉴 항목 Toolbar Options
> 			35 도구 모음 Debug
> 				12660 단추 Go online (Alt+F6)
> 				12661 단추 Change Online Settings
> 				12662 메뉴 항목 Online Connection
> 				12663 단추 (disabled) Set Online Connection For Current Project
> 				12664 단추 (disabled) Download (F6)
> 				12665 단추 Build Changes, Online, Download and Run (CTRL+ALT+F6)
> 				12666 단추 (disabled) Download Module on the Fly
> 				12667 단추 (disabled) Save Project on PLC
> 				12668 단추 (disabled) Start (F7)
> 				12669 단추 (disabled) Reset (F8)
> 				12670 단추 Toggle breakpoint (F4)
> 				12671 단추 Create condition breakpoint
> 				12672 메뉴 항목 Toolbar Options
> 			49 도구 모음 Build
> 				12673 메뉴 항목 Target Architecture
> 				12674 단추 Build changes (F9)
> 				12675 단추 Rebuild project (Strg+F9)
> 				12676 단추 (disabled) Cancel building (Ctrl+Break)
> 				12677 단추 Link project
> 			55 도구 모음 Standard
> 				12678 단추 New project (Strg+N)
> 				12679 단추 Open a file (Strg+Shift+O)
> 				12680 단추 Close active document (Strg+F4)
> 				12681 단추 Save file (Strg+S)
> 				12682 단추 Open project (Strg+O)
> 				12683 단추 Save project changes (Strg+Shift+S)
> 				12684 단추 Close project
> 				12685 단추 Print
> 				12686 단추 Cut (Strg+X)
> 				12687 단추 Copy (Strg+C)
> 				12688 단추 Paste (Strg+V)
> 				12689 메뉴 항목 Undo (Strg+Z)
> 				12690 메뉴 항목 (disabled) Redo (Strg+Y)
> 				12691 단추 Navigate Backward (Alt+Left)
> 				12692 단추 (disabled) Navigate Forward (Alt +Right)
> 			71 메뉴 모음 Menu Bar
> 				12693 메뉴 항목 FILE
> 				12694 메뉴 항목 EDIT
> 				12695 메뉴 항목 VIEW
...
> 			12704 탭 항목 (selectable) Python Script
> 			12705 탭 항목 (selectable) Debugger
> 			12706 탭 항목 (selectable) Output
> 			97 단추 Close
...
> 							10881 콘솔 트리 (selectable) OwnershipLeaseState
> 								12707 콘솔 트리 (selectable) 0..1
...
> 			12708 탭 항목 (selectable) Lib
> 			12709 탭 항목 (selectable) File
> 			12710 탭 항목 (selectable) Global
> 			12711 탭 항목 (selectable) Net
> 			12712 탭 항목 (selectable) Class
> 			106 단추 Close
...
> 					12714 custom GUID
> 					12715 custom Type
> 					12716 custom Element Type
> 					12717 custom Pointer
> 					12718 custom Comment
> 				110 도구 모음 ID: 59392
> 					111 단추
> 					112 단추
> 			12719 탭 항목 (selectable) Properties
> 			114 단추 Close
>
...
> ```json
> {
>   "code": "{const observation=globalThis.state;if(!observation?.accessibility)throw new Error('reobserve');globalThis.state=null;await sky.click({window:observation.window,element_index:12707});globalThis.state=await sky.get_window_state({window:observation.window,include_screenshot:true,include_text:true});globalThis.targetWindow=state.window;nodeRepl.write(String(state.accessibility?.tree||state.accessibility?.document_text||''))}",
>   "title": "ownership lease 배열 범위 선택"
> }
> ```
>
> ```text
