...
>       '\t\t\t26176 탭 항목 (selectable) Lib\n' +
>       '\t\t\t26177 탭 항목 (selectable) File\n' +
>       '\t\t\t26178 탭 항목 (selectable) Class\n' +
>       '\t\t\t102 단추 Close\n' +
...
>       '\t\t\t\t\t26179 custom Name\n' +
>       '\t\t\t\t\t26180 custom Revision\n' +
>       '\t\t\t\t\t26181 custom GUID\n' +
>       '\t\t\t\t\t26182 custom Task Settings\n' +
>       '\t\t\t\t\t26183 custom Sigmatek\n' +
>       '\t\t\t\t\t26184 custom OSInterface\n' +
>       '\t\t\t\t\t26185 custom IconPath\n' +
>       '\t\t\t\t\t26186 c'... 361 more characters,
...
> ```json
> {
>   "code": "await sky.click({window: targetWindow, x: 1217, y: 359, screenshotId: 'screenshot-1'}); state = await sky.get_window_state({window: targetWindow, include_text: true, include_screenshot: true}); nodeRepl.write(state);",
>   "title": "Private 메서드 트리 펼치기"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[BASE64_OMITTED source_line=4063 chars=9977 sha256=78a0a86962f4f03eb4d8abf96da423da5a5ba21e020185db411cc7d2c9c3765d]'... 306639 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[BASE64_OMITTED source_line=4072 chars=9977 sha256=75cd9ec269e88b5b7459eef83796c8512720c57840f4fac779c9b5c1fa9d3c0c]'... 285655 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
>       '\t\t\t13 도구 모음 Edit\n' +
>       '\t\t\t\t26769 단추 Toggle bookmark\n' +
>       '\t\t\t\t26770 단추 (disabled) Previous bookmark\n' +
>       '\t\t\t\t26771 단추 (disabled) Next bookmark\n' +
>       '\t\t\t\t26772 단추 (disabled) Delete all bookmarks\n' +
>       '\t\t\t\t26773 단추 (disabled) Previous bookmark in this file\n' +
>       '\t\t\t\t26774 단추 (disabled) Next bookmark in this file\n' +
>       '\t\t\t\t26775 단추 (disabled) Comment selected text (Ctrl+Shift+C)\n' +
>       '\t\t\t\t26776 단추 (disabled) Remove comment (Ctrl+Shift+X)\n' +
>       '\t\t\t\t26777 단추 (disabled) Unindent (Shift+Tab)\n' +
>       '\t\t\t\t26778 단추 (disabled) Indent (Tab)\n' +
>       '\t\t\t24 도구 모음 Macros Manager\n' +
>       '\t\t\t\t26779 메뉴 항목 Macros\n' +
>       '\t\t\t26 도구 모음 Layout Manager\n' +
>       '\t\t\t\t26780 메뉴 항목 Layouts\n' +
>       '\t\t\t28 도구 모음 Toolbox\n' +
>       '\t\t\t\t26781 단추 DataAnalyzer\n' +
>       '\t\t\t\t26782 메뉴 항목 Toolbar Options\n' +
>       '\t\t\t31 도구 모음 Net Edit\n' +
>       '\t\t\t\t26783 단추 (disabled) Select\n' +
>       '\t\t\t\t26784 메뉴 항목 Toolbar Options\n' +
>       '\t\t\t34 도구 모음 Debug\n' +
>       '\t\t\t\t26785 단추 Go online (Alt+F6)\n' +
>       '\t\t\t\t26786 단추 Change Online Settings\n' +
>       '\t\t\t\t26787 메뉴 항목 Online Connection\n' +
>       '\t\t\t\t26788 단추 (disabled) Set Online Connection For Current Project\n' +
>       '\t\t\t\t26789 단추 (disabled) Download (F6)\n' +
>       '\t\t\t\t26790 단추 Build Changes, Online, Download and Run (CTRL+ALT+F6)\n' +
>       '\t\t\t\t26791 단추 (disabled) Download Module on the Fly\n' +
>       '\t\t\t\t26792 단추 (disabled) Save Project on PLC\n' +
>       '\t\t\t\t26793 단추 (disabled) Start (F7)\n' +
>       '\t\t\t\t26794 단추 (disabled) Reset (F8)\n' +
>       '\t\t\t\t26795 단추 Toggle breakpoint (F4)\n' +
>       '\t\t\t\t26796 단추 Create condition breakpoint\n' +
>       '\t\t\t\t26797 메뉴 항목 Toolbar Options\n' +
>       '\t\t\t48 도구 모음 Build\n' +
>       '\t\t\t\t26798 메뉴 항목 Target Architecture\n' +
>       '\t\t\t\t26799 단추 Build changes (F9)\n' +
>       '\t\t\t\t26800 단추 Rebuild project (Strg+F9)\n' +
>       '\t\t\t\t26801 단추 (disabled) Cancel building (Ctrl+Break)\n' +
>       '\t\t\t\t26802 단추 Link project\n' +
>       '\t\t\t54 도구 모음 Standard\n' +
>       '\t\t\t\t26803 단추 New project (Strg+N)\n' +
>       '\t\t\t\t26804 단추 Open a file (Strg+Shift+O)\n' +
>       '\t\t\t\t26805 단추 Close active document (Strg+F4)\n' +
>       '\t\t\t\t26806 단추 (disabled) Save file (Strg+S)\n' +
>       '\t\t\t\t26807 단추 Open project (Strg+O)\n' +
>       '\t\t\t\t26808 단추 (disabled) Save project changes (Strg+Shift+S)\n' +
>       '\t\t\t\t26809 단추 Close project\n' +
>       '\t\t\t\t26810 단추 Print\n' +
>       '\t\t\t\t26811 단추 Cut (Strg+X)\n' +
>       '\t\t\t\t26812 단추 Copy (Strg+C)\n' +
>       '\t\t\t\t26813 단추 Paste (Strg+V)\n' +
>       '\t\t\t\t26814 메뉴 항목 (disabled) Undo (Strg+Z)\n' +
>       '\t\t\t\t26815 메뉴 항목 (disabled) Redo (Strg+Y)\n' +
>       '\t\t\t\t26816 단추 (disabled) Navigate Backward (Alt+Left)\n' +
>       '\t\t\t\t26817 단추 (disabled) Navigate Forward (Alt +Right)\n' +
>       '\t\t\t70 메뉴 모음 Menu Bar\n' +
>       '\t\t\t\t26818 메뉴 항목 FILE\n' +
>       '\t\t\t\t26819 메뉴 항목 EDIT\n' +
>       '\t\t\t\t26820 메뉴 항목 VIEW\n' +
...
>       '\t\t\t26829 탭 항목 (selectable) Python Script\n' +
>       '\t\t\t26830 탭 항목 (selectable) Debugger\n' +
>       '\t\t\t26831 탭 항목 (selectable) Output\n' +
>       '\t\t\t95 단추 Close\n' +
...
>       '\t\t\t\t\t5963 콘솔 트리 (selectable) TCPIPServer\n' +
>       '\t\t\t\t\t5964 콘솔 트리 (selectable) TCPMotionInterface\n' +
>       '\t\t\t26832 탭 항목 (selectable) Lib\n' +
>       '\t\t\t26833 탭 항목 (selectable) File\n' +
>       '\t\t\t26834 탭 항목 (selectable) Class\n' +
>       '\t\t\t102 단추 Close\n' +
>       '\t\t103 Tab Properties ID: 306057816\n' +
>       '\t\t\t104 창 ID: 297102840\n' +
>       '\t\t\t\t105 TABLE Properties Window ID: 301242408\n' +
