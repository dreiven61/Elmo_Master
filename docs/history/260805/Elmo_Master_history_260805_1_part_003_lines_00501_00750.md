...
> ```json
> {
>   "code": "globalThis.apps = await sky.list_apps(); nodeRepl.write(JSON.stringify(apps.map(a => ({id:a.id, displayName:a.displayName, isRunning:a.isRunning, windows:a.windows})), null, 2));",
