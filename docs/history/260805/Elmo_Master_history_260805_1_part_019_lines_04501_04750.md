...
> ```json
> {
>   "code": "nodeRepl.write(state.accessibility.tree.split('\\n').filter(x => /Edit Method|Delete Method|Move Up|Move Down|Copy|New Input/.test(x)).join('\\n'));",
>   "title": "메서드 메뉴 항목 확인"
> }
> ```
>
...
> ```json
> {
>   "code": "await sky.click({window: targetWindow, x: 1380, y: 423}); state = await sky.get_window_state({window: targetWindow, include_text: true, include_screenshot: true}); nodeRepl.write(state);",
>   "title": "Outcome 메서드 복사"
> }
> ```
>
> ```text
...
>       id: 'screenshot-0',
>       zIndex: 0,
>       url: 'data:image/jpeg;base64,[BASE64_OMITTED source_line=4579 chars=9977 sha256=78a0a86962f4f03eb4d8abf96da423da5a5ba21e020185db411cc7d2c9c3765d]'... 301067 more characters,
>       originX: -1880,
>       originY: 41,
>       width: 1450,
>       height: 763
...
>       id: 'screenshot-1',
>       zIndex: 1,
>       url: 'data:image/jpeg;base64,[BASE64_OMITTED source_line=4588 chars=9977 sha256=75cd9ec269e88b5b7459eef83796c8512720c57840f4fac779c9b5c1fa9d3c0c]'... 279787 more characters,
>       originX: -1875,
>       originY: 46,
>       width: 1440,
>       height: 753
...
>       '\t\t27924 창\n' +
>       '\t\t27925 메뉴\n' +
>       '\t\t\t29060 메뉴 항목 Edit Method Enter\n' +
>       '\t\t\t29061 메뉴 항목 Delete Method Del\n' +
>       '\t\t\t29062 메뉴 항목 Move Up\n' +
>       '\t\t\t29063 메뉴 항목 Move Down\n' +
>       '\t\t\t29064 메뉴 항목 Copy\n' +
>       '\t\t\t29065 메뉴 항목 New Input Variable\n' +
>       '\t\t\t29066 메뉴 항목 (disabled) New Output Variable\n' +
>       '\t\t\t29067 메뉴 항목 Add to Newinst\n' +
>       '\t\t1 창 작업 영역 ID: 59648\n' +
...
>       '\t\t\t13 도구 모음 Edit\n' +
>       '\t\t\t\t29068 단추 Toggle bookmark\n' +
>       '\t\t\t\t29069 단추 (disabled) Previous bookmark\n' +
>       '\t\t\t\t29070 단추 (disabled) Next bookmark\n' +
>       '\t\t\t\t29071 단추 (disabled) Delete all bookmarks\n' +
>       '\t\t\t\t29072 단추 (disabled) Previous bookmark in this file\n' +
>       '\t\t\t\t29073 단추 (disabled) Next bookmark in this file\n' +
>       '\t\t\t\t29074 단추 (disabled) Comment selected text (Ctrl+Shift+C)\n' +
>       '\t\t\t\t29075 단추 (disabled) Remove comment (Ctrl+Shift+X)\n' +
>       '\t\t\t\t29076 단추 (disabled) Unindent (Shift+Tab)\n' +
>       '\t\t\t\t29077 단추 (disabled) Indent (Tab)\n' +
>       '\t\t\t24 도구 모음 Macros Manager\n' +
>       '\t\t\t\t29078 메뉴 항목 Macros\n' +
>       '\t\t\t26 도구 모음 Layout Manager\n' +
>       '\t\t\t\t29079 메뉴 항목 Layouts\n' +
>       '\t\t\t28 도구 모음 Toolbox\n' +
>       '\t\t\t\t29080 단추 DataAnalyzer\n' +
>       '\t\t\t\t29081 메뉴 항목 Toolbar Options\n' +
>       '\t\t\t31 도구 모음 Net Edit\n' +
>       '\t\t\t\t29082 단추 (disabled) Select\n' +
>       '\t\t\t\t29083 메뉴 항목 Toolbar Options\n' +
>       '\t\t\t34 도구 모음 Debug\n' +
>       '\t\t\t\t29084 단추 Go online (Alt+F6)\n' +
>       '\t\t\t\t29085 단추 Change Online Settings\n' +
>       '\t\t\t\t29086 메뉴 항목 Online Connection\n' +
>       '\t\t\t\t29087 단추 (disabled) Set Online Connection For Current Project\n' +
>       '\t\t\t\t29088 단추 (disabled) Download (F6)\n' +
>       '\t\t\t\t29089 단추 Build Changes, Online, Download and Run (CTRL+ALT+F6)\n' +
>       '\t\t\t\t29090 단추 (disabled) Download Module on the Fly\n' +
>       '\t\t\t\t29091 단추 (disabled) Save Project on PLC\n' +
>       '\t\t\t\t29092 단추 (disabled) Start (F7)\n' +
>       '\t\t\t\t29093 단추 (disabled) Reset (F8)\n' +
>       '\t\t\t\t29094 단추 Toggle breakpoint (F4)\n' +
>       '\t\t\t\t29095 단추 Create condition breakpoint\n' +
>       '\t\t\t\t29096 메뉴 항목 Toolbar Options\n' +
>       '\t\t\t48 도구 모음 Build\n' +
>       '\t\t\t\t29097 메뉴 항목 Target Architecture\n' +
>       '\t\t\t\t29098 단추 Build changes (F9)\n' +
>       '\t\t\t\t29099 단추 Rebuild project (Strg+F9)\n' +
>       '\t\t\t\t29100 단추 (disabled) Cancel building (Ctrl+Break)\n' +
>       '\t\t\t\t29101 단추 Link project\n' +
>       '\t\t\t54 도구 모음 Standard\n' +
>       '\t\t\t\t29102 단추 New project (Strg+N)\n' +
>       '\t\t\t\t29103 단추 Open a file (Strg+Shift+O)\n' +
>       '\t\t\t\t29104 단추 Close active document (Strg+F4)\n' +
>       '\t\t\t\t29105 단추 (disabled) Save file (Strg+S)\n' +
>       '\t\t\t\t29106 단추 Open project (Strg+O)\n' +
>       '\t\t\t\t29107 단추 (disabled) Save project changes (Strg+Shift+S)\n' +
>       '\t\t\t\t29108 단추 Close project\n' +
>       '\t\t\t\t29109 단추 Print\n' +
>       '\t\t\t\t29110 단추 Cut (Strg+X)\n' +
>       '\t\t\t\t29111 단추 Copy (Strg+C)\n' +
>       '\t\t\t\t29112 단추 Paste (Strg+V)\n' +
>       '\t\t\t\t29113 메뉴 항목 (disabled) Undo (Strg+Z)\n' +
>       '\t\t\t\t29114 메뉴 항목 (disabled) Redo (Strg+Y)\n' +
>       '\t\t\t\t29115 단추 (disabled) Navigate Backward (Alt+Left)\n' +
>       '\t\t\t\t29116 단추 (disabled) Navigate Forward (Alt +Right)\n' +
>       '\t\t\t70 메뉴 모음 Menu Bar\n' +
>       '\t\t\t\t29117 메뉴 항목 FILE\n' +
>       '\t\t\t\t29118 메뉴 항목 EDIT\n' +
>       '\t\t\t\t29119 메뉴 항목 VIEW\n' +
...
>       '\t\t\t29128 탭 항목 (selectable) Python Script\n' +
>       '\t\t\t29129 탭 항목 (selectable) Debugger\n' +
>       '\t\t\t29130 탭 항목 (selectable) Output\n' +
>       '\t\t\t95 단추 Close\n' +
