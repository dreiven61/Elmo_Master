...
> 			14408 탭 항목 (selectable) Python Script
> 			14409 탭 항목 (selectable) Debugger
> 			14410 탭 항목 (selectable) Output
> 			80 단추 Close
...
> 			14411 탭 항목 (selectable) Lib
> 			14412 탭 항목 (selectable) File
> 			14413 탭 항목 (selectable) Class
> 			14414 탭 항목 (selectable) Global
> 			88 단추 Close
...
> 					93 단추
> 					94 단추
> 			14415 탭 항목 (selectable) Properties
> 			96 단추 Close
>
...
> ```json
> {
>   "title": "Wait for LASAL marker search",
>   "code": "await new Promise(r=>setTimeout(r,6000)); state=await sky.get_window_state({window:targetWindow,include_screenshot:true,include_text:true}); targetWindow=state.window; nodeRepl.write(String(state.accessibility?.tree||''));",
>   "timeout_ms": 20000
> }
> ```
>
...
> 			13 도구 모음 Edit
> 				15173 단추 Toggle bookmark
> 				15174 단추 (disabled) Previous bookmark
> 				15175 단추 (disabled) Next bookmark
> 				15176 단추 (disabled) Delete all bookmarks
> 				15177 단추 (disabled) Previous bookmark in this file
> 				15178 단추 (disabled) Next bookmark in this file
> 				15179 단추 Comment selected text (Ctrl+Shift+C)
> 				15180 단추 Remove comment (Ctrl+Shift+X)
> 				15181 단추 Unindent (Shift+Tab)
> 				15182 단추 Indent (Tab)
...
> 				15184 메뉴 항목 Layouts
> 			28 도구 모음 Toolbox
> 				15185 단추 DataAnalyzer
> 				15186 메뉴 항목 Toolbar Options
> 			31 도구 모음 Net Edit
> 				15187 단추 (disabled) Select
> 				15188 메뉴 항목 Toolbar Options
> 			34 도구 모음 Debug
> 				15189 단추 Go online (Alt+F6)
> 				15190 메뉴 항목 Toolbar Options
> 			37 도구 모음 Build
> 				15191 메뉴 항목 Target Architecture
> 				15192 메뉴 항목 Toolbar Options
> 			40 도구 모음 Standard
> 				15193 단추 New project (Strg+N)
> 				15194 단추 Open a file (Strg+Shift+O)
> 				15195 단추 Close active document (Strg+F4)
> 				15196 단추 (disabled) Save file (Strg+S)
> 				15197 단추 Open project (Strg+O)
> 				15198 단추 (disabled) Save project changes (Strg+Shift+S)
> 				15199 단추 Close project
> 				15200 단추 Print
> 				15201 단추 Cut (Strg+X)
> 				15202 단추 Copy (Strg+C)
> 				15203 단추 (disabled) Paste (Strg+V)
> 				15204 메뉴 항목 (disabled) Undo (Strg+Z)
> 				15205 메뉴 항목 (disabled) Redo (Strg+Y)
> 				15206 메뉴 항목 Toolbar Options
> 			55 메뉴 모음 Menu Bar
> 				15207 메뉴 항목 FILE
> 				15208 메뉴 항목 EDIT
> 				15209 메뉴 항목 VIEW
