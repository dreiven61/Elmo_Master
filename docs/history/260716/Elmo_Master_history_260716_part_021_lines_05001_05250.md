...
> ```json
> {
>   "code": "var confirmationsDoc = await sky.documentation(\"confirmations\");\nnodeRepl.write(confirmationsDoc);",
>   "title": "LASAL IDE 작업 안전 확인",
>   "timeout_ms": 30000
> }
> ```
>
...
> ```json
> {
>   "code": "var apiDoc = await sky.documentation(\"api\");\nnodeRepl.write(apiDoc);",
>   "title": "LASAL IDE 제어 명령 확인",
>   "timeout_ms": 30000
> }
> ```
>
