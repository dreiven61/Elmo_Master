...
> 			15024 탭 항목 (selectable) Lib
> 			15025 탭 항목 (selectable) File
> 			15026 탭 항목 (selectable) Global
> 			15027 탭 항목 (selectable) Net
> 			15028 탭 항목 (selectable) Class
> 			104 단추 Close
> 		105 Tab Properties ID: 121363360
> 			106 창 ID: 288430568
> 				107 TABLE Properties Window ID: 118941016
> 					15029 스크롤 막대 세로 ID: NonClientVerticalScrollBar
> 						15030 단추 위쪽 스크롤 화살표 ID: UpButton
> 						15031 위치 조정 위치 ID: ScrollbarThumb
> 						15032 단추 페이지 아래로 ID: DownPageButton
> 						15033 단추 아래쪽 스크롤 화살표 ID: DownButton
> 					15034 custom Name
> 					15035 custom Revision
> 					15036 custom GUID
> 					15037 custom Task Settings
> 					15038 custom Sigmatek
> 					15039 custom OSInterface
> 					15040 custom IconPath
> 					15041 custom SharedCommandTable
> 					15042 custom Objectsize
> 					15043 custom Singleton
> 					15044 custom Hidden
> 					15045 custom Deprecated
> 					15046 custom GCCOptions
> 					15047 custom Comment
> 					15048 custom Filename
> 				108 도구 모음 ID: 59392
> 					109 단추
> 					110 단추
> 			15049 탭 항목 (selectable) Properties
> 			112 단추 Close
>
...
> ```json
> {
>   "code": "{\n  var observationChooseNewVar = globalThis.state;\n  var shotChooseNewVar = observationChooseNewVar.screenshots?.[0]?.id;\n  globalThis.state = null;\n  await sky.click({ window: observationChooseNewVar.window, screenshotId: shotChooseNewVar, x: 1360, y: 658 });\n  globalThis.state = await sky.get_window_state({ window: observationChooseNewVar.window, include_screenshot: true, include_text: true });\n  globalThis.targetWindow = state.window;\n  nodeRepl.write(String(state.accessibility?.focused_element || \"\"));\n}",
>   "timeout_ms": 30000,
>   "title": "Create kinematic state variable"
> }
> ```
>
> ```text
...
> ```json
> {
>   "code": "{\n  var observationCancelType = globalThis.state;\n  globalThis.state = null;\n  await sky.press_key({ window: observationCancelType.window, key: \"Escape\" });\n  globalThis.state = await sky.get_window_state({ window: observationCancelType.window, include_screenshot: true, include_text: true });\n  globalThis.targetWindow = state.window;\n  nodeRepl.write(String(state.accessibility?.tree || state.accessibility?.document_text || \"\"));\n}",
>   "timeout_ms": 30000,
>   "title": "Cancel accidental type creation"
> }
> ```
>
> ```text
...
> 			13 도구 모음 Edit
> 				16416 단추 Toggle bookmark
> 				16417 단추 (disabled) Previous bookmark
> 				16418 단추 (disabled) Next bookmark
> 				16419 단추 (disabled) Delete all bookmarks
> 				16420 단추 (disabled) Previous bookmark in this file
> 				16421 단추 (disabled) Next bookmark in this file
> 				16422 단추 (disabled) Comment selected text (Ctrl+Shift+C)
> 				16423 단추 (disabled) Remove comment (Ctrl+Shift+X)
> 				16424 단추 (disabled) Unindent (Shift+Tab)
> 				16425 단추 (disabled) Indent (Tab)
> 			24 도구 모음 Macros Manager
> 				16426 메뉴 항목 Macros
> 			26 도구 모음 Layout Manager
> 				16427 메뉴 항목 Layouts
> 			28 도구 모음 Toolbox
> 				16428 단추 DataAnalyzer
> 				16429 메뉴 항목 Toolbar Options
> 			31 도구 모음 Net Edit
> 				16430 단추 (disabled) Select
> 				16431 메뉴 항목 Toolbar Options
> 			34 도구 모음 Debug
> 				16432 단추 Go online (Alt+F6)
> 				16433 단추 Change Online Settings
> 				16434 메뉴 항목 Online Connection
> 				16435 단추 (disabled) Set Online Connection For Current Project
> 				16436 단추 (disabled) Download (F6)
> 				16437 단추 Build Changes, Online, Download and Run (CTRL+ALT+F6)
> 				16438 단추 (disabled) Download Module on the Fly
> 				16439 단추 (disabled) Save Project on PLC
> 				16440 단추 (disabled) Start (F7)
> 				16441 단추 (disabled) Reset (F8)
> 				16442 단추 Toggle breakpoint (F4)
> 				16443 단추 Create condition breakpoint
> 				16444 메뉴 항목 Toolbar Options
> 			48 도구 모음 Build
> 				16445 메뉴 항목 Target Architecture
> 				16446 단추 Build changes (F9)
> 				16447 단추 Rebuild project (Strg+F9)
> 				16448 단추 (disabled) Cancel building (Ctrl+Break)
> 				16449 단추 Link project
> 			54 도구 모음 Standard
> 				16450 단추 New project (Strg+N)
