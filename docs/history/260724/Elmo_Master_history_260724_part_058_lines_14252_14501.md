...
> ```json
> {
>   "code": "var groupScrollObservation2 = globalThis.state;\nglobalThis.state = null;\nawait sky.scroll({ window: groupScrollObservation2.window, x: 1600, y: 1050, scrollX: 0, scrollY: 1718 });\nglobalThis.state = await sky.get_window_state({ window: groupScrollObservation2.window, include_screenshot: true, include_text: false });\nglobalThis.targetWindow = state.window;\nnodeRepl.write(\"Captured lower Group Motion viewport.\");",
>   "title": "Group Qualification 하단 확인",
>   "timeout_ms": 30000
> }
> ```
>
> ```text
> Captured lower Group Motion viewport.
> ```
>
> Image output: image/jpeg
>
...
> ```json
> {
>   "code": "var groupScrollObservation3 = globalThis.state;\nglobalThis.state = null;\nawait sky.scroll({ window: groupScrollObservation3.window, x: 1600, y: 1080, scrollX: 0, scrollY: 2000 });\nglobalThis.state = await sky.get_window_state({ window: groupScrollObservation3.window, include_screenshot: true, include_text: false });\nglobalThis.targetWindow = state.window;\nnodeRepl.write(\"Captured qualification panel viewport.\");",
>   "title": "Qualification 패널 시각 확인",
>   "timeout_ms": 30000
> }
> ```
>
> ```text
> Captured qualification panel viewport.
> ```
>
> Image output: image/jpeg
>
...
> ```json
> {
>   "code": "var groupScrollObservation4 = globalThis.state;\nglobalThis.state = null;\nawait sky.scroll({ window: groupScrollObservation4.window, x: 700, y: 1050, scrollX: 0, scrollY: 2200 });\nglobalThis.state = await sky.get_window_state({ window: groupScrollObservation4.window, include_screenshot: true, include_text: false });\nglobalThis.targetWindow = state.window;\nnodeRepl.write(\"Captured Group qualification lower viewport.\");",
>   "title": "Qualification 패널 하단 확인",
>   "timeout_ms": 30000
> }
> ```
>
> ```text
> Captured Group qualification lower viewport.
> ```
>
> Image output: image/jpeg
>
