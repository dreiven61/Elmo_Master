...
> ```json
> {
>   "code": "await sky.click({window:lasalWindow,x:185,y:145}); nodeRepl.write(\"opened source tab\");",
>   "title": "LASAL 구현 탭 열기"
> }
> ```
>
...
> 						58 위치 조정 (disabled)
> 			59 창 Comm_Network Secondary Actions: Raise ID: 65286
> 				60 창 ID: 59648
...
> 					66 스크롤 막대 가로 ID: NonClientHorizontalScrollBar
> 						67 단추 왼쪽 스크롤 화살표 ID: UpButton
> 						68 위치 조정 위치 ID: ScrollbarThumb
> 						69 단추 페이지 오른쪽으로 ID: DownPageButton
> 						70 단추 오른쪽 스크롤 화살표 ID: DownButton
> 					71 위치 조정 (disabled)
> 			72 창 TCPMotionInterface Secondary Actions: Raise ID: 65287
> 				73 창 ID: 59648
...
> 						75 스크롤 막대 세로 ID: NonClientVerticalScrollBar
> 							76 단추 위쪽 스크롤 화살표 ID: UpButton
> 							77 위치 조정 위치 ID: ScrollbarThumb
> 							78 단추 페이지 아래로 ID: DownPageButton
> 							79 단추 아래쪽 스크롤 화살표 ID: DownButton
> 						80 스크롤 막대 가로 ID: NonClientHorizontalScrollBar
> 							81 단추 왼쪽 스크롤 화살표 ID: UpButton
> 							82 위치 조정 위치 ID: ScrollbarThumb
> 							83 단추 페이지 오른쪽으로 ID: DownPageButton
> 							84 단추 오른쪽 스크롤 화살표 ID: DownButton
> 						85 위치 조정 (disabled)
...
> 							92 단추 페이지 아래로 ID: DownPageButton
> 							93 단추 아래쪽 스크롤 화살표 ID: DownButton
> 						94 스크롤 막대 가로 ID: NonClientHorizontalScrollBar
> 							95 단추 왼쪽 스크롤 화살표 ID: UpButton
> 							96 위치 조정 위치 ID: ScrollbarThumb
> 							97 단추 페이지 오른쪽으로 ID: DownPageButton
> 							98 단추 오른쪽 스크롤 화살표 ID: DownButton
> 						99 위치 조정 (disabled)
> 			100 창 _TCPIPServer_RT Secondary Actions: Raise ID: 65289
> 				101 창 ID: 59648
...
> 						103 스크롤 막대 세로 ID: NonClientVerticalScrollBar
> 							104 단추 위쪽 스크롤 화살표 ID: UpButton
...
> 						113 위치 조정 (disabled)
> 			114 창 ECAT_DS402Base [RO] Secondary Actions: Raise ID: 65285
> 				115 창 ID: 59648
...
> 						128 위치 조정 (disabled)
> 			129 창 Elmo_2 Secondary Actions: Raise ID: 65284
> 				130 창 ID: 59648
...
> 				163 단추 Comment selected text (Ctrl+Shift+C)
> 				164 단추 Remove comment (Ctrl+Shift+X)
> 				165 단추 Unindent (Shift+Tab)
> 				166 단추 Indent (Tab)
...
> 			171 도구 모음 Toolbox
> 				172 단추 DataAnalyzer
> 				173 메뉴 항목 Toolbar Options
> 			174 도구 모음 Net Edit
> 				175 단추 (disabled) Select
> 				176 메뉴 항목 Toolbar Options
> 			177 도구 모음 Debug
> 				178 단추 Go online (Alt+F6)
> 				179 단추 Change Online Settings
> 				180 메뉴 항목 Online Connection
> 				181 단추 (disabled) Set Online Connection For Current Project
> 				182 단추 (disabled) Download (F6)
> 				183 단추 Build Changes, Online, Download and Run (CTRL+ALT+F6)
> 				184 단추 (disabled) Download Module on the Fly
> 				185 단추 (disabled) Save Project on PLC
> 				186 단추 (disabled) Start (F7)
> 				187 단추 (disabled) Reset (F8)
> 				188 단추 Toggle breakpoint (F4)
> 				189 단추 Create condition breakpoint
> 				190 메뉴 항목 Toolbar Options
> 			191 도구 모음 Build
> 				192 메뉴 항목 Target Architecture
> 				193 단추 Build changes (F9)
> 				194 단추 Rebuild project (Strg+F9)
> 				195 단추 (disabled) Cancel building (Ctrl+Break)
> 				196 단추 Link project
> 			197 도구 모음 Standard
> 				198 단추 New project (Strg+N)
> 				199 단추 Open a file (Strg+Shift+O)
> 				200 단추 Close active document (Strg+F4)
> 				201 단추 (disabled) Save file (Strg+S)
> 				202 단추 Open project (Strg+O)
> 				203 단추 (disabled) Save project changes (Strg+Shift+S)
> 				204 단추 Close project
> 				205 단추 Print
> 				206 단추 Cut (Strg+X)
> 				207 단추 Copy (Strg+C)
> 				208 단추 (disabled) Paste (Strg+V)
> 				209 메뉴 항목 (disabled) Undo (Strg+Z)
> 				210 메뉴 항목 (disabled) Redo (Strg+Y)
> 				211 단추 Navigate Backward (Alt+Left)
> 				212 단추 (disabled) Navigate Forward (Alt +Right)
> 			213 메뉴 모음 Menu Bar
> 				214 메뉴 항목 FILE
> 				215 메뉴 항목 EDIT
> 				216 메뉴 항목 VIEW
