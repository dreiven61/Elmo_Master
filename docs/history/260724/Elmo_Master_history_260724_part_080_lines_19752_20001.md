...
> 					227 custom Name
> 					228 custom Type
> 					229 custom ChannelInfo
> 					230 custom ChannelSize
> 					231 custom Use Read()-Method
> 					232 custom Unit
> 					233 custom Draw
> 					234 custom Color
> 					235 custom Active
> 					236 custom Upper Limit
> 					237 custom Lower Limit
> 					238 custom CalcFactor
> 					239 custom CalcOffset
> 					240 custom Y-Axis
> 					241 custom Comment
> 				242 도구 모음 ID: 59392
> 					243 단추
...
> ```json
> {
>   "title": "Open TCPMotionInterface class",
>   "code": "{\n  var obsTree = globalThis.state;\n  globalThis.state = null;\n  await sky.click({window:obsTree.window, element_index:217});\n  globalThis.state = await sky.get_window_state({window:obsTree.window, include_screenshot:true, include_text:true});\n  globalThis.targetWindow = state.window;\n  nodeRepl.write(String(state.accessibility?.tree || state.accessibility?.document_text || \"\"));\n}"
> }
> ```
>
> ```text
