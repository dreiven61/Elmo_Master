...
>   "code": "{\n  var obsCtx = globalThis.state;\n  globalThis.state = null;\n  await sky.click({window:obsCtx.window, element_index:217, mouse_button:\"right\"});\n  globalThis.state = await sky.get_window_state({window:obsCtx.window, include_screenshot:true, include_text:true});\n  globalThis.targetWindow = state.window;\n  nodeRepl.write(String(state.accessibility?.tree || state.accessibility?.document_text || \"\"));\n}"
> }
> ```
>
> ```text
...
> 		202 Tab Libraries ID: 295678480
> 			203 트리 ID: 106
> 				204 콘솔 트리 (selectable) Elmo_EtherCAT_Test_4Axis
> 					205 콘솔 트리 (selectable) Hardware
