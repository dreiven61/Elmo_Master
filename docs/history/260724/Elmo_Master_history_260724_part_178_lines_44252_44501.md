...
> ```json
> {
>   "code": "{\n  var observationClassTab3 = globalThis.state;\n  var shotClassTab3 = observationClassTab3.screenshots?.[0]?.id;\n  globalThis.state = null;\n  await sky.click({ window: observationClassTab3.window, screenshotId: shotClassTab3, x: 1410, y: 409 });\n  globalThis.state = await sky.get_window_state({ window: observationClassTab3.window, include_screenshot: true, include_text: true });\n  globalThis.targetWindow = state.window;\n  nodeRepl.write(String(state.accessibility?.tree || state.accessibility?.document_text || \"\"));\n}",
>   "timeout_ms": 30000,
>   "title": "Open class tree"
> }
> ```
>
> ```text
...
> 		2 상태 표시줄 ID: 59393
> 			3 텍스트
> 			4 텍스트 TCPMotionInterface::HandleAxisCommands
> 			5 텍스트
> 			6 텍스트 Ln 3209 Col 1
> 			7 텍스트
> 			8 텍스트 Offline
...
> 			13 도구 모음 Edit
> 				7116 단추 Toggle bookmark
> 				7117 단추 (disabled) Previous bookmark
> 				7118 단추 (disabled) Next bookmark
> 				7119 단추 (disabled) Delete all bookmarks
> 				7120 단추 (disabled) Previous bookmark in this file
> 				7121 단추 (disabled) Next bookmark in this file
> 				7122 단추 Comment selected text (Ctrl+Shift+C)
> 				7123 단추 Remove comment (Ctrl+Shift+X)
> 				7124 단추 Unindent (Shift+Tab)
> 				7125 단추 Indent (Tab)
...
> 				7127 메뉴 항목 Layouts
> 			28 도구 모음 Toolbox
> 				7128 단추 DataAnalyzer
> 				7129 메뉴 항목 Toolbar Options
> 			31 도구 모음 Net Edit
> 				7130 단추 (disabled) Select
> 				7131 메뉴 항목 Toolbar Options
> 			34 도구 모음 Debug
> 				7132 단추 Go online (Alt+F6)
> 				7133 단추 Change Online Settings
> 				7134 메뉴 항목 Online Connection
> 				7135 단추 (disabled) Set Online Connection For Current Project
> 				7136 단추 (disabled) Download (F6)
> 				7137 단추 Build Changes, Online, Download and Run (CTRL+ALT+F6)
> 				7138 단추 (disabled) Download Module on the Fly
> 				7139 단추 (disabled) Save Project on PLC
> 				7140 단추 (disabled) Start (F7)
> 				7141 단추 (disabled) Reset (F8)
> 				7142 단추 Toggle breakpoint (F4)
> 				7143 단추 Create condition breakpoint
> 				7144 메뉴 항목 Toolbar Options
> 			48 도구 모음 Build
> 				7145 메뉴 항목 Target Architecture
> 				7146 단추 Build changes (F9)
> 				7147 단추 Rebuild project (Strg+F9)
> 				7148 단추 (disabled) Cancel building (Ctrl+Break)
> 				7149 단추 Link project
> 			54 도구 모음 Standard
> 				7150 단추 New project (Strg+N)
> 				7151 단추 Open a file (Strg+Shift+O)
> 				7152 단추 Close active document (Strg+F4)
> 				7153 단추 (disabled) Save file (Strg+S)
> 				7154 단추 Open project (Strg+O)
> 				7155 단추 (disabled) Save project changes (Strg+Shift+S)
> 				7156 단추 Close project
> 				7157 단추 Print
> 				7158 단추 Cut (Strg+X)
> 				7159 단추 Copy (Strg+C)
> 				7160 단추 Paste (Strg+V)
> 				7161 메뉴 항목 (disabled) Undo (Strg+Z)
> 				7162 메뉴 항목 (disabled) Redo (Strg+Y)
> 				7163 단추 Navigate Backward (Alt+Left)
> 				7164 단추 (disabled) Navigate Forward (Alt +Right)
> 			70 메뉴 모음 Menu Bar
> 				7165 메뉴 항목 FILE
> 				7166 메뉴 항목 EDIT
> 				7167 메뉴 항목 VIEW
...
> 			7176 탭 항목 (selectable) Python Script
> 			7177 탭 항목 (selectable) Debugger
> 			7178 탭 항목 (selectable) Output
> 			95 단추 Close
> 		96 창 Splitter ID: 364851552
> 		97 Tab Network View ID: 121361080
> 			98 트리 ID: 104
> 				4939 콘솔 트리 (selectable) Elmo_EtherCAT_Test_4Axis
> 					4940 콘솔 트리 (selectable) Comm_Network
> 					4941 콘솔 트리 (selectable) EtherCAT_Network
> 					4942 콘솔 트리 (selectable) HW_Network
> 					4943 콘솔 트리 (selectable) Motion_Network
> 			7179 탭 항목 (selectable) Lib
> 			7180 탭 항목 (selectable) File
> 			7181 탭 항목 (selectable) Global
> 			7182 탭 항목 (selectable) Net
> 			7183 탭 항목 (selectable) Class
> 			104 단추 Close
...
> 					7189 custom Project Version
> 					7190 custom Name
> 					7191 custom Revision
> 					7192 custom Online Connection
> 					7193 custom CodeGenerator
> 					7194 custom Networks
> 					7195 custom Server list
> 					7196 custom Target
> 					7197 custom Compiler
> 					7198 custom Directory
> 					7199 custom OPC-UA
> 					7200 custom Load all libraries
> 					7201 custom Use Unit System
> 					7202 custom Include Paths
> 					7203 custom Library Paths
> 					7204 custom Backup Includes and Loader
> 					7205 custom Ignore at Cleanup
