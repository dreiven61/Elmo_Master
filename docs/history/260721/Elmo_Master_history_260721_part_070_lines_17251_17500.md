...
> 					305 단추
> 					306 단추
> 			307 탭 항목 (selectable) Properties
> 			308 단추 Close
>
...
> {
>   "title": "Drive1 설정 선택",
>   "code": "await sky.click({window:globalThis.targetWindow,element_index:288}); globalThis.state=null; nodeRepl.write('Drive1 selected');"
> }
> ```
>
> ```text
