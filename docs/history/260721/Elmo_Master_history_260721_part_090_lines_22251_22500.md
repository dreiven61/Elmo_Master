...
>   "code": "var apiDoc2=await sky.documentation('api'); nodeRepl.write(apiDoc2);"
> }
> ```
>
> ````text
...
> ```json
> {
>   "title": "Global HandleRequest 확정",
>   "code": "var returnGlobal=await sky.press_key({window:targetWindow,key:'Return'}); state=null;"
> }
> ```
>
> ```text
...
> ```json
> {
>   "title": "Global HandleRequest 확정 결과",
...
> ```json
> {
>   "title": "HandleRequest method 편집 완료",
>   "code": "var dblMethod=await sky.click({window:targetWindow,x:1045,y:448,click_count:2}); state=null;"
> }
> ```
>
> ```text
...
>   "code": "var kpEnter=await sky.press_key({window:targetWindow,key:'KP_Enter'}); state=null;"
> }
> ```
>
> ```text
