...
> 			312 단추 Close
>
> The focused UI element is 296 편집 ID: 881844176.
> ```
>
...
> ```json
> {
>   "title": "Drive1 타입 선택 목록 열기",
>   "code": "await sky.press_key({window:globalThis.targetWindow,key:'Alt_L+Down'}); globalThis.state=null; nodeRepl.write('combo expanded');"
> }
> ```
>
> ```text
