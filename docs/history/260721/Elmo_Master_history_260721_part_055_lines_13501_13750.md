...
> 			311 단추 Close
>
> The focused UI element is 294 TABLE Properties Window ID: 293314152.
> ```
>
...
> </details>
>
> LASAL 쪽도 확인했습니다. 화면의 `EcatMaster = ECAT_Master_Base / Object Channel` 설정이 맞습니다. 이 형식이어야 마스터 객체의 `EtherCATState`, frame time, missed-frame 등의 여러 서버 채널을 한 클라이언트에서 읽을 수 있습니다. 저장 후 생성 선언까지 대조하겠습니다.
>
