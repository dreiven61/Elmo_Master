...
> 			312 단추 Close
>
> The focused UI element is 295 TABLE Properties Window ID: 293314152.
> ```
>
...
> ```json
> {
>   "title": "Drive1 타입에서 Command Channel로 이동",
>   "code": "await sky.press_key({window:globalThis.targetWindow,key:'Down'}); globalThis.state=null; nodeRepl.write('moved one option');"
> }
> ```
>
> ```text
