...
> 			238 트리 ID: 103
> 				239 편집 ID: 1
> 				240 콘솔 트리 (selectable) Elmo_EtherCAT_Test_4Axis
> 					241 콘솔 트리 (selectable) External
> 					242 콘솔 트리 (selectable) Sigmatek
> 					243 콘솔 트리 (selectable) _TCPIPServer_RT
> 					244 콘솔 트리 (selectable) Elmo_1
> 					245 콘솔 트리 (selectable) Elmo_2
> 					246 콘솔 트리 (selectable) Elmo_3
> 					247 콘솔 트리 (selectable) Elmo_4
> 					248 콘솔 트리 (selectable) LMCDiagnosticsService
> 					249 콘솔 트리 (selectable) LMCEcatInputLatch
> 						250 콘솔 트리 (selectable) Servers
> 						251 콘솔 트리 (selectable) Clients
> 						252 콘솔 트리 (selectable) Methods
> 							253 콘솔 트리 (selectable) Global
> 							254 콘솔 트리 (selectable) Private
> 							255 콘솔 트리 (selectable) Method
> 						256 콘솔 트리 (selectable) Variables
> 							257 콘솔 트리 (selectable) PublishSequence
> 						258 콘솔 트리 (selectable) Dependencies
> 					259 콘솔 트리 (selectable) TCPMotionInterface
> 			260 탭 항목 (selectable) Lib
> 			261 탭 항목 (selectable) File
> 			262 탭 항목 (selectable) Global
> 			263 탭 항목 (selectable) Net
> 			264 탭 항목 (selectable) Class
> 			265 단추 Close
> 		266 Tab Properties ID: 302395640
> 			267 창 ID: 291858232
> 				268 TABLE Properties Window ID: 297584112
...
> 					275 custom Revision
> 					276 custom GUID
> 					277 custom Task Settings
> 					278 custom Sigmatek
> 					279 custom OSInterface
> 					280 custom IconPath
> 					281 custom SharedCommandTable
> 					282 custom Objectsize
> 					283 custom Singleton
> 					284 custom Hidden
> 					285 custom Deprecated
> 					286 custom GCCOptions
> 					287 custom Comment
> 					288 custom Filename
> 				289 도구 모음 ID: 59392
> 					290 단추
> 					291 단추
> 			292 탭 항목 (selectable) Properties
> 			293 단추 Close
>
> The focused UI element is 239 편집 ID: 1.
> ```
>
...
> ```json
> {
>   "code": "var o19=globalThis.state;globalThis.state=null;await sky.type_text({window:o19.window,text:'GetSnapshotSize'});globalThis.state=await sky.get_window_state({window:o19.window,include_screenshot:true,include_text:true});globalThis.targetWindow=state.window;nodeRepl.write(String(state.accessibility?.focused_element||''));",
>   "title": "보조 snapshot 메서드 이름 지정"
> }
> ```
>
> ```text
...
> ```json
> {
>   "code": "var o20=globalThis.state;globalThis.state=null;await sky.click({window:o20.window,element_index:248,mouse_button:'right'});globalThis.state=await sky.get_window_state({window:o20.window,include_screenshot:true,include_text:true});globalThis.targetWindow=state.window;nodeRepl.write(String(state.accessibility?.tree||state.accessibility?.document_text||''));",
>   "title": "RT latch 변수 메뉴 다시 열기"
> }
> ```
>
> ```text
