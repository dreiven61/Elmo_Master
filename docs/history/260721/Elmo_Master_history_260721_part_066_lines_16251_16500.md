...
> ```json
> {
>   "title": "Drive1 클래스 속성 선택",
>   "code": "await sky.click({window:globalThis.targetWindow,x:1250,y:625}); globalThis.state=null; nodeRepl.write('class row selected');"
> }
> ```
>
> ```text
