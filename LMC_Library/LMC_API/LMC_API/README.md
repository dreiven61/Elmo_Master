...
- 이 배포본은 기존 Elmo/PMAS 패킷 확인용입니다. LASAL 전용 단위 변환 기준으로 사용하지 않습니다.
- LASAL 전용 DLL은 `../LMC_LASAL_API_Delivery`를 사용합니다. 해당 DLL은 LASAL `unit.h` 기반 `LMC_Units` scale profile을 사용합니다.
