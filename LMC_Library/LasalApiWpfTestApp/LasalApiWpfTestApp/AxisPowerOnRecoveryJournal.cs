...
namespace LasalMotionControlApiExample
{
    ...
    internal sealed class AxisPowerOnRecoveryJournal : IDisposable
    {
        ...
        internal AxisPowerOnRecoveryRecord ResolveOperatorRetirement(
            ...
            DateTime updatedUtc)
        {
            ...
            {
                throw new InvalidOperationException(
                    "Axis Power retirement requires a durably committed ledger decision.");
            }
            ...
            lock (sync)
            {
                ...
                {
                    throw new InvalidOperationException(
                        "The committed retirement decision does not match the expected Axis Power source evidence.");
                }
                ...
                {
                    throw new InvalidOperationException(
                        "Axis Power recovery changed after operator confirmation; retirement was not applied.");
                }
            ...
            CaptureActiveRetirementEvidenceCore()
        {
            ...
            {
                throw new InvalidOperationException(
                    "No active Axis Power recovery record exists for operator retirement.");
            }
            ...
            if (!RecordsEqual(currentRecord, diskRecord))
            {
                throw new InvalidDataException(
                    "Axis Power recovery memory state does not match the exact durable source bytes.");
            }
        ...
        private byte[] ReadRetirementSourceBytes()
        {
                ...
                FileShare.Read))
            {
                ...
                {
                    throw new InvalidDataException(
                        "Axis Power recovery source length is invalid.");
                }
                ...
                while (offset < bytes.Length)
                {
                    ...
                    {
                        throw new InvalidDataException(
                            "Axis Power recovery source is truncated.");
                    }
                    offset += read;
                }
                return bytes;
        ...
        private static bool RecordsEqual(
            AxisPowerOnRecoveryRecord left,
            AxisPowerOnRecoveryRecord right)
        {
            return left != null
                && right != null
