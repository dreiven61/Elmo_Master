...
- 기본 profile: `position=MM`, `velocity=MMPSEC`, `acceleration=MMPSEC2`, `deceleration=MMPSEC2`, `jerk=MMPSEC2`
- `LMC_Units`에 `unit.h` 기반 상수 추가: `MM=10000`, `MMPSEC=10000`, `MMPSEC2=1`, `DEG=10000`, `RPM=1000` 등
