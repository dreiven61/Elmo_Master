    ...
    internal static class ResponsePayloadLimitTests
    {
        ...
        private static void AllCommandsHaveExactLimits()
        {
            var expected = new Dictionary<ushort, int>
            {
                ...
                { LMC_CommandId.RetireAxisDs402HomeOutcome, 92 },
                { LMC_CommandId.StartAxisDs402HomeEx, 24 },
                { LMC_CommandId.ReadAxisDs402HomeExOutcome, 176 },
                { LMC_CommandId.RetireAxisDs402HomeExOutcome, 176 },
                { LMC_CommandId.ReadAxisHomeOutcome, 144 },
                { LMC_CommandId.RetireAxisHomeOutcome, 144 },
                { LMC_CommandId.ReadGroupParameters, 32 },
                { LMC_CommandId.GroupMoveLinearRelative, 16 },
                { LMC_CommandId.StartAxisSetOperationMode, 24 },
                { LMC_CommandId.ReadAxisSetOperationModeOutcome, 112 },
                { LMC_CommandId.RetireAxisSetOperationModeOutcome, 112 },
                ...
                { LMC_CommandId.StartEncoderMaintenance, 40 },
                { LMC_CommandId.ReadEncoderMaintenanceOutcome, 156 },
                { LMC_CommandId.RetireEncoderMaintenanceOutcome, 156 },
